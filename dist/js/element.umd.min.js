 ...
 */
(function (N, mt) {
  typeof exports == 'object' && typeof module < 'u' ? mt(exports) : typeof define == 'function' && define.amd ? define(['exports'], mt) : ((N = typeof globalThis < 'u' ? globalThis : N || self), mt((N.te = {})));
})(this, function (N) {
  'use strict';
  var xL = Object.defineProperty;
  var CL = (N, mt, O) => (mt in N ? xL(N, mt, { enumerable: !0, configurable: !0, writable: !0, value: O }) : (N[mt] = O));
  ...
  const mt = (() => {
      ...
      return {
        set(e, i, n) {
          typeof e[i] > 'u' && ((e[i] = { key: i, id: t }), t++), (s[e[i].id] = n);
        },
        get(e, i) {
    ...
    oo = (s) => {
      ...
      return !i && !n ? 0 : ((t = t.split(',')[0]), (e = e.split(',')[0]), (Number.parseFloat(t) + Number.parseFloat(e)) * cm);
    },
    hh = (s) => {
      s.dispatchEvent(new Event(xa));
    },
    Wi = (s) => (!s || typeof s != 'object' ? !1 : (typeof s.jquery < 'u' && (s = s[0]), typeof s.nodeType < 'u')),
    Be = (s) => (Wi(s) ? (s.jquery ? s[0] : s) : typeof s == 'string' && s.length > 0 ? document.querySelector(s) : null),
    L = (s, t, e) => {
    ...
    ci = (s) => (!s || s.nodeType !== Node.ELEMENT_NODE || s.classList.contains('disabled') ? !0 : typeof s.disabled < 'u' ? s.disabled : s.hasAttribute('disabled') && s.getAttribute('disabled') !== 'false'),
    dh = (s) => {
      ...
      return s instanceof ShadowRoot ? s : s.parentNode ? dh(s.parentNode) : null;
    },
    ro = () => function () {},
    zi = (s) => {
      s.offsetHeight;
  ...
  function mm(s, t) {
    return function e(i) {
      return (i.delegateTarget = s), e.oneOff && _.off(s, i.type, t), t.apply(s, [i]);
    };
  }
  function bm(s, t, e) {
    return function i(n) {
      const o = s.querySelectorAll(t);
      for (let { target: r } = n; r && r !== this; r = r.parentNode) for (let a = o.length; a--; '') if (o[a] === r) return (n.delegateTarget = r), i.oneOff && _.off(s, n.type, e), e.apply(r, [n]);
      return null;
    };
  }
  ...
  function Eh(s, t, e, i, n) {
    ...
    const d = bh(r, t.replace(um, '')),
      u = o ? bm(s, e, i) : mm(s, e);
    (u.delegationSelector = o ? e : null), (u.originalHandler = r), (u.oneOff = n), (u.uidEvent = d), (c[d] = u), s.addEventListener(a, u, o);
  }
  ...
  const _ = {
      ...
      trigger(s, t, e) {
        ...
        let a,
          ...
          d = null;
        return (
          o && i && ((a = i.Event(t, e)), i(s).trigger(a), (l = !a.isPropagationStopped()), (c = !a.isImmediatePropagationStopped()), (h = a.isDefaultPrevented())),
          r ? ((d = document.createEvent('HTMLEvents')), d.initEvent(n, l, !0)) : (d = new CustomEvent(t, { bubbles: l, cancelable: !0 })),
          typeof e < 'u' &&
  ...
  class Mt {
    constructor(t) {
      (t = Be(t)), t && ((this._element = t), O.setData(this._element, this.constructor.DATA_KEY, this));
    }
    dispose() {
  ...
  class ao extends Mt {
    ...
    toggle() {
      this._element.setAttribute('aria-pressed', this._element.classList.toggle(Em));
    }
  ...
  const Ma = { name: 'applyStyles', enabled: !0, phase: 'write', fn: xm, effect: Cm, requires: ['computeStyles'] };
  function Qt(s) {
    return s.split('-')[0];
  }
  var pi = Math.max,
  ...
  function Xi(s, t, e) {
    ...
    var i = s.getBoundingClientRect(),
      n = 1,
      o = 1;
    t && Pt(s) && ((n = (s.offsetWidth > 0 && Ui(i.width) / s.offsetWidth) || 1), (o = (s.offsetHeight > 0 && Ui(i.height) / s.offsetHeight) || 1));
  ...
  function $a(s) {
    var t = Xi(s),
      e = s.offsetWidth,
      i = s.offsetHeight;
    return Math.abs(t.width - e) <= 1 && (e = t.width), Math.abs(t.height - i) <= 1 && (i = t.height), { x: s.offsetLeft, y: s.offsetTop, width: e, height: i };
  }
  function Ph(s, t) {
  ...
  function He(s) {
    return ((ui(s) ? s.ownerDocument : s.document) || window.document).documentElement;
  }
  function ho(s) {
    return le(s) === 'html' ? s : s.assignedSlot || s.parentNode || (Da(s) ? s.host : null) || He(s);
  }
  function Nh(s) {
  ...
  function wm(s) {
    ...
    var n = ho(s);
    for (Da(n) && (n = n.host); Pt(n) && ['html', 'body'].indexOf(le(n)) < 0; ) {
      var o = Jt(n);
  ...
  function Ns(s) {
    for (var t = Rt(s), e = Nh(s); e && Am(e) && Jt(e).position === 'static'; ) e = Nh(e);
    return e && (le(e) === 'html' || (le(e) === 'body' && Jt(e).position === 'static')) ? t : e || wm(s) || t;
  }
  function Ra(s) {
  ...
  var Sm = function (t, e) {
    return (t = typeof t == 'function' ? t(Object.assign({}, e.rects, { placement: e.placement })) : t), Hh(typeof t != 'number' ? t : Vh(t, ji));
  };
  function Om(s) {
    var t,
      e = s.state,
  ...
  function Im(s) {
    ...
    if (n != null && !(typeof n == 'string' && ((n = t.elements.popper.querySelector(n)), !n))) {
      if (
        ({}.NODE_ENV !== 'production' && (Pt(n) || console.error(['Popper: "arrow" element must be an HTMLElement (not an SVGElement).', 'To use an SVG arrow, wrap it in an HTMLElement that will be used as', 'the arrow.'].join(' '))),
  ...
  const Fh = { name: 'arrow', enabled: !0, phase: 'main', fn: Om, effect: Im, requires: ['popperOffsets'], requiresIfExists: ['preventOverflow'] };
  function Gi(s) {
    return s.split('-')[1];
  }
  ...
  function Wh(s) {
    ...
    if (c) {
      var A = Ns(e),
        w = 'clientHeight',
        S = 'clientWidth';
      if ((A === Rt(e) && ((A = He(e)), Jt(A).position !== 'static' && a === 'absolute' && ((w = 'scrollHeight'), (S = 'scrollWidth'))), (A = A), n === vt || ((n === yt || n === $t) && o === Yi))) {
        E = Lt;
    ...
    if (((p = M.x), (b = M.y), l)) {
      var P;
      return Object.assign({}, I, ((P = {}), (P[E] = T ? '0' : ''), (P[x] = y ? '0' : ''), (P.transform = (C.devicePixelRatio || 1) <= 1 ? 'translate(' + p + 'px, ' + b + 'px)' : 'translate3d(' + p + 'px, ' + b + 'px, 0)'), P));
    }
    return Object.assign({}, I, ((t = {}), (t[E] = T ? b + 'px' : ''), (t[x] = y ? p + 'px' : ''), (t.transform = ''), t));
  }
  function Lm(s) {
    var t = s.state,
      e = s.options,
...
`,
    ...
    var h = { placement: Qt(t.placement), variation: Gi(t.placement), popper: t.elements.popper, popperRect: t.rects.popper, gpuAcceleration: n, isFixed: t.options.strategy === 'fixed' };
    t.modifiersData.popperOffsets != null && (t.styles.popper = Object.assign({}, t.styles.popper, Wh(Object.assign({}, h, { offsets: t.modifiersData.popperOffsets, position: t.options.strategy, adaptive: r, roundOffsets: l })))),
      t.modifiersData.arrow != null && (t.styles.arrow = Object.assign({}, t.styles.arrow, Wh(Object.assign({}, h, { offsets: t.modifiersData.arrow, position: 'absolute', adaptive: !1, roundOffsets: l })))),
      (t.attributes.popper = Object.assign({}, t.attributes.popper, { 'data-popper-placement': t.placement }));
  }
  const Pa = { name: 'computeStyles', enabled: !0, phase: 'beforeWrite', fn: Lm, data: {} };
  var uo = { passive: !0 };
  function $m(s) {
    var t = s.state,
      e = s.instance,
  ...
  const Na = { name: 'eventListeners', enabled: !0, phase: 'write', fn: function () {}, effect: $m, data: {} };
  ...
  function Bm(s) {
    var t,
      ...
      o = pi(e.scrollWidth, e.clientWidth, n ? n.scrollWidth : 0, n ? n.clientWidth : 0),
      r = pi(e.scrollHeight, e.clientHeight, n ? n.scrollHeight : 0, n ? n.clientHeight : 0),
      a = -i.scrollLeft + Ha(s),
      l = -i.scrollTop;
    return Jt(n || e).direction === 'rtl' && (a += pi(e.clientWidth, n ? n.clientWidth : 0) - o), { width: o, height: r, x: a, y: l };
  }
  function Va(s) {
    var t = Jt(s),
      e = t.overflow,
  ...
  function jh(s) {
    return ['html', 'body', '#document'].indexOf(le(s)) >= 0 ? s.ownerDocument.body : Pt(s) && Va(s) ? s : jh(ho(s));
  }
  function Hs(s, t) {
    var e;
    t === void 0 && (t = []);
  ...
  function Fm(s, t, e, i) {
    var n = t === 'clippingParents' ? Vm(s) : [].concat(t),
      ...
      a = o.reduce(
        function (l, c) {
          var h = Yh(s, c, i);
          return (l.top = pi(h.top, l.top)), (l.right = co(h.right, l.right)), (l.bottom = co(h.bottom, l.bottom)), (l.left = pi(h.left, l.left)), l;
        },
        Yh(s, r, i)
      );
  ...
  function qi(s, t) {
    ...
    var e = t,
      ...
      k = u === Ki ? S : A,
      D = { top: C.top - k.top + y.top, bottom: k.bottom - C.bottom + y.bottom, left: C.left - k.left + y.left, right: k.right - C.right + y.right },
  ...
  function Wm(s, t) {
    ...
    var p = u.reduce(function (f, b) {
      return (f[b] = qi(s, { placement: b, boundary: n, rootBoundary: o, padding: r })[Qt(b)]), f;
    }, {});
      ...
      for (
        var n = e.mainAxis,
          ...
          E = [v].concat(x).reduce(function (we, Zt) {
            return we.concat(Qt(Zt) === Ps ? Wm(t, { placement: Zt, boundary: h, rootBoundary: d, padding: c, flipVariations: f, allowedAutoPlacements: b }) : Zt);
          }, []),
          C = t.rects.reference,
          A = t.rects.popper,
          w = new Map(),
        ...
        var I = E[D],
          ...
          X = [vt, Lt].indexOf(M) >= 0,
          R = X ? 'width' : 'height',
          z = qi(t, { placement: I, boundary: h, rootBoundary: d, altBoundary: u, padding: c }),
          Y = X ? (P ? $t : yt) : P ? Lt : vt;
        C[R] > A[R] && (Y = po(Y));
        var Gt = po(Y),
          oe = [];
  ...
  const Uh = { name: 'flip', enabled: !0, phase: 'main', fn: jm, requiresIfExists: ['offset'], data: { _skip: !1 } };
  function Xh(s, t, e) {
    return e === void 0 && (e = { x: 0, y: 0 }), { top: s.top - t.height - e.y, right: s.right - t.width + e.x, bottom: s.bottom - t.height + e.y, left: s.left - t.width - e.x };
  }
  function Gh(s) {
  ...
  function Ym(s) {
    var t = s.state,
      ...
      h = Gh(l),
      d = Gh(c);
    (t.modifiersData[e] = { referenceClippingOffsets: l, popperEscapeOffsets: c, isReferenceHidden: h, hasPopperEscaped: d }),
      (t.attributes.popper = Object.assign({}, t.attributes.popper, { 'data-popper-reference-hidden': h, 'data-popper-escaped': d }));
  }
  const qh = { name: 'hide', enabled: !0, phase: 'main', requiresIfExists: ['preventOverflow'], fn: Ym };
  function Km(s, t, e) {
    var i = Qt(s),
      n = [yt, vt].indexOf(i) >= 0 ? -1 : 1,
      o = typeof e == 'function' ? e(Object.assign({}, t, { placement: s })) : e,
      r = o[0],
      a = o[1];
    return (r = r || 0), (a = (a || 0) * n), [yt, $t].indexOf(i) >= 0 ? { x: a, y: r } : { x: r, y: a };
  }
  function Um(s) {
    var t = s.state,
      e = s.options,
  ...
  const Zh = { name: 'offset', enabled: !0, phase: 'main', requires: ['popperOffsets'], fn: Um };
  function Xm(s) {
    var t = s.state,
      e = s.name;
    t.modifiersData[e] = Kh({ reference: t.rects.reference, element: t.rects.popper, strategy: 'absolute', placement: t.placement });
  }
  const Wa = { name: 'popperOffsets', enabled: !0, phase: 'read', fn: Xm, data: {} };
  function Gm(s) {
    return s === 'x' ? 'y' : 'x';
  }
  function qm(s) {
    ...
    if (A) {
      if (o) {
        var P,
          ...
          Zt = t.modifiersData['arrow#persistent'] ? t.modifiersData['arrow#persistent'].padding : Bh(),
          Pe = Zt[X],
          Ta = Zt[R],
          Vi = Bs(0, w[z], we[z]),
          rh = x ? w[z] / 2 - re - Vi - Pe - D.mainAxis : li - Vi - Pe - D.mainAxis,
          mL = x ? -w[z] / 2 + re + Vi + Ta + D.mainAxis : qt + Vi + Ta + D.mainAxis,
  ...
  const Qh = { name: 'preventOverflow', enabled: !0, phase: 'main', fn: qm, requiresIfExists: ['offset'] };
  function Zm(s) {
  ...
  function tb(s, t, e) {
    ...
    var i = Pt(t),
      ...
      l = { x: 0, y: 0 };
    return (
      (i || (!i && !e)) && ((le(t) !== 'body' || Va(o)) && (a = Qm(t)), Pt(t) ? ((l = Xi(t, !0)), (l.x += t.clientLeft), (l.y += t.clientTop)) : o && (l.x = Ha(o))),
  ...
  var fi = 'Popper: modifier "%s" provided an invalid %s property, expected %s but got %s',
    ...
    s.forEach(function (t) {
      []
        ...
        .forEach(function (e) {
          switch (e) {
            case 'name':
              typeof t.name != 'string' && console.error(Ve(fi, String(t.name), '"name"', '"string"', '"' + String(t.name) + '"'));
              break;
            case 'enabled':
              typeof t.enabled != 'boolean' && console.error(Ve(fi, t.name, '"enabled"', '"boolean"', '"' + String(t.enabled) + '"'));
              break;
            case 'phase':
              lo.indexOf(t.phase) < 0 && console.error(Ve(fi, t.name, '"phase"', 'either ' + lo.join(', '), '"' + String(t.phase) + '"'));
              break;
            case 'fn':
              typeof t.fn != 'function' && console.error(Ve(fi, t.name, '"fn"', '"function"', '"' + String(t.fn) + '"'));
              break;
            case 'effect':
              t.effect != null && typeof t.effect != 'function' && console.error(Ve(fi, t.name, '"effect"', '"function"', '"' + String(t.fn) + '"'));
              break;
            case 'requires':
              t.requires != null && !Array.isArray(t.requires) && console.error(Ve(fi, t.name, '"requires"', '"array"', '"' + String(t.requires) + '"'));
              break;
            case 'requiresIfExists':
              Array.isArray(t.requiresIfExists) || console.error(Ve(fi, t.name, '"requiresIfExists"', '"array"', '"' + String(t.requiresIfExists) + '"'));
              break;
            case 'options':
            case 'data':
              break;
  ...
  function ab(s) {
    var t = s.reduce(function (e, i) {
      var n = e[i.name];
      return (e[i.name] = n ? Object.assign({}, n, i, { options: Object.assign({}, n.options, i.options), data: Object.assign({}, n.data, i.data) }) : i), e;
    }, {});
    return Object.keys(t).map(function (e) {
      return t[e];
    });
  }
  var td = 'Popper: Invalid reference or popper argument provided. They must be either a DOM element or virtual element.',
    lb = 'Popper: An infinite loop in the modifiers cycle has been detected! The cycle has been interrupted to prevent a browser crash.',
  ...
  function fo(s) {
    ...
    return function (a, l, c) {
      c === void 0 && (c = o);
      var h = { placement: 'bottom', orderedModifiers: [], options: Object.assign({}, ed, o), modifiersData: {}, elements: { reference: a, popper: l }, attributes: {}, styles: {} },
        d = [],
        u = !1,
        p = {
          state: h,
          setOptions: function (y) {
            ...
            b(), (h.options = Object.assign({}, o, h.options, T)), (h.scrollParents = { reference: ui(a) ? Hs(a) : a.contextElement ? Hs(a.contextElement) : [], popper: Hs(l) });
          ...
          forceUpdate: function () {
            if (!u) {
              ...
              (h.rects = { reference: tb(T, Ns(x), h.options.strategy === 'fixed'), popper: $a(x) }),
                (h.reset = !1),
              ...
              for (var E = 0, C = 0; C < h.orderedModifiers.length; C++) {
                ...
                var A = h.orderedModifiers[C],
                  ...
                  k = S === void 0 ? {} : S,
                  D = A.name;
                typeof w == 'function' && (h = w({ state: h, options: k, name: D, instance: p }) || h);
              }
            }
          },
          update: sb(function () {
  ...
  const g = {
      ...
      return (
        Object.keys(s.dataset)
          ...
          .forEach((e) => {
            ...
            let i = e.replace(/^te/, '');
            (i = i.charAt(0).toLowerCase() + i.slice(1, i.length)), (t[i] = za(s.dataset[e]));
          }),
        t
      );
    },
      ...
      return (
        Object.keys(t)
          ...
          .forEach((e) => {
            ...
            (i = i.charAt(0).toLowerCase() + i.slice(1, i.length)), (t[i] = za(t[e]));
          }),
        t
      );
    },
    ...
    maxOffset(s) {
      const t = s.getBoundingClientRect();
      return { top: t.top + Math.max(document.body.scrollTop, document.documentElement.scrollTop, window.scrollY), left: t.left + Math.max(document.body.scrollLeft, document.documentElement.scrollLeft, window.scrollX) };
    },
  };
  function Ya(s) {
  ...
  const pb = 3,
    m = {
      ...
      parents(s, t) {
        const e = [];
        let i = s.parentNode;
        for (; i && i.nodeType === Node.ELEMENT_NODE && i.nodeType !== pb; ) this.matches(i, t) && e.push(i), (i = i.parentNode);
        return e;
      },
      prev(s, t) {
    ...
    kb = '[data-te-dropdown-menu-ref] [data-te-dropdown-item-ref]:not(.disabled):not(:disabled)',
    ...
    Pb = { offset: [0, 2], boundary: 'clippingParents', reference: 'toggle', display: 'dynamic', popperConfig: null, autoClose: !0, dropdownAnimation: 'on', animationDuration: 550 },
    Nb = {
  ...
  class Ft extends Mt {
    ...
    show() {
      ...
      this._inNavbar ? g.setDataAttribute(this._menu, 'popper', 'none') : this._createPopper(i),
        'ontouchstart' in document.documentElement && !i.closest(wb) && [].concat(...document.body.children).forEach((n) => _.on(n, 'mouseover', ro)),
        this._element.focus(),
        this._element.setAttribute('aria-expanded', !0),
        this._menu.setAttribute(`data-te-dropdown-${We}`, ''),
        this._animationCanPlay && this._menu.animate($b, { ...ad, duration: this._config.animationDuration }),
    ...
    _init() {
      this._didInit || (_.on(document, rd, mo, Ft.dataApiKeydownHandler), _.on(document, rd, Ga, Ft.dataApiKeydownHandler), _.on(document, yb, Ft.clearMenus), _.on(document, Tb, Ft.clearMenus), (this._didInit = !0));
    }
    _completeHide(t) {
      (this._fadeOutAnimate && this._fadeOutAnimate.playState === 'running') ||
        _.trigger(this._element, gb, t).defaultPrevented ||
        ('ontouchstart' in document.documentElement && [].concat(...document.body.children).forEach((i) => _.off(i, 'mouseover', ro)),
        this._animationCanPlay && (this._fadeOutAnimate = this._menu.animate(Rb, { ...ad, duration: this._config.animationDuration })),
        setTimeout(
          () => {
    ...
    _getConfig(t) {
      if (
        ((t = { ...this.constructor.Default, ...g.getDataAttributes(this._element), ...t }),
        L(Ka, t, this.constructor.DefaultType),
        typeof t.reference == 'object' && !Wi(t.reference) && typeof t.reference.getBoundingClientRect != 'function')
      )
        throw new TypeError(`${Ka.toUpperCase()}: Option "reference" provided type "object" without a required "getBoundingClientRect" method.`);
      return t;
    }
    _createPopper(t) {
      if (typeof sd > 'u') throw new TypeError("Bootstrap's dropdowns require Popper (https://popper.js.org)");
      let e = this._element;
      this._config.reference === 'parent' ? (e = t) : Wi(this._config.reference) ? (e = Be(this._config.reference)) : typeof this._config.reference == 'object' && (e = this._config.reference);
      const i = this._getPopperConfig(),
        n = i.modifiers.find((o) => o.name === 'applyStyles' && o.enabled === !1);
      (this._popper = Fe(e, this._menu, i)), n && g.setDataAttribute(this._menu, 'popper', 'static');
    }
    _isShown(t = this._element) {
      return t.dataset[`teDropdown${We.charAt(0).toUpperCase() + We.slice(1)}`] === '';
    }
    _getMenuElement() {
    ...
    _getPopperConfig() {
      ...
      return this._config.display === 'static' && (t.modifiers = [{ name: 'applyStyles', enabled: !1 }]), { ...t, ...(typeof this._config.popperConfig == 'function' ? this._config.popperConfig(t) : this._config.popperConfig) };
    }
      ...
      for (let i = 0, n = e.length; i < n; i++) {
        ...
        if (t) {
          ...
          if (
            ...
            (o._menu.contains(t.target) && ((t.type === 'keyup' && t.key === od) || /input|select|option|textarea|form/i.test(t.target.tagName)))
          )
            continue;
    ...
    static dataApiKeydownHandler(t) {
      if (/input|textarea/i.test(t.target.tagName) ? t.key === nd || (t.key !== _o && ((t.key !== go && t.key !== Xa) || t.target.closest(Ga))) : !_b.test(t.key)) return;
      const e = this.dataset[`teDropdown${We.charAt(0).toUpperCase() + We.slice(1)}`] === '';
      if ((!e && t.key === _o) || (t.preventDefault(), t.stopPropagation(), ci(this))) return;
  ...
  const qa = 'collapse',
    ...
    jb = 'width',
    Yb = 'height',
    Kb = '[data-te-collapse-item][data-te-collapse-show], [data-te-collapse-item][data-te-collapse-collapsing]',
    ...
    Xb = { visible: 'string', hidden: 'string', baseTransition: 'string', collapsing: 'string', collapsingHorizontal: 'string' };
  class ce extends Mt {
    constructor(t, e, i) {
    ...
    show() {
      ...
      if (t.length) {
        ...
        if (((e = h ? ce.getInstance(h) : null), e && e._isTransitioning)) return;
      }
      if (_.trigger(this._element, Hb).defaultPrevented) return;
      t.forEach((h) => {
        i !== h && ce.getOrCreateInstance(h, { toggle: !1 }).hide(), e || O.setData(h, ld, null);
      });
    ...
    hide() {
      if (this._isTransitioning || !this._isShown() || _.trigger(this._element, Fb).defaultPrevented) return;
    ...
    _getConfig(t) {
      return (t = { ...cd, ...g.getDataAttributes(this._element), ...t }), (t.toggle = !!t.toggle), (t.parent = Be(t.parent)), L(qa, t, Bb), t;
    }
    _getClasses(t) {
    ...
    _addAriaAndCollapsedClass(t, e) {
      t.length &&
        t.forEach((i) => {
          e ? i.removeAttribute(hd) : i.setAttribute(`${hd}`, ''), i.setAttribute('aria-expanded', e);
        });
    }
    static jQueryInterface(t) {
      return this.each(function () {
  ...
  class Qi {
    ...
    hide() {
      ...
      this._disableOverFlow(), this._setElementAttributes(this._element, 'paddingRight', (e) => e + t), this._setElementAttributes(pd, 'paddingRight', (e) => e + t), this._setElementAttributes(fd, 'marginRight', (e) => e - t);
    }
    _disableOverFlow() {
    ...
    reset() {
      this._resetElementAttributes(this._element, 'overflow'), this._resetElementAttributes(this._element, 'paddingRight'), this._resetElementAttributes(pd, 'paddingRight'), this._resetElementAttributes(fd, 'marginRight');
    }
    ...
    _resetElementAttributes(t, e) {
      const i = (n) => {
        ...
        typeof o > 'u' ? n.style.removeProperty(e) : (g.removeDataAttribute(n, e), (n.style[e] = o));
      };
  ...
  const Gb = { isVisible: !0, isAnimated: !1, rootElement: 'body', clickCallback: null, backdropClasses: null },
    qb = { isVisible: 'boolean', isAnimated: 'boolean', rootElement: '(element|string)', clickCallback: '(function|null)', backdropClasses: '(array|string|null)' },
    _d = 'backdrop',
    gd = `mousedown.te.${_d}`;
  class Qa {
    constructor(t) {
    ...
    _getConfig(t) {
      return (t = { ...Gb, ...(typeof t == 'object' ? t : {}) }), (t.rootElement = Be(t.rootElement)), L(_d, t, qb), t;
    }
    _append() {
      this._isAppended ||
    ...
    dispose() {
      this._isAppended && (_.off(this._element, gd), this._element.remove(), (this._isAppended = !1));
    }
    _emulateAnimation(t) {
      ...
      (this._element = t),
        ...
        (this.handler = (n) => {
          this._condition(n) && !n.shiftKey && n.target === this._lastElement
            ...
            : this._condition(n) && n.shiftKey && n.target === this._firstElement && (n.preventDefault(), this._lastElement.focus());
        });
    }
    trap() {
  ...
  const yo = (s, t = 'hide') => {
      ...
      md.includes(i) ||
        ...
        _.on(document, e, `[data-te-${i}-dismiss]`, function (n) {
          if ((['A', 'AREA'].includes(this.tagName) && n.preventDefault(), ci(this))) return;
          const o = Ne(this) || this.closest(`.${i}`) || this.closest(`[data-te-${i}-init]`);
          if (!o) return;
  ...
  class ts extends Mt {
    ...
    show(t) {
      if (this._isShown || _.trigger(this._element, ev, { relatedTarget: t }).defaultPrevented) return;
      (this._isShown = !0),
      ...
      const i = () => {
        this._config.scroll || this._focustrap.trap(), _.trigger(this._element, iv, { relatedTarget: t });
      };
      this._queueCallback(i, this._element, !0);
    }
    hide() {
      if (!this._isShown || _.trigger(this._element, sv).defaultPrevented) return;
      this._focustrap.disable(), this._element.blur(), (this._isShown = !1), this._element.removeAttribute(`data-te-offcanvas-${yd}`), this._backdrop.hide();
      const e = () => {
    ...
    _init() {
      this._didInit || (_.on(window, Zb, () => m.find(tv).forEach((t) => ts.getOrCreateInstance(t).show())), (this._didInit = !0), yo(ts));
    }
    _getConfig(t) {
      return (t = { ...vd, ...g.getDataAttributes(this._element), ...(typeof t == 'object' ? t : {}) }), L(bd, t, Jb), t;
    }
    _initializeBackDrop() {
      return new Qa({ isVisible: this._config.backdrop, isAnimated: !0, rootElement: this._element.parentNode, clickCallback: () => this.hide() });
    }
    _initializeFocusTrap() {
      return new Vs(this._element, { event: 'keydown', condition: (t) => t.key === 'Tab' });
    }
    _addEventListeners() {
  ...
  const Ja = 'alert',
    ...
    lv = { animation: 'boolean', autohide: 'boolean', autoclose: 'boolean', delay: 'number' },
    Ed = { animation: !0, autohide: !0, autoclose: !1, delay: 1e3 },
    cv = { fadeIn: 'animate-[fade-in_0.3s_both] p-[auto] motion-reduce:transition-none motion-reduce:animate-none', fadeOut: 'animate-[fade-out_0.3s_both] p-[auto] motion-reduce:transition-none motion-reduce:animate-none' },
  ...
  class Ws extends Mt {
    ...
    close() {
      ...
      let e = 0;
      this._config.animation && ((e = 300), g.addClass(this._element, this._classes.fadeOut)),
    ...
    show() {
      if (this._element) {
        if (
          ...
          (this._config.autoclose || (this._config.autoclose && this._config.autohide)) && this._setupAutoclose(),
          !this._element.hasAttribute(Fs) && (g.removeClass(this._element, 'hidden'), g.addClass(this._element, 'block'), ae(this._element)))
        ) {
          const t = (e) => {
            g.removeClass(this._element, 'hidden'), g.addClass(this._element, 'block'), _.off(e.target, 'animationend', t);
          };
          this._element.setAttribute(Fs, ''), _.on(this._element, 'animationend', t);
        }
        this._config.animation && (g.removeClass(this._element, this._classes.fadeOut), g.addClass(this._element, this._classes.fadeIn));
      }
    }
    hide() {
      if (this._element && this._element.hasAttribute(Fs)) {
        this._element.removeAttribute(Fs);
        const t = (e) => {
          g.addClass(this._element, 'hidden'), g.removeClass(this._element, 'block'), this._timeout !== null && (clearTimeout(this._timeout), (this._timeout = null)), _.off(e.target, 'animationend', t);
        };
        _.on(this._element, 'animationend', t), g.removeClass(this._element, this._classes.fadeIn), g.addClass(this._element, this._classes.fadeOut);
      }
    }
    _init() {
    ...
    _getConfig(t) {
      return (t = { ...Ed, ...g.getDataAttributes(this._element), ...(typeof t == 'object' && t ? t : {}) }), L(Ja, t, this.constructor.DefaultType), t;
    }
    _getClasses(t) {
      const e = g.getDataClassAttributes(this._element);
  ...
  const tl = 'carousel',
    ...
    pv = 500,
    fv = 40,
    Cd = { interval: 5e3, keyboard: !0, ride: !1, pause: 'hover', wrap: !0, touch: !0 },
    _v = { interval: '(number|boolean)', keyboard: 'boolean', ride: '(boolean|string)', pause: '(string|boolean)', wrap: 'boolean', touch: 'boolean' },
    gv = {
      pointer: 'touch-pan-y',
      block: '!block',
    ...
    mv = { pointer: 'string', block: 'string', visible: 'string', invisible: 'string', slideRight: 'string', slideLeft: 'string' },
    gi = 'next',
    mi = 'prev',
    bi = 'left',
    zs = 'right',
  ...
  class he extends Mt {
    ...
    pause(t) {
      t || (this._isPaused = !0), m.findOne(Nv, this._element) && (hh(this._element), this.cycle(!0)), clearInterval(this._interval), (this._interval = null);
    }
    cycle(t) {
      t || (this._isPaused = !1),
    ...
    _getConfig(t) {
      return (t = { ...Cd, ...g.getDataAttributes(this._element), ...(typeof t == 'object' ? t : {}) }), L(tl, t, _v), t;
    }
    _getClasses(t) {
      const e = g.getDataClassAttributes(this._element);
    ...
    _setActiveElementClass() {
      (this._activeElement = m.findOne(es, this._element)), g.addClass(this._activeElement, 'hidden');
    }
    _addEventListeners() {
      this._config.keyboard && _.on(this._element, yv, (t) => this._keydown(t)),
        this._config.pause === 'hover' && (_.on(this._element, Tv, (t) => this.pause(t)), _.on(this._element, Ev, (t) => this._enableCycle(t))),
        this._config.touch && this._touchSupported && this._addTouchEventListeners(),
        this._applyInitialClasses();
    }
    _addTouchEventListeners() {
      const t = (o) => this._pointerEvent && (o.pointerType === Wv || o.pointerType === Fv),
        e = (o) => {
        ...
        n = (o) => {
          t(o) && (this.touchDeltaX = o.clientX - this.touchStartX),
            this._handleSwipe(),
            this._config.pause === 'hover' && (this.pause(), this.touchTimeout && clearTimeout(this.touchTimeout), (this.touchTimeout = setTimeout((r) => this._enableCycle(r), pv + this._config.interval)));
        };
      m.find(Pv, this._element).forEach((o) => {
        _.on(o, Sv, (r) => r.preventDefault());
      }),
        this._pointerEvent
          ? (_.on(this._element, wv, (o) => e(o)), _.on(this._element, kv, (o) => n(o)), this._element.classList.add(this._classes.pointer), this._element.setAttribute(`${$v}`, ''))
          : (_.on(this._element, xv, (o) => e(o)), _.on(this._element, Cv, (o) => i(o)), _.on(this._element, Av, (o) => n(o)));
    }
    _keydown(t) {
    ...
    _triggerSlideEvent(t, e) {
      ...
      return _.trigger(this._element, vv, { relatedTarget: t, direction: e, from: n, to: i });
    }
    _setActiveIndicatorElement(t) {
      if (this._indicatorsElement) {
        const e = m.findOne(wd, this._indicatorsElement);
        e.removeAttribute(vi), e.removeAttribute('aria-current'), e.classList.remove('!opacity-100');
        const i = m.find(Hv, this._indicatorsElement);
        for (let n = 0; n < i.length; n++)
          if (Number.parseInt(i[n].getAttribute('data-te-slide-to'), 10) === this._getItemIndex(t)) {
            i[n].setAttribute(`${vi}`, ''), i[n].setAttribute('aria-current', 'true'), i[n].classList.add('!opacity-100');
            break;
          }
      }
    }
    ...
    _slide(t, e) {
      ...
      const v = () => {
        _.trigger(this._element, el, { relatedTarget: r, direction: u, from: o, to: a });
      };
    ...
    _directionToOrder(t) {
      return [zs, bi].includes(t) ? (et() ? (t === bi ? mi : gi) : t === bi ? gi : mi) : t;
    }
    _orderToDirection(t) {
      return [gi, mi].includes(t) ? (et() ? (t === mi ? bi : zs) : t === mi ? zs : bi) : t;
    }
  ...
  const nl = 'modal',
    ...
    zv = { backdrop: '(boolean|string)', keyboard: 'boolean', focus: 'boolean', modalNonInvasive: 'boolean' },
    jv = {
      show: 'transform-none',
      static: 'scale-[1.02]',
    ...
    Yv = { show: 'string', static: 'string', staticProperties: 'string', backdrop: 'string' },
    Kv = `hide${te}`,
    Uv = `hidePrevented${te}`,
    Xv = `hidden${te}`,
    Gv = `show${te}`,
  ...
  class Ys extends Mt {
    constructor(t, e, i) {
      super(t),
        ...
        (this._backdrop = this._config.modalNonInvasive ? null : this._initializeBackDrop()),
    ...
    hide() {
      if (!this._isShown || this._isTransitioning || _.trigger(this._element, Kv).defaultPrevented) return;
      this._isShown = !1;
    ...
    dispose() {
      [window, document, this._dialog].forEach((t) => _.off(t, te)), this._backdrop && this._backdrop.dispose(), this._focustrap.disable(), super.dispose();
    }
    handleUpdate() {
      this._adjustDialog();
    }
    ...
    _initializeBackDrop() {
      return new Qa({ isVisible: !!this._config.backdrop, isAnimated: this._isAnimated(), backdropClasses: this._classes.backdrop });
    }
    _initializeFocusTrap() {
      return new Vs(this._element, { event: 'keydown', condition: (t) => t.key === 'Tab' });
    }
    _getConfig(t) {
      return (t = { ...Sd, ...g.getDataAttributes(this._element), ...(typeof t == 'object' ? t : {}) }), L(nl, t, zv), t;
    }
    _getClasses(t) {
      const e = g.getDataClassAttributes(this._element);
    ...
    _showElement(t) {
      ...
      n.classList.add(this._classes.show), n.classList.remove('opacity-0'), n.classList.add('opacity-100'), i && (i.scrollTop = 0), e && zi(this._element);
      const o = () => {
        this._config.focus && this._focustrap.trap(), (this._isTransitioning = !1), _.trigger(this._element, qv, { relatedTarget: t });
      };
    ...
    _setEscapeEvent() {
      this._isShown
        ? _.on(document, Dd, (t) => {
            this._config.keyboard && t.key === kd ? (t.preventDefault(), this.hide()) : !this._config.keyboard && t.key === kd && this._triggerBackdropTransition();
          })
        : _.off(this._element, Dd);
    }
    _setResizeEvent() {
      this._isShown ? _.on(window, Od, () => this._adjustDialog()) : _.off(window, Od);
    }
    _hideModal() {
      ...
      setTimeout(() => {
        ...
        this._backdrop &&
          this._backdrop.hide(() => {
            document.body.removeAttribute(Ld), this._resetAdjustments(), !this._config.modalNonInvasive && this._scrollBar.reset(), _.trigger(this._element, Xv);
          });
    }
    _showBackdrop(t) {
    ...
    _adjustDialog() {
      const t = this._element.scrollHeight > document.documentElement.clientHeight,
        ...
        i = e > 0;
      ((!i && t && !et()) || (i && !t && et())) && (this._element.style.paddingLeft = `${e}px`), ((i && !t && !et()) || (!i && t && et())) && (this._element.style.paddingRight = `${e}px`);
    }
    _resetAdjustments() {
  ...
  const Jv = new Set(['background', 'cite', 'href', 'itemtype', 'longdesc', 'poster', 'src', 'xlink:href']),
    Rd = /^aria-[\w-]*$/i,
    t0 = /^data-te-[\w-]*$/i,
    e0 = /^(?:(?:https?|mailto|ftp|tel|file|sms):|[^#&/:?]*(?:[#/?]|$))/i,
    i0 = /^data:(?:image\/(?:bmp|gif|jpeg|jpg|png|tiff|webp)|video\/(?:mpeg|mp4|ogg|webm)|audio\/(?:mp3|oga|ogg|opus));base64,[\d+/a-z]+=*$/i,
    s0 = (s, t) => {
      const e = s.nodeName.toLowerCase();
      if (t.includes(e)) return Jv.has(e) ? !!(e0.test(s.nodeValue) || i0.test(s.nodeValue)) : !0;
  ...
  const Nd = 'tooltip',
    ...
    l0 = { AUTO: 'auto', TOP: 'top', RIGHT: et() ? 'left' : 'right', BOTTOM: 'bottom', LEFT: et() ? 'right' : 'left' },
    c0 = {
      animation: !0,
      template:
  ...
  let is = class rm extends Mt {
    constructor(t, e) {
      if (typeof sd > 'u') throw new TypeError("Bootstrap's tooltips require Popper (https://popper.js.org)");
    ...
    dispose() {
      clearTimeout(this._timeout), _.off(this._element.closest(Hd), Vd, this._hideModalHandler), this.tip && this.tip.remove(), this._disposePopper(), super.dispose();
    }
    show() {
      ...
      this.constructor.NAME === 'tooltip' && this.tip && this.getTitle() !== this.tip.querySelector(Bd).innerHTML && (this._disposePopper(), this.tip.remove(), (this.tip = null));
      ...
      if (
        ...
        this._element.ownerDocument.documentElement.contains(this.tip) || (l.append(n), _.trigger(this._element, this.constructor.Event.INSERTED)),
        this._popper ? this._popper.update() : (this._popper = Fe(this._element, n, this._getPopperConfig(a))),
      ...
      const d = () => {
          ...
          (this._hoverState = null), _.trigger(this._element, this.constructor.Event.SHOWN), p === rl && this._leave(null, this);
        },
    ...
    hide() {
      ...
      const t = this.getTipElement(),
        e = () => {
          this._isWithActiveTrigger() || (this._hoverState !== Ks && t.remove(), this._cleanTipClass(), this._element.removeAttribute('aria-describedby'), _.trigger(this._element, this.constructor.Event.HIDDEN), this._disposePopper());
        };
      if (_.trigger(this._element, this.constructor.Event.HIDE).defaultPrevented) return;
      t.classList.add('opacity-0'),
        t.classList.remove('opacity-100'),
        'ontouchstart' in document.documentElement && [].concat(...document.body.children).forEach((o) => _.off(o, 'mouseover', ro)),
    ...
    getTipElement() {
      ...
      return this.setContent(e), e.classList.remove(d0, ol), (this.tip = e), this.tip;
    }
    setContent(t) {
    ...
    setElementContent(t, e) {
      if (t !== null) {
        if (Wi(e)) {
          (e = Be(e)), this._config.html ? e.parentNode !== t && ((t.innerHTML = ''), t.append(e)) : (t.textContent = e.textContent);
          return;
        }
        this._config.html ? (this._config.sanitize && (e = To(e, this._config.allowList, this._config.sanitizeFn)), (t.innerHTML = e)) : (t.textContent = e);
      }
    }
    getTitle() {
    ...
    _getPopperConfig(t) {
      const e = {
        ...
        modifiers: [
          ...
          { name: 'onChange', enabled: !0, phase: 'afterWrite', fn: (i) => this._handlePopperPlacementChange(i) },
        ],
        onFirstUpdate: (i) => {
    ...
    _setListeners() {
      this._config.trigger.split(' ').forEach((e) => {
        if (e === 'click') _.on(this._element, this.constructor.Event.CLICK, this._config.selector, (i) => this.toggle(i));
        else if (e !== f0) {
          const i = e === Us ? this.constructor.Event.MOUSEENTER : this.constructor.Event.FOCUSIN,
            n = e === Us ? this.constructor.Event.MOUSELEAVE : this.constructor.Event.FOCUSOUT;
          _.on(this._element, i, this._config.selector, (o) => this._enter(o)), _.on(this._element, n, this._config.selector, (o) => this._leave(o));
        }
      }),
    ...
    _fixTitle() {
      ...
      (t || e !== 'string') &&
        (this._element.setAttribute('data-te-original-title', t || ''), t && !this._element.getAttribute('aria-label') && !this._element.textContent && this._element.setAttribute('aria-label', t), this._element.setAttribute('title', ''));
    }
    _enter(t, e) {
      if (((e = this._initializeOnDelegatedTarget(t, e)), t && (e._activeTrigger[t.type === 'focusin' ? al : Us] = !0), e.getTipElement().classList.contains(ol) || e._hoverState === Ks)) {
        e._hoverState = Ks;
        return;
      }
      if ((clearTimeout(e._timeout), (e._hoverState = Ks), !e._config.delay || !e._config.delay.show)) {
        e.show();
        return;
      }
    ...
    _leave(t, e) {
      if (((e = this._initializeOnDelegatedTarget(t, e)), t && (e._activeTrigger[t.type === 'focusout' ? al : Us] = e._element.contains(t.relatedTarget)), !e._isWithActiveTrigger())) {
        if ((clearTimeout(e._timeout), (e._hoverState = rl), !e._config.delay || !e._config.delay.hide)) {
          e.hide();
          return;
        }
        e._timeout = setTimeout(() => {
  ...
  class Eo extends is {
    ...
    setContent(t) {
      this._sanitizeAndSetContent(t, this.getTitle(), y0), this._sanitizeAndSetContent(t, this._getContent(), T0);
    }
    _getContent() {
  ...
  const ll = 'scrollspy',
    ...
    x0 = { active: '!text-primary dark:!text-primary-400 font-semibold border-l-[0.125rem] border-solid border-primary dark:border-primary-400' },
    C0 = { active: 'string' },
    A0 = `activate${cl}`,
    w0 = `scroll${cl}`,
  ...
  class xo extends Mt {
    ...
    _getConfig(t) {
      return (t = { ...Fd, ...g.getDataAttributes(this._element), ...(typeof t == 'object' && t ? t : {}) }), (t.target = Be(t.target) || document.documentElement), L(ll, t, E0), t;
    }
    _getClasses(t) {
      const e = g.getDataClassAttributes(this._element);
    ...
    _activate(t) {
      ...
      const e = ul.split(',').map((n) => `${n}[data-te-target="${t}"],${n}[href="${t}"]`),
        i = m.findOne(e.join(','), this._config.target);
      i.classList.add(...this._classes.active.split(' ')),
        i.setAttribute(hl, ''),
        i.getAttribute(Wd)
          ? m.findOne(I0, i.closest(O0)).classList.add(...this._classes.active.split(' '))
          : m.parents(i, k0).forEach((n) => {
              m.prev(n, `${dl}, ${zd}`).forEach((o) => {
                o.classList.add(...this._classes.active.split(' ')), o.setAttribute(hl, '');
              }),
                m.prev(n, S0).forEach((o) => {
                  m.children(o, dl).forEach((r) => r.classList.add(...this._classes.active.split(' ')));
                });
            }),
    ...
    _clear() {
      m.find(ul, this._config.target)
        ...
        .forEach((t) => {
          t.classList.remove(...this._classes.active.split(' ')), t.removeAttribute(hl);
        });
    }
    static jQueryInterface(t) {
      return this.each(function () {
  ...
  class wo extends Mt {
    ...
    show() {
      if (this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && this._element.getAttribute(Ao) === '') return;
      let t;
      ...
      if (_.trigger(this._element, $0, { relatedTarget: t }).defaultPrevented || (o !== null && o.defaultPrevented)) return;
      this._activate(this._element, i, null, n, this._element);
      const a = () => {
        _.trigger(t, L0, { relatedTarget: this._element }), _.trigger(this._element, R0, { relatedTarget: t });
      };
    ...
    _activate(t, e, i, n, o) {
      const a = (e && (e.nodeName === 'UL' || e.nodeName === 'OL') ? m.find(Ud, e) : m.children(e, Kd))[0],
        l = i && a && a.hasAttribute(ss),
        c = () => this._transitionComplete(t, a, i, n, o);
      a && l ? (g.removeClass(a, this._classes.show), g.addClass(a, this._classes.hide), this._queueCallback(c, t, !0)) : c();
    }
    _transitionComplete(t, e, i, n, o) {
      if (e && n) {
        e.removeAttribute(ss), n.removeAttribute(Ao);
        const a = m.findOne(F0, e.parentNode);
        a && a.removeAttribute(ss), e.getAttribute('role') === 'tab' && e.setAttribute('aria-selected', !1);
      }
      t.setAttribute(ss, ''),
        o.setAttribute(Ao, ''),
        t.getAttribute('role') === 'tab' && t.setAttribute('aria-selected', !0),
        zi(t),
        t.classList.contains(this._classes.hide) && (g.removeClass(t, this._classes.hide), g.addClass(t, this._classes.show));
      let r = t.parentNode;
      if ((r && r.nodeName === 'LI' && (r = r.parentNode), r && r.hasAttribute(P0))) {
        const a = t.closest(N0);
        a && m.find(V0, a).forEach((l) => l.setAttribute(ss, '')), t.setAttribute('aria-expanded', !0);
      }
      i && i();
    }
    static jQueryInterface(t) {
  ...
  const pl = 'toast',
    ...
    J0 = { fadeIn: 'animate-[fade-in_0.3s_both] p-[auto] motion-reduce:transition-none motion-reduce:animate-none', fadeOut: 'animate-[fade-out_0.3s_both] p-[auto] motion-reduce:transition-none motion-reduce:animate-none' },
  ...
  class Xs extends Mt {
    ...
    show() {
      ...
      this._clearTimeout(), this._config.animation && (g.removeClass(this._element, this._classes.fadeOut), g.addClass(this._element, this._classes.fadeIn));
      const e = () => {
        this._element.removeAttribute(ko), _.trigger(this._element, Z0), this._maybeScheduleHide();
      };
      this._element.removeAttribute(Xd), zi(this._element), this._element.setAttribute(fl, ''), this._element.setAttribute(ko, ''), this._queueCallback(e, this._element, this._config.animation);
    }
    hide() {
      if (!this._element || this._element.dataset.teToastShow === void 0 || _.trigger(this._element, X0).defaultPrevented) return;
      const e = () => {
        let i = 0;
        this._config.animation && ((i = 300), g.removeClass(this._element, this._classes.fadeIn), g.addClass(this._element, this._classes.fadeOut)),
          setTimeout(() => {
            this._element.setAttribute(Xd, ''), this._element.removeAttribute(ko), this._element.removeAttribute(fl), _.trigger(this._element, G0);
          }, i);
      };
      this._element.setAttribute(ko, ''), this._queueCallback(e, this._element, this._config.animation);
    }
    dispose() {
      this._clearTimeout(), this._element.dataset.teToastShow !== void 0 && this._element.removeAttribute(fl), super.dispose();
    }
    _init() {
      this._didInit || (yo(Xs), (this._didInit = !0));
    }
    _getConfig(t) {
      return (t = { ...Gd, ...g.getDataAttributes(this._element), ...(typeof t == 'object' && t ? t : {}) }), L(pl, t, this.constructor.DefaultType), t;
    }
    _getClasses(t) {
      const e = g.getDataClassAttributes(this._element);
        ...
        379: (i, n, o) => {
          ...
          function h(x, E) {
            for (var C = {}, A = [], w = 0; w < x.length; w++) {
              ...
              M !== -1 ? (l[M].references++, l[M].updater(P)) : l.push({ identifier: I, updater: T(P, E), references: 1 }), A.push(I);
            }
            return A;
          }
          function d(x) {
          ...
          function f(x, E, C, A) {
            ...
            if (x.styleSheet) x.styleSheet.cssText = p(E, w);
              ...
              var S = document.createTextNode(w),
                k = x.childNodes;
              k[E] && x.removeChild(k[E]), k.length ? x.insertBefore(S, k[E]) : x.appendChild(S);
            }
          }
          function b(x, E, C) {
            var A = C.css,
...
/*# sourceMappingURL=data:application/json;base64,`.concat(btoa(unescape(encodeURIComponent(JSON.stringify(S)))), ' */')),
          ...
          function T(x, E) {
            ...
            if (E.singleton) {
              var S = y++;
              (C = v || (v = d(E))), (A = f.bind(null, C, S, !1)), (w = f.bind(null, C, S, !0));
            } else
              (C = d(E)),
                (A = b.bind(null, C, E)),
                (w = function () {
            ...
            return (
              ...
              function (k) {
                if (k) {
                  if (k.css === x.css && k.media === x.media && k.sourceMap === x.sourceMap) return;
                  A((x = k));
                } else w();
              }
            );
    ...
    (e.n = (i) => {
      ...
      (e.d = (i, n) => {
        for (var o in n) e.o(n, o) && !e.o(i, o) && Object.defineProperty(i, o, { enumerable: !0, get: n[o] });
      }),
  ...
  class Z {
    ...
    forceActive() {
      this.input.setAttribute(je, ''), m.findOne(ns, this.input.parentNode).setAttribute(je, '');
    }
    forceInactive() {
      this.input.removeAttribute(je), m.findOne(ns, this.input.parentNode).removeAttribute(je);
    }
    dispose() {
      this._removeBorder(), O.removeData(this._element, So), (this._element = null);
    }
    _getConfig(t, e) {
      return (t = { ...oy, ...g.getDataAttributes(e), ...(typeof t == 'object' ? t : {}) }), L(_l, t, ry), t;
    }
    _getClasses(t) {
      const e = g.getDataClassAttributes(this._element);
    ...
    _getCounter() {
      (this._counter = g.getDataAttribute(this.input, 'inputShowcounter')), this._counter && ((this._maxLength = this.input.maxLength), this._showCounter());
    }
    _getEvents() {
      _.on(this._element, 'focus', 'input', Z.activate(new Z())),
        ...
        _.on(window, 'shown.te.tab', (t) => {
          let e;
          t.target.href ? (e = t.target.href.split('#')[1]) : (e = g.getDataAttribute(t.target, 'target').split('#')[1]);
          const i = m.findOne(`#${e}`);
    ...
    _showCounter() {
      ...
      (this._counterElement = document.createElement('div')), g.addClass(this._counterElement, this._classes.counter), this._counterElement.setAttribute(eu, '');
    ...
    _getNotchData() {
      (this._notchMiddle = m.findOne(su, this._element)), (this._notchLeading = m.findOne(iu, this._element));
    }
    _getLabelWidth() {
    ...
    _applyDivs() {
      ...
      g.addClass(o, this._classes.notch),
        ...
        !(n.length >= 1) && (o.append(this._notchLeading), o.append(this._notchMiddle), o.append(this._notchTrailing), this._element.append(o));
    }
    _applyNotch() {
    ...
    _activate(t) {
      ph(() => {
        ...
        t && t.type === 'focus' && i && i.setAttribute(tu, ''), e.value !== '' && (e.setAttribute(je, ''), i && i.setAttribute(je, '')), this._toggleDefaultDatePlaceholder(e);
      });
    }
    _getElements(t) {
      if ((t && ((this._element = t.target.parentNode), (this._label = m.findOne('label', this._element))), t && this._label)) {
        const e = this._labelWidth;
        this._getLabelData(), e !== this._labelWidth && ((this._notchMiddle = m.findOne(su, t.target.parentNode)), (this._notchLeading = m.findOne(iu, t.target.parentNode)), this._applyNotch());
      }
    }
    _deactivate(t) {
      const e = t ? t.target : this.input,
        i = m.findOne(ns, e.parentNode);
      i.removeAttribute(tu), e.value === '' && (e.removeAttribute(je), i.removeAttribute(je)), this._toggleDefaultDatePlaceholder(e);
    }
    static activate(t) {
      return function (e) {
        t._activate(e);
    ...
    static jQueryInterface(t, e) {
      return this.each(function () {
        ...
        if (!(!i && /dispose/.test(t)) && (i || (i = new Z(this, n)), typeof t == 'string')) {
          if (typeof i[t] > 'u') throw new TypeError(`No method named "${t}"`);
          i[t](e);
        }
      });
  ...
  class Gs {
    constructor(t, e) {
      (this._element = t), (this._animateElement = this._getAnimateElement()), (this._isFirstScroll = !0), (this._repeatAnimateOnScroll = !0), (this._options = this._getConfig(e)), this._element && (O.setData(t, gl, this), this._init());
    }
    static get NAME() {
      return ou;
    }
    ...
    _setAnimationReverse() {
      g.style(this._animateElement, { animationIterationCount: this._options.animationRepeat === !0 ? 'infinite' : '2', animationDirection: 'alternate' });
    }
    _setAnimationDuration() {
      g.style(this._animateElement, { animationDuration: `${this._options.animationDuration}ms` });
    }
    _setAnimationDelay() {
      g.style(this._animateElement, { animationDelay: `${this._options.animationDelay}ms` });
    }
    _setAnimationRepeat() {
      g.style(this._animateElement, { animationIterationCount: this._options.animationRepeat === !0 ? 'infinite' : this._options.animationRepeat });
    }
  ...
  const hy = { property: 'color', defaultValue: null, inherit: !0 },
    ...
    ml = 'ripple',
    Do = 'te.ripple',
    dy = 'rgba({{color}}, 0.2) 0, rgba({{color}}, 0.3) 40%, rgba({{color}}, 0.4) 50%, rgba({{color}}, 0.5) 60%, rgba({{color}}, 0) 70%',
    uy = ['[data-te-ripple-init]'],
    Mo = [0, 0, 0],
    py = [
      { name: 'primary', gradientColor: os('text-primary', { defaultValue: '#3B71CA', inherit: !1 }) },
      { name: 'secondary', gradientColor: os('text-secondary', { defaultValue: '#9FA6B2', inherit: !1 }) },
      { name: 'success', gradientColor: os('text-success', { defaultValue: '#14A44D', inherit: !1 }) },
      { name: 'danger', gradientColor: os('text-danger', { defaultValue: '#DC4C64', inherit: !1 }) },
      { name: 'warning', gradientColor: os('text-warning', { defaultValue: '#E4A11B', inherit: !1 }) },
      { name: 'info', gradientColor: os('text-info', { defaultValue: '#54B4D3', inherit: !1 }) },
      { name: 'light', gradientColor: '#fbfbfb' },
      { name: 'dark', gradientColor: '#262626' },
    ],
    ru = 0.5,
    fy = { rippleCentered: !1, rippleColor: '', rippleColorDark: '', rippleDuration: '500ms', rippleRadius: 0, rippleUnbound: !1 },
    _y = { rippleCentered: 'boolean', rippleColor: 'string', rippleColorDark: 'string', rippleDuration: 'string', rippleRadius: 'number', rippleUnbound: 'boolean' },
    gy = {
  ...
  class Ye {
    constructor(t, e, i) {
      (this._element = t),
        ...
        (this._classes = this._getClasses(i)),
        this._element && (O.setData(t, Do, this), g.addClass(this._element, this._classes.ripple)),
    ...
    dispose() {
      O.removeData(this._element, Do), _.off(this._element, 'click', this._clickHandler), (this._element = null), (this._options = null);
    }
    _autoInit(t) {
      uy.forEach((e) => {
        m.closest(t.target, e) && (this._element = m.closest(t.target, e));
      }),
        this._element.style.minWidth || (g.style(this._element, { 'min-width': getComputedStyle(this._element).width }), (this._isMinWidthSet = !0)),
    ...
    _createRipple(t) {
      this._element.className.indexOf(this._classes.ripple) < 0 && g.addClass(this._element, this._classes.ripple);
      const { layerX: e, layerY: i } = t,
        ...
        c = { offsetX: this._options.rippleCentered ? r / 2 : n, offsetY: this._options.rippleCentered ? a / 2 : o, height: r, width: a },
        ...
        f = $('div');
      this._createHTMLRipple({ wrapper: this._element, ripple: f, styles: p }), this._removeHTMLRipple({ ripple: f, duration: l });
    }
    _createHTMLRipple({ wrapper: t, ripple: e, styles: i }) {
      Object.keys(i).forEach((n) => (e.style[n] = i[n])), g.addClass(e, this._classes.rippleWave), e.setAttribute('data-te-ripple-ref', ''), this._addColor(e, t), this._toggleUnbound(t), this._appendRipple(e, t);
    }
        ...
        (this._rippleTimer = setTimeout(() => {
          if (t && (t.remove(), this._element)) {
            m.find('[data-te-ripple-ref]', this._element).forEach((n) => {
              ...
              this._isMinWidthSet && (g.style(this._element, { 'min-width': '' }), (this._isMinWidthSet = !1));
    ...
    _getDiameter({ offsetX: t, offsetY: e, height: i, width: n }) {
      const o = e <= i / 2,
        ...
        l = e === i / 2 && t === n / 2,
        c = { first: o === !0 && r === !1, second: o === !0 && r === !0, third: o === !1 && r === !0, fourth: o === !1 && r === !1 },
        h = { topLeft: a(t, e), topRight: a(n - t, e), bottomLeft: a(t, i - e), bottomRight: a(n - t, i - e) };
      let d = 0;
    ...
    _toggleUnbound(t) {
      this._options.rippleUnbound === !0 ? g.addClass(t, this._classes.unbound) : g.removeClass(t, this._classes.unbound);
    }
    _addColor(t) {
    ...
    _colorToRGB(t) {
      ...
      function i(o) {
        const r = document.body.appendChild(document.createElement('fictum')),
          a = 'rgb(1, 2, 3)';
        return (r.style.color = a), r.style.color !== a || ((r.style.color = o), r.style.color === a || r.style.color === '') ? Mo : ((o = getComputedStyle(r).color), document.body.removeChild(r), o);
      }
      function n(o) {
        return (o = o.match(/[.\d]+/g).map((r) => +Number(r))), (o.length = 3), o;
      }
      return t.toLowerCase() === 'transparent' ? Mo : t[0] === '#' ? e(t) : (t.indexOf('rgb') === -1 && (t = i(t)), t.indexOf('rgb') === 0 ? n(t) : Mo);
    }
  ...
  function xy(s, t, e, i, n, o, r, a) {
    const l = new Date();
    return l.setHours(0, 0, 0, 0), ((s && o && ls(o, l) < 0) || s) && (o = l), o && qs(t, o, e, i, n, o, r, a);
  }
  function Cy(s, t, e, i, n, o, r, a) {
    const l = new Date();
    return l.setHours(0, 0, 0, 0), ((s && n && ls(n, l) < 0) || s) && (n = l), n && qs(t, n, e, i, n, o, r, a);
  }
  function qs(s, t, e, i, n, o, r, a) {
    return e === 'days' ? K(s) === K(t) && ot(s) === ot(t) : e === 'months' ? K(s) === K(t) : e === 'years' ? K(t) >= a && K(t) <= r : !1;
  }
  ...
  function du(s, t, e, i, n, o, r, a, l, c) {
    let h;
    return o.view === 'days' ? (h = Po(s, e, o, c)) : o.view === 'months' ? (h = No(t, i, n, o, r, c)) : (h = Bo(s, i, o, a, l, c)), h;
  }
  function uu(s, t, e, i) {
    return `
  ...
  function Hy(s, t, e) {
    ...
    for (let f = 1; f < d; f++) {
      ...
      if (f === 1) {
        ...
        for (let T = v; T <= h; T++) {
          const x = ee(a, o, T);
          b.push({ date: x, currentMonth: p, isSelected: t && yi(x, t), isToday: yi(x, rs()), dayNumber: Tt(x) });
        }
        p = !0;
        const y = d - b.length;
        for (let T = 0; T < y; T++) {
          const x = ee(a, n, u);
          b.push({ date: x, currentMonth: p, isSelected: t && yi(x, t), isToday: yi(x, rs()), dayNumber: Tt(x), disabled: Ro(x, e.min, e.max, e.filter, e.disablePast, e.disableFuture) }), u++;
        }
      } else
        for (let v = 1; v < 8; v++) {
          u > c && ((u = 1), (p = !1));
          const y = ee(a, p ? n : r, u);
          b.push({ date: y, currentMonth: p, isSelected: t && yi(y, t), isToday: yi(y, rs()), dayNumber: Tt(y), disabled: Ro(y, e.min, e.max, e.filter, e.disablePast, e.disableFuture) }), u++;
        }
      i.push(b);
    }
    return i;
  ...
  const cs = 37,
    ...
    aT = 'animate-[fade-in_0.3s_both] px-[auto] motion-reduce:transition-none motion-reduce:animate-none',
    lT = 'animate-[fade-out_0.3s_both] px-[auto] motion-reduce:transition-none motion-reduce:animate-none',
    cT = 'animate-[fade-in_0.15s_both] px-[auto] motion-reduce:transition-none motion-reduce:animate-none',
    hT = 'animate-[fade-out_0.15s_both] px-[auto] motion-reduce:transition-none motion-reduce:animate-none',
    dT =
    ...
    uT = 'w-full h-full fixed top-0 right-0 left-0 bottom-0 bg-black/40 z-[1065]',
    pT = 'relative h-full',
    fT = 'xs:max-md:landscape:h-full h-[120px] px-6 bg-primary flex flex-col rounded-t-lg dark:bg-zinc-800',
    ...
    NT = 'inline-block pointer-events-none ml-[3px] [&>svg]:w-4 [&>svg]:h-4 [&>svg]:fill-neutral-500 dark:[&>svg]:fill-white',
    BT = 'w-[328px] h-[380px] bg-white rounded-lg shadow-[0px_2px_15px_-3px_rgba(0,0,0,.07),_0px_10px_20px_-2px_rgba(0,0,0,.04)] z-[1066] dark:bg-zinc-700',
    HT = {
      title: 'Select date',
      container: 'body',
      disablePast: !1,
  ...
  class xl {
    ...
    get container() {
      return m.findOne(`[${pu}='${this._toggleButtonId}']`) || m.findOne(`[${fu}='${this._toggleButtonId}']`);
    }
    get options() {
    ...
    _getConfig(t) {
      const e = g.getDataAttributes(this._element);
      if (((t = { ...HT, ...e, ...t }), L(El, t, VT), t.max && typeof t.max == 'string' && (t.max = new Date(t.max)), t.min && typeof t.min == 'string' && (t.min = new Date(t.min)), t.startDay && t.startDay !== 0)) {
    ...
    open() {
      ...
      const e = Py(this._classes.datepickerBackdrop),
        i = Ry(this._activeDate, this._selectedDate, this._selectedYear, this._selectedMonth, this._options, Fo, ie, Vo, this._toggleButtonId, this._classes);
      this._options.inline ? this._openDropdown(i) : (this._openModal(e, i), this._scrollBar.hide()),
        this._animations && (g.addClass(this.container, this._classes.fadeIn), g.addClass(e, this._classes.fadeInShort)),
    ...
    _openDropdown(t) {
      (this._popper = Fe(this._input, t, { placement: 'bottom-start' })), this._getContainer().appendChild(t);
    }
    _openModal(t, e) {
    ...
    _setFocusTrap(t) {
      (this._focusTrap = new Vs(t, { event: 'keydown', condition: (e) => e.key === 'Tab' })), this._focusTrap.trap();
    }
    _listenToUserInput() {
    ...
    _listenToFooterButtonsClick() {
      _.on(this.okButton, 'click', () => this.handleOk()), _.on(this.cancelButton, 'click', () => this.handleCancel()), _.on(this.clearButton, 'click', () => this.handleClear());
    }
    ...
    _handleDaysViewKeydown(t) {
      ...
      switch (t.keyCode) {
        ...
        case Ti:
          ...
          break;
        case Ei:
          this._activeDate = as(this._activeDate, bl(this._activeDate) - Tt(this._activeDate));
          break;
        case yl:
      ...
      qs(e, this._activeDate, this._view, ie, this._options.min, this._options.max) || this._changeView('days'), this._removeHighlightFromCell(i), this._focusActiveCell(this.activeCell), t.preventDefault();
    }
    ...
    _handleMonthsViewKeydown(t) {
      ...
      qs(e, this._activeDate, this._view, ie, this._options.min, this._options.max) || this._changeView('months'), this._removeHighlightFromCell(i), this._focusActiveCell(this.activeCell), t.preventDefault();
    }
    _getActiveMonthCell() {
      const t = m.find('td', this.datesContainer);
      return Array.from(t).find((i) => {
    ...
    _handleYearsViewKeydown(t) {
      ...
      switch (t.keyCode) {
        ...
        case Ti:
          ...
          break;
        case Ei:
          this._activeDate = kt(this._activeDate, o - $o(this._activeDate, o) - 1);
          break;
        case yl:
      ...
      qs(e, this._activeDate, this._view, ie, this._options.min, this._options.max) || this._changeView('years'), this._removeHighlightFromCell(i), this._focusActiveCell(this.activeCell), t.preventDefault();
    }
    _getActiveYearCell() {
      const t = m.find('td', this.datesContainer);
    ...
    _closeDropdown() {
      ...
      window.matchMedia('(prefers-reduced-motion: reduce)').matches && (t && e.removeChild(t), this._popper && this._popper.destroy()),
    ...
    _removeInputAndToggleListeners() {
      _.off(this._input, 'input'), _.off(this._element, jo, Yo), _.off(this._element, 'keydown', Yo);
    }
    handleOk() {
    ...
    _confirmSelection(t) {
      if (t) {
        ...
        (this._input.value = e), _.trigger(this._element, Xy, { date: t }), _.trigger(this._input, 'input');
      }
    }
    handleCancel() {
    ...
    previousMonth() {
      ...
      (this.viewChangeButton.textContent = `${this._options.monthsFull[this.activeMonth]} ${this.activeYear}`), (this.viewChangeButton.innerHTML += pe(this._options, this._classes)), (this.datesContainer.innerHTML = e);
    }
    nextYear() {
      const t = kt(this._activeDate, 1);
      (this._activeDate = t), (this.viewChangeButton.textContent = `${this.activeYear}`), (this.viewChangeButton.innerHTML += pe(this._options, this._classes));
      const e = No(this.activeYear, this._selectedYear, this._selectedMonth, this._options, Fo, this._classes);
      this.datesContainer.innerHTML = e;
    }
    previousYear() {
      const t = kt(this._activeDate, -1);
    ...
    nextYears() {
      ...
      (this.viewChangeButton.textContent = `${this.firstYearInView} - ${this.lastYearInView}`), (this.viewChangeButton.innerHTML += pe(this._options, this._classes)), (this.datesContainer.innerHTML = e);
    }
    previousYears() {
      const t = kt(this._activeDate, -24);
      this._activeDate = t;
    ...
    _changeView(t) {
      (this._view = t),
        ...
        t === 'days' && (this.datesContainer.innerHTML = Po(this._activeDate, this._headerDate, this._options, this._classes)),
        t === 'months' && (this.datesContainer.innerHTML = No(this.activeYear, this._selectedYear, this._selectedMonth, this._options, Fo, this._classes)),
        t === 'years' && (this.datesContainer.innerHTML = Bo(this._activeDate, this._selectedYear, this._options, ie, Vo, this._classes)),
        this.datesContainer.focus(),
    ...
    _updateControlsDisabledState() {
      xy(this._options.disableFuture, this._activeDate, this._view, ie, this._options.min, this._options.max, this.lastYearInView, this.firstYearInView) ? (this.nextButton.disabled = !0) : (this.nextButton.disabled = !1),
        Cy(this._options.disablePast, this._activeDate, this._view, ie, this._options.min, this._options.max, this.lastYearInView, this.firstYearInView) ? (this.previousButton.disabled = !0) : (this.previousButton.disabled = !1);
    }
    _handleUserInput(t) {
      const e = this._getDelimeters(this._options.format),
        i = this._parseDate(t, this._options.format, e);
      yy(i)
        ? ((this._activeDate = i), (this._selectedDate = i), (this._selectedYear = K(i)), (this._selectedMonth = ot(i)), (this._headerDate = i))
        : ((this._activeDate = new Date()), (this._selectedDate = null), (this._selectedMonth = null), (this._selectedYear = null), (this._headerDate = null), (this._headerMonth = null), (this._headerYear = null));
    }
    _getDelimeters(t) {
  ...
  const zT = ({ format24: s, okLabel: t, cancelLabel: e, headID: i, footerID: n, bodyID: o, pickerID: r, clearLabel: a, inline: l, showClearBtn: c, amLabel: h, pmLabel: d }, u) => {
...
`;
    ...
    Ai = (s) => {
      ...
      return (
        _u(s)
          ? ((t = s.getHours()), (n = t), (e = s.getMinutes()), (t %= 12), n === 0 && t === 0 && (i = 'AM'), (t = t || 12), i === void 0 && (i = Number(n) >= 12 ? 'PM' : 'AM'), (e = e < 10 ? `0${e}` : e))
          : (([t, e, i] = j(s, !1)), (n = t), (t %= 12), n === 0 && t === 0 && (i = 'AM'), (t = t || 12), i === void 0 && (i = Number(n) >= 12 ? 'PM' : 'AM')),
        { hours: t, minutes: e, amOrPm: i }
      );
    },
    _u = (s) => s && Object.prototype.toString.call(s) === '[object Date]' && !Number.isNaN(s),
    gu = (s) => {
      if (s === '') return;
      let t, e;
      return _u(s) ? ((t = s.getHours()), (e = s.getMinutes())) : ([t, e] = j(s, !1)), (e = Number(e) < 10 ? `0${Number(e)}` : e), { hours: t, minutes: e };
    },
    YT = (s, t, e) =>
      _.on(document, s, t, ({ target: i }) => {
        if (i.hasAttribute(Uo)) return;
        document.querySelectorAll(t).forEach((o) => {
          o.hasAttribute(Uo) && (g.removeClass(o, e.opacity), o.removeAttribute(Uo));
        }),
    ...
    mu = ({ clientX: s, clientY: t, touches: e }, i, n = !1) => {
      ...
      let a = {};
      return !n || !e ? (a = { x: s - o, y: t - r }) : n && Object.keys(e).length > 0 && (a = { x: e[0].clientX - o, y: e[0].clientY - r }), a;
    },
    Xo = () => (navigator.maxTouchPoints && navigator.maxTouchPoints > 2 && /MacIntel/.test(navigator.platform)) || /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent),
    j = (s, t = !0) => (t ? s.value.replace(/:/gi, ' ').split(' ') : s.replace(/:/gi, ' ').split(' ')),
    bu = (s, t) => {
      const [e, i, n] = j(s, !1),
        [o, r, a] = j(t, !1);
    ...
    Ke = (s, t, e) => {
      if (!t) return s;
      let i = vu();
      return e && (i = `${Ai(i).hours}:${Ai(i).minutes} ${Ai(i).amOrPm}`), ((s !== '' && bu(i, s)) || s === '') && (s = i), s;
    },
    Ue = (s, t, e) => {
      if (!t) return s;
      let i = vu();
    ...
    KT = ({ format12: s, maxTime: t, minTime: e, disablePast: i, disableFuture: n }, o, r) => {
      const a = j(o)[1];
    ...
    yu = (s, t, e, i) => {
      s.forEach((n) => {
        (t = t === '12' && i ? '0' : t), (n.textContent === '00' || Number(n.textContent === '12' && i ? '0' : n.textContent) > t) && (g.addClass(n, e.tipsDisabled), n.setAttribute(Ko, ''));
      });
    },
    Tu = (s, t, e, i) => {
      s.forEach((n) => {
        (t = t === '12' && i ? '0' : t), n.textContent !== '00' && Number(n.textContent === '12' && i ? '0' : n.textContent) < Number(t) && (g.addClass(n, e.tipsDisabled), n.setAttribute(Ko, ''));
      });
    },
    Eu = (s, t, e, i) => {
      if (t === '12' || t === '24') return;
    ...
    UT = (s, t, e, i, n, o) => {
      s.forEach((r) => {
        (Eu(i, e, o, 'max') || (Number(r.textContent) > t && Number(i) === Number(e))) && (g.addClass(r, n.tipsDisabled), r.setAttribute(Ko, ''));
      });
    },
    XT = (s, t, e, i, n, o) => {
      s.forEach((r) => {
        (Eu(i, e, o, 'min') || (Number(r.textContent) < t && Number(i) === Number(e))) && (g.addClass(r, n.tipsDisabled), r.setAttribute(Ko, ''));
      });
    },
  ...
  class Ll {
    constructor(t, e = {}, i) {
      ...
      ke(this, '_makeMinutesDegrees', (t, e) => {
        ...
        return (
          t < 0 ? ((e = Math.round(360 + t / 6) % 60), (t = 360 + Math.round(t / 6) * 6)) : ((e = Math.round(t / 6) % 60), (t = Math.round(t / 6) * 6)),
          i && ((t = Math.round(t / 30) * 30), (e = (Math.round(t / 6) * 6) / 6), e === 60 && (e = '00')),
          t >= 360 && (t = 0),
          ...
          return (
            this._hasTargetInnerClass(t)
              ...
              : e < 0
                ...
                : ((i = Math.round(e / 30) % 12), (i === 0 || i > 12) && (i = 12)),
            e >= 360 && (e = 0),
            { degrees: e, hour: i, addDegrees: 30 }
          );
      });
      ke(this, '_makeInnerHoursDegrees', (t, e) => (t < 0 ? ((e = Math.round(360 + t / 30) % 24), (t = 360 + t)) : ((e = Math.round(t / 30) + 12), e === 12 && (e = '00')), { degrees: t, hour: e, addDegrees: 30 }));
      ke(this, '_getAppendClock', (t = [], e = `[${wi}]`, i) => {
        ...
        const [h, d, u] = j(o, !1),
          [p, f, b] = j(n, !1);
        !r && a && this._isInvalidTimeFormat && !this._AM.hasAttribute(J) && (g.addClass(this._PM, this._classes.opacity), this._PM.setAttribute(J, ''));
        const v = m.findOne(e),
          y = 360 / t.length;
        function T(A) {
        ...
        setTimeout(() => {
          let A;
          a && (A = m.findOne(`${Qo}[${J}]`).textContent), this._handleDisablingTipsMinTime(A, b, f, p), this._handleDisablingTipsMaxTime(A, u, d, h);
        }, 0),
          [...t].forEach((A, w) => {
            const S = T(w * y),
              k = $('span'),
              D = $('span');
            (D.innerHTML = A), g.addClass(k, this._classes.tips), k.setAttribute(i, '');
            const I = k.offsetWidth,
              M = k.offsetHeight;
            return (
              g.addStyle(k, { left: `${x + Math.sin(S) * C - I}px`, bottom: `${E + Math.cos(S) * C - M}px` }),
              t.includes('05') && k.setAttribute(xt, ''),
              t.includes('13') ? D.setAttribute(er, '') : D.setAttribute(tr, ''),
              k.appendChild(D),
              v.appendChild(k)
            );
          });
      ...
      (this._element = t),
        ...
        this._options.format24 && ((this._options.format12 = !1), (this._currentTime = gu(this._inputValue))),
        this._options.format12 && ((this._options.format24 = !1), (this._currentTime = Ai(this._inputValue))),
        this._options.readOnly && this.input.setAttribute(nE, !0),
        this.inputFormat === 'true' && this.inputFormat !== '' && ((this._options.format12 = !1), (this._options.format24 = !0), (this._currentTime = gu(this._inputValue))),
        (this._animations = !window.matchMedia('(prefers-reduced-motion: reduce)').matches && this._options.animations),
        this.init(),
        (this._isHours = !0),
        (this._isMinutes = !1),
    ...
    init() {
      ...
      this.input.value.length > 0 && this.input.value !== '' && (this.input.setAttribute(J, ''), _.trigger(this.input, 'input')),
        !(this._options === null && this._element === null) && (i && this._getValidate('keydown change blur focus'), this._handleOpen(), this._listenToToggleKeydown());
    }
    dispose() {
      this._removeModal(),
        ...
        _.off(this._element, 'click', `[data-te-toggle='${this.toggleElement}']`),
        _.off(this._element, 'keydown', `[data-te-toggle='${this.toggleElement}']`);
    }
    update(t = {}) {
      this._options = this._getConfig({ ...this._options, ...t });
    }
    _checkToggleButton() {
      this.customIcon === null &&
        (this.dataWithIcon !== void 0 && ((this._options.withIcon = null), this.dataWithIcon === 'true' && this._appendToggleButton(this._options)), this._options.withIcon && this._appendToggleButton(this._options));
    }
    _appendToggleButton() {
    ...
    _handlerMaxMinHoursOptions(t, e, i, n, o, r) {
      ...
      const { format24: a, format12: l, disablePast: c, disableFuture: h } = this._options,
        ...
        p = r.keyCode,
        f = r.target.hasAttribute(Qs) || r.target.hasAttribute(Bt) || r.target.hasAttribute(er);
      (i = Ke(i, c, l)), (e = Ue(e, h, l)), typeof e != 'number' && (e = j(e, !1)[0]);
      const b = e !== '' ? e * 30 : '',
        v = i !== '' ? i * 30 : '';
      ...
      const y = () => {
          ...
          return (
            p === ut ? (I = 1) : p === ht && (I = -1),
            k === 12 && p === ut ? (M = 1) : k === 0 && p === ut ? (M = 13) : k === 0 && p === ht ? (M = 23) : k === 13 && p === ht ? (M = 0) : k === 1 && p === ht ? (M = 12) : (M = k + I),
            w.forEach((P) => {
    ...
    _handleKeyboard() {
      _.on(this._document, qo, '', (t) => {
        ...
        const p = j(a, !1)[2],
          f = j(r, !1)[2];
        (d = Ke(d, c, l)), (u = Ue(u, h, l)), typeof u != 'number' && (u = j(u, !1)[0]);
          ...
          if (
            (v &&
              (t.keyCode === hs &&
                ...
                (this._hour.textContent = this._setHourOrMinute(C > 12 ? 1 : C)),
              ...
              t.keyCode === cs &&
                ...
                (this._hour.textContent = this._setHourOrMinute(I >= 24 || I === '00' ? 0 : I)),
                this._toggleClassActive(this.innerHours, this._hour, E),
            ...
            g.addStyle(this._hand, { transform: `rotateZ(${A + w}deg)` }),
              this._isInner
                ? ((I += 1), I === 24 ? (I = 0) : (I === 25 || I === '001') && (I = 13), (this._hour.textContent = this._setHourOrMinute(I)), this._toggleClassActive(this.innerHours, this._hour, E))
                : ((C += 1), (this._hour.textContent = this._setHourOrMinute(C > 12 ? 1 : C)), this._toggleClassActive(this.hoursArray, this._hour, x));
          }
          if (t.keyCode === ht) {
            if (!this._handlerMaxMinHoursOptions(A - 30, u, d, f, p, t)) return;
            g.addStyle(this._hand, { transform: `rotateZ(${A - w}deg)` }),
              this._isInner
                ? ((I -= 1), I === 12 ? (I = 0) : I === -1 && (I = 23), (this._hour.textContent = this._setHourOrMinute(I)), this._toggleClassActive(this.innerHours, this._hour, E))
                : ((C -= 1), (this._hour.textContent = this._setHourOrMinute(C === 0 ? 12 : C)), this._toggleClassActive(this.hoursArray, this._hour, x));
          }
        } else
          t.keyCode === ut &&
            ((k += D),
      ...
      if (!this._isInvalidTimeFormat)
        if (this._options.format24) {
          ...
          [...e].filter(
            (n) => (
              n.toLowerCase() === 'pm'
                ? (g.addClass(this._PM, this._classes.opacity), this._PM.setAttribute(J, ''))
                : n.toLowerCase() === 'am'
                  ? (g.addClass(this._AM, this._classes.opacity), this._AM.setAttribute(J, ''))
                  : (g.removeClass(this._AM, this._classes.opacity), g.removeClass(this._PM, this._classes.opacity), this._AM.removeAttribute(J), this._PM.removeAttribute(J)),
              n
            )
          );
          const i = m.find(`[${_t}]`, this._modal);
    ...
    _setTipsAndTimesDependOnInputValue(t, e) {
      ...
      if (this._isInvalidTimeFormat)
        (this._hour.textContent = '12'), (this._minutes.textContent = '00'), i || g.addStyle(this._hand, { transform: 'rotateZ(0deg)' }), n && (g.addClass(this._PM, this._classes.opacity), this._PM.setAttribute(J, ''));
      else {
        const o = t > 12 ? t * 30 - 360 : t * 30;
        (this._hour.textContent = t),
          (this._minutes.textContent = e),
          i || (g.addStyle(this._hand, { transform: `rotateZ(${o}deg)` }), g.addStyle(this._circle, { backgroundColor: '#1976d2' }), (Number(t) > 12 || t === '00') && g.addStyle(this._hand, { height: '21.5%' }));
      }
    }
    _listenToToggleKeydown() {
      _.on(this._element, 'keydown', `[data-te-toggle='${this.toggleElement}']`, (t) => {
        t.keyCode === Et && (t.preventDefault(), _.trigger(this.elementToggle, 'click'));
      });
    }
    _handleOpen() {
      const t = this._getContainer();
      ct.on(this._element, 'click', `[data-te-toggle='${this.toggleElement}']`, (e) => {
        if (this._options === null) return;
        const i = g.getDataAttribute(this.input, 'toggle') !== null ? 200 : 0;
        setTimeout(() => {
          g.addStyle(this.elementToggle, { pointerEvents: 'none' }), this.elementToggle.blur();
          let n;
          j(this.input)[0] === '' ? (n = ['12', '00', 'PM']) : (n = j(this.input));
          ...
          if (
            ...
            d.setAttribute('id', o),
            r ? ((this._popper = Fe(this.input, d, { placement: 'bottom-start' })), t.appendChild(d)) : (t.appendChild(d), this._scrollBar.hide()),
            this._getDomElements(),
            this._animations ? this._toggleBackdropAnimation() : g.addClass(this._wrapper, this._classes.opacity),
            ...
            a && (g.addClass(this._PM, this._classes.opacity), this._PM.setAttribute(J, '')), (this._hour.textContent = '12'), (this._minutes.textContent = '00'), this._addActiveClassToTip(u, Number(this._hour.textContent));
          }
          if ((this._handleSwitchTimeMode(), this._handleOkButton(), this._handleClose(), r)) this._handleHoverInlineBtn(), this._handleDocumentClickInline(), this._handleInlineClicks();
            ...
            g.addClass(u, this._classes.opacity), g.addStyle(this._hour, { pointerEvents: 'none' }), g.addStyle(this._minutes, { pointerEvents: '' });
          }
          (this._focusTrap = new Vs(this._wrapper, { event: 'keydown', condition: ({ key: u }) => u === 'Tab' })), this._focusTrap.trap();
        }, i);
      });
    }
    _handleInlineClicks() {
      ...
      ct.on(this._modal, 'click mousedown mouseup touchstart touchend contextmenu', `[${wl}], [${kl}]`, (p) => {
          ...
          ? f.closest(`[${wl}]`).parentNode.hasAttribute($u)
            ...
            : v
              ...
              : b === 'mouseup' || b === 'touchend' || b === 'contextmenu'
                ? d()
                : l()
          : f.closest(`[${kl}]`) && (f.closest(`[${kl}]`).parentNode.hasAttribute($u) ? (v ? u(c) : b === 'mouseup' || b === 'touchend' ? d() : c()) : v ? u(h) : b === 'mouseup' || b === 'touchend' ? d() : h());
      }),
        _.on(window, qo, (p) => {
          const f = p.code,
    ...
    _handleClose() {
      _.on(this._modal, 'click', `[${Ol}], [${Cl}], [${Lu}]`, ({ target: t }) => {
        ...
        } else (t.hasAttribute(Cl) || t.hasAttribute(Al) || (t.hasAttribute(Ol) && e)) && i();
      });
    }
    showValueInput() {
    ...
    _handleOkButton() {
      ct.on(this._modal, 'click', `[${Al}]`, () => {
        ...
        const S = p > b && u === Number(f),
          k = p < T && u === Number(y);
        if ((this.input.setAttribute(J, ''), g.addStyle(this.elementToggle, { pointerEvents: 'auto' }), t !== '')) {
          if (A && (C || S)) return;
          if (v === 'AM' && c.textContent === 'PM') return;
        }
        (e !== '' && ((w && (E || k)) || (x === 'PM' && c.textContent === 'AM'))) ||
          (KT(this._options, this.input, this._hour.textContent) !== void 0 &&
            ...
            g.addStyle(this.elementToggle, { pointerEvents: 'auto' }),
            n ? (this.input.value = h) : c === null ? (this.input.value = `${h} PM`) : (this.input.value = `${h} ${c.textContent}`),
            this._animations && this._toggleBackdropAnimation(!0),
            this._removeModal(),
    ...
    _handleHoverInlineBtn() {
      ct.on(this._modal, 'mouseover mouseleave', `[${sE}]`, ({ type: t, target: e }) => {
    ...
    _handleDocumentClickInline() {
      _.on(document, Cu, ({ target: t }) => {
        if (this._modal && !this._modal.contains(t) && !t.hasAttribute(tE)) {
          if ((clearInterval(this._interval), g.addStyle(this.elementToggle, { pointerEvents: 'auto' }), this._removeModal(), !this._animations)) return;
        ...
        _.on(this._modal, 'click', Zo, () => {
          ...
          e.forEach((c) => {
            c.hasAttribute(J) &&
              (c.hasAttribute(Il)
                ? (g.addClass(this._hand, this._classes.transform),
                  g.addStyle(this._hand, { transform: `rotateZ(${this._minutes.textContent * 6}deg)`, height: 'calc(40% + 1px)' }),
                ...
                : c.hasAttribute(Jo) &&
                  (g.addStyle(this._hand, { transform: `rotateZ(${this._hour.textContent * 30}deg)` }),
                  Number(this._hour.textContent) > 12
                    ? (g.addStyle(this._hand, { transform: `rotateZ(${this._hour.textContent * 30 - 360}deg)`, height: '21.5%' }), Number(this._hour.textContent) > 12 && g.addStyle(this._hand, { height: '21.5%' }))
                    : g.addStyle(this._hand, { height: 'calc(40% + 1px)' }),
    ...
    _handleDisablingTipsMaxTime(t, e, i, n) {
      ...
      const o = m.find(`[${_t}]`),
        ...
        a = m.find(`[${xt}]`);
      if (!e || e === t) {
        yu(r, n, this._classes, this._options.format12), yu(o, n, this._classes, this._options.format12), UT(a, i, n, this._hour.textContent, this._classes, this._options.format12);
        return;
      }
      e === 'AM' &&
        t === 'PM' &&
    ...
    _handleDisablingTipsMinTime(t, e, i, n) {
      ...
      const o = m.find(`[${_t}]`),
        ...
        a = m.find(`[${xt}]`);
      !e || e === t
        ? (Tu(o, n, this._classes, this._options.format12), Tu(r, n, this._classes, this._options.format12), XT(a, i, n, this._hour.textContent, this._classes, this._options.format12))
        : e === 'PM' &&
          t === 'AM' &&
          (o.forEach((l) => {
            g.addClass(l, this._classes.tipsDisabled), l.setAttribute(Xe, '');
    ...
    _handleSwitchTimeMode() {
      _.on(document, 'click', Qo, ({ target: t }) => {
        ...
        (() => {
          ...
          t.hasAttribute(J) ||
            (m.find(Qo).forEach((y) => {
              y.hasAttribute(J) && (g.removeClass(y, this._classes.opacity), y.removeAttribute(J));
            }),
    ...
    _handleClockClick() {
      ...
      const r = j(t, !1)[2],
        ...
        c = j(e, !1)[0],
        h = m.findOne(`[${Ru}]`);
      ct.on(document, `${Au} ${wu} ${ku} ${Su} ${Ou} ${Mu} ${Iu} ${Du}`, '', (d) => {
        Xo() || d.preventDefault();
        ...
        if (u === 'mousedown' || u === 'mousemove' || u === 'touchmove' || u === 'touchstart')
          (u === 'mousedown' || u === 'touchstart' || u === 'touchmove') &&
            (this._hasTargetInnerClass(p) || p.hasAttribute(Ru) || p.hasAttribute(wi) || p.hasAttribute(xt) || p.hasAttribute(_t) || p.hasAttribute(Ml) || p.hasAttribute(Dl) || p.hasAttribute(Pu) || p.hasAttribute(tr)) &&
            ((this._isMouseMove = !0), Xo() && d.touches && ((w = d.touches[0].clientX), (S = d.touches[0].clientY), (k = document.elementFromPoint(w, S))));
        else if (u === 'mouseup' || u === 'touchend') {
          if (((this._isMouseMove = !1), this._hasTargetInnerClass(p) || p.hasAttribute(wi) || p.hasAttribute(_t) || p.hasAttribute(Ml) || p.hasAttribute(Dl) || p.hasAttribute(Pu) || p.hasAttribute(tr))) {
            if ((y || T) && b) {
        ...
        if (v) {
          ...
          const { degrees: X, minute: R } = this._handlerMaxMinMinutesOptions(M, P);
          if (this._isMouseMove) {
            if ((g.addStyle(this._hand, { transform: `rotateZ(${X}deg)` }), R === void 0)) return;
        ...
        if (y || T) {
          ...
          if (((I = Math.round(I / 30) * 30), g.addStyle(this._circle, { backgroundColor: '#1976d2' }), this._makeHourDegrees(p, I, D) === void 0)) return;
          const M = () => {
            if (Xo() && I && k) {
          ...
          (this._objWithDataOnChange.degreesHours = I), this._handlerMaxMinHoursOptions(I, l, c, r, a, d) && M();
        }
        d.stopPropagation();
      });
    }
    ...
    _handleMoveHand(t, e, i) {
      const n = m.find(`[${_t}]`, this._modal),
        o = m.find(`[${Bt}]`, this._modal);
      this._isMouseMove &&
        (this._hasTargetInnerClass(t) ? g.addStyle(this._hand, { height: '21.5%' }) : g.addStyle(this._hand, { height: 'calc(40% + 1px)' }),
    ...
    _handlerMaxMinMinutesOptions(t, e) {
      ...
      if (!b && !v) {
        ...
        if (i !== '') {
          ...
          } else if (b === 'AM' && this._isAmEnabled && E >= Number(f) && t >= y + 6) return t;
        }
      }
    ...
    _removeModal() {
      this._animations
        ...
        : (this._removeModalElements(), this._scrollBar.reset()),
        ct.off(this._document, `${Cu} ${qo} ${Au} ${wu} ${ku} ${Su} ${Ou} ${Mu} ${Iu} ${Du}`),
        _.off(window, qo);
    }
    ...
    _toggleBackdropAnimation(t = !1) {
      t ? this._wrapper.classList.add('animate-[fade-out_350ms_ease-in-out]') : (this._wrapper.classList.add('animate-[fade-in_350ms_ease-in-out]'), this._options.inline || g.addClass(this._clock, this._classes.clockAnimation)),
        setTimeout(() => {
    ...
    _addActiveClassToTip(t, e) {
      t.forEach((i) => {
        Number(i.textContent) === Number(e) && (g.addClass(i, this._classes.tipsActive), i.setAttribute(J, ''));
      });
    }
    _setHourOrMinute(t) {
      return t < 10 ? `0${t}` : t;
    ...
    _appendTimes() {
      const { format24: t } = this._options;
      if (t) {
        this._getAppendClock(this.hoursArray, `[${wi}]`, _t), this._getAppendClock(this.innerHours, `[${Qs}]`, Bt);
        return;
      }
    ...
    _getValidate(t) {
      ...
      ct.on(this.input, t, ({ target: o }) => {
        ...
        if ((a.test(o.value) !== !0 && e) || (l !== !0 && i)) {
          n && this.input.setAttribute(Sl, ''), g.addStyle(o, { marginBottom: 0 }), (this._isInvalidTimeFormat = !0);
          return;
        }
  ...
  let uE = class {
      constructor(t, e) {
        (this._element = t), (this._startPosition = null), (this._options = { ...dE, ...e });
      }
      handleTouchStart(t) {
      ...
      handleTouchMove(t) {
        ...
        if (this._options.direction === 'all') {
          ...
          _.trigger(this._element, `swipe${r}`), _.trigger(this._element, 'swipe', { direction: r }), (this._startPosition = null);
          return;
        }
        const o = this._options.direction === 'left' || this._options === 'right' ? 'x' : 'y';
        n[o].direction === this._options.direction && n[o].value > this._options.threshold && (_.trigger(this._element, `swipe${n[o].direction}`), (this._startPosition = null));
      }
      handleTouchEnd() {
  ...
  class Wu {
    ...
    _init() {
      const t = m.find(`${Ge}`, this._element)[this._activeStepIndex].setAttribute('data-te', 'active-step'),
    ...
    _toggleStep(t) {
      ...
      const e = this._activeStepIndex,
        i = _.trigger(this.activeStep, fE, { currentStep: this._activeStepIndex, nextStep: t });
      (t > this._activeStepIndex && i.defaultPrevented) ||
        ...
        this._currentView === tn ? this._animateHorizontalStep(t) : (this._animateVerticalStep(t), this._setSingleStepHeight(this._steps[t])),
        this._toggleStepTabIndex(m.findOne(`${Ct}`, this.activeStep), m.findOne(`${Ct}`, this._steps[t])),
        ...
        _.trigger(this.activeStep, _E, { currentStep: this._activeStepIndex, prevStep: e }));
    }
    _resetStepperHeight() {
    ...
    _setStepsHeight() {
      this._steps.forEach((t) => {
        ...
        this._verticalStepperStyles.push({ paddingTop: parseFloat(i.paddingTop), paddingBottom: parseFloat(i.paddingBottom) });
    ...
    _toggleVertical() {
      (this._currentView = ge), this._setStepsHeight(), this._hideInactiveSteps();
    }
    _toggleHorizontal() {
      (this._currentView = tn), this._setHeight(this.activeStep), this._hideInactiveSteps();
    }
    _toggleStepperClass() {
        ...
        this._steps.forEach((t) => {
          ...
          _.on(e, Hu, (i) => {
            ...
            if (
              (o && (c = m.findOne(`${Ct}`, o)),
              r && (h = m.findOne(`${Ct}`, r)),
              i.keyCode === cs && this._currentView !== ge && (h ? (this._toggleStepTabIndex(a, h), this._toggleOutlineStyles(a, h), h.focus()) : c && (this._toggleStepTabIndex(a, c), this._toggleOutlineStyles(a, c), c.focus())),
              i.keyCode === hs && this._currentView !== ge && (c ? (this._toggleStepTabIndex(a, c), this._toggleOutlineStyles(a, c), c.focus()) : h && (this._toggleStepTabIndex(a, h), this._toggleOutlineStyles(a, h), h.focus())),
              i.keyCode === ht && this._currentView === ge && (i.preventDefault(), c && (this._toggleStepTabIndex(a, c), this._toggleOutlineStyles(a, c), c.focus())),
              i.keyCode === ut && this._currentView === ge && (i.preventDefault(), h && (this._toggleStepTabIndex(a, h), this._toggleOutlineStyles(a, h), h.focus())),
              i.keyCode === Ti)
            ) {
            ...
            (i.keyCode === Et || i.keyCode === Ho) && (i.preventDefault(), this.changeStep(this._steps.indexOf(n))), i.keyCode === Ci && (this._toggleStepTabIndex(a, l), this._toggleOutlineStyles(a, !1), l.focus());
          }),
            _.on(e, bE, (i) => {
              const n = m.parents(i.currentTarget, `${Ge}`)[0],
                o = m.findOne(`${Ct}`, n),
                r = m.findOne(`${Ct}`, this.activeStep);
              i.keyCode === Ci && (this._toggleStepTabIndex(o, r), this._toggleOutlineStyles(!1, r), r.focus());
            });
        });
    }
    ...
    _toggleCompleted(t) {
      ...
      this._options.stepperNoEditable ? this._steps[t].classList.add('pointer-events-none') : (e[t].classList.add('!bg-success-100'), e[t].classList.add('!text-success-700')),
    ...
    _hideElement(t) {
      !m.parents(t, `${Ge}`)[0].getAttribute('data-te') && this._currentView !== ge ? (t.style.display = 'none') : (t.classList.add('!my-0'), t.classList.add('!py-0'), t.classList.add('!h-0'));
    }
    _showElement(t) {
      this._currentView === ge ? (t.classList.remove('!my-0'), t.classList.remove('!py-0'), t.classList.remove('!h-0')) : (t.style.display = 'block');
    }
    _animateHorizontalStep(t) {
      ...
      this._steps.forEach((a, l) => {
        ...
        e ? ((r = this._options.slideOutLeftAnimation), (o = this._options.slideInRightAnimation)) : ((r = this._options.slideOutRightAnimation), (o = this._options.slideInLeftAnimation)),
        n.classList.add(r),
        i.classList.add(o),
    ...
    _clearStepsAnimation() {
      this._steps.forEach((t) => {
        m.findOne(`${At}`, t).classList.remove(this._options.slideInLeftAnimation, this._options.slideOutLeftAnimation, this._options.slideInRightAnimation, this._options.slideOutRightAnimation);
      });
    }
  ...
  class Ku {
    ...
    _selectSingle() {
      this.selected || (this.node.setAttribute(nr, ''), this.node.setAttribute('aria-selected', !0), (this.selected = !0), this.nativeOption && (this.nativeOption.selected = !0));
    }
    _selectMultiple() {
      if (!this.selected) {
        const t = m.findOne(Yu, this.node);
        (t.checked = !0), this.node.setAttribute(nr, ''), this.node.setAttribute('aria-selected', !0), (this.selected = !0), this.nativeOption && (this.nativeOption.selected = !0);
      }
    }
    deselect() {
    ...
    _deselectSingle() {
      this.selected && (this.node.removeAttribute(nr), this.node.setAttribute('aria-selected', !1), (this.selected = !1), this.nativeOption && (this.nativeOption.selected = !1));
    }
    _deselectMultiple() {
      if (this.selected) {
        const t = m.findOne(Yu, this.node);
        (t.checked = !1), this.node.removeAttribute(nr), this.node.setAttribute('aria-selected', !1), (this.selected = !1), this.nativeOption && (this.nativeOption.selected = !1);
      }
    }
    setNode(t) {
      this.node = t;
    ...
    removeActiveStyles() {
      this.active && ((this.active = !1), this.node.removeAttribute(zu)), this.multiple && this.node.removeAttribute(ju);
    }
  }
  class vE {
    constructor(t = !1) {
...
`,
  ...
  function or(s, t, e, i, n) {
    t.selectSize === 'default' && g.addClass(s, e), t.selectSize === 'sm' && g.addClass(s, i), t.selectSize === 'lg' && g.addClass(s, n);
  }
  function PE(s, t, e, i, n) {
    ...
    a.setAttribute(EE, ''),
      ...
      or(a, t, i.selectInputSizeDefault, i.selectInputSizeSm, i.selectInputSizeLg),
      ...
      t.selectPlaceholder !== '' && a.setAttribute('placeholder', t.selectPlaceholder),
      t.selectValidation ? (g.addStyle(a, { 'pointer-events': 'none', 'caret-color': 'transparent' }), g.addStyle(r, { cursor: 'pointer' })) : a.setAttribute('readonly', 'true'),
      t.selectValidation && (a.setAttribute('required', 'true'), a.setAttribute('aria-required', 'true'), a.addEventListener('keydown', RE));
    const d = $('div');
    ...
    p.appendChild(f);
    const b = $('span');
    b.setAttribute(xE, ''), g.addClass(b, i.selectClearBtn), or(b, t, i.selectClearBtnDefault, i.selectClearBtnSm, i.selectClearBtnLg), t.selectFormWhite && g.addClass(b, i.selectClearBtnWhite);
    ...
    return (
      ...
      (y.innerHTML = n || $E),
      r.appendChild(a),
      e && (g.addClass(e, i.selectLabel), or(e, t, i.selectLabelSizeDefault, i.selectLabelSizeSm, i.selectLabelSizeLg), t.selectFormWhite && g.addClass(e, i.selectLabelWhite), r.appendChild(e)),
  ...
  function Gu(s, t, e, i, n, o, r, a) {
    ...
    l.setAttribute(CE, ''), g.addClass(l, a.selectDropdownContainer), l.setAttribute('id', `${s}`), (l.style.width = `${e}px`);
    const c = document.createElement('div');
    c.setAttribute('tabindex', 0), c.setAttribute(AE, ''), g.addClass(c, a.dropdown);
    const h = $('div');
    h.setAttribute(wE, ''), g.addClass(h, a.optionsWrapper), g.addClass(h, a.optionsWrapperScrollbar), (h.style.maxHeight = `${i}px`);
    const d = qu(o, n, t, a);
    return h.appendChild(d), t.selectFilter && c.appendChild(NE(t.selectSearchPlaceholder, a)), c.appendChild(h), r && c.appendChild(r), l.appendChild(c), l;
  }
  function qu(s, t, e, i) {
    const n = $('div');
  ...
  function NE(s, t) {
    ...
    const i = $('input');
    return i.setAttribute(SE, ''), g.addClass(i, t.selectFilterInput), (i.placeholder = s), i.setAttribute('role', 'searchbox'), i.setAttribute('type', 'text'), e.appendChild(i), e;
  }
  function BE(s, t, e) {
    return Zu(s, t, e);
  }
  ...
  function Ju(s, t, e) {
    ...
    return t.multiple && i.appendChild(WE(s, e)), i.appendChild(n), (s.secondaryText || typeof s.secondaryText == 'number') && i.appendChild(FE(s.secondaryText, e)), i;
  }
  function FE(s, t) {
    const e = $('span');
  ...
  function WE(s, t) {
    const e = $('input');
    e.setAttribute('type', 'checkbox'), g.addClass(e, t.formCheckInput), e.setAttribute(DE, '');
    const i = $('label');
  ...
  function zE(s, t) {
    const e = $('span'),
      i = $('img');
    return g.addClass(i, t.selectOptionIcon), (i.src = s.icon), e.appendChild(i), e;
  }
  function jE(s, t, e) {
    const i = $('div');
    i.setAttribute(ME, ''), g.addClass(i, e.selectOptionGroup), i.setAttribute('role', 'group'), i.setAttribute('id', s.id), s.hidden && g.addClass(i, 'hidden');
    const n = $('label');
    return (
      n.setAttribute(LE, ''),
  ...
  function YE(s, t) {
    const e = $('div');
    return (e.textContent = s), g.addClass(e, t.selectLabel), g.addClass(e, t.selectFakeValue), e;
  }
  const Pl = 'select',
    en = 'te.select',
    sn = `.${en}`,
  ...
  class on {
      ...
      return (
        t.childNodes.forEach((n) => {
          if (n.nodeName === 'OPTGROUP') {
            const o = { id: bt('group-'), label: n.label, disabled: n.hasAttribute('disabled'), hidden: n.hasAttribute('hidden'), options: [] };
    ...
    _init() {
      this._renderMaterialWrapper(), (this._wrapper = m.findOne(`#${this._wrapperId}`)), (this._input = m.findOne(op, this._wrapper)), this._config.disabled && this._input.setAttribute(Nl, '');
      ...
      t === 'body' ? (this._container = document.body) : (this._container = m.findOne(t)),
        ...
        (this._dropdownContainer = Gu(this._dropdownContainerId, this._config, this._input.offsetWidth, this._dropdownHeight, this._selectAllOption, this._optionsToRender, this._customContent, this._classes)),
        this._setFirstActiveOption(),
        this._listenToFocusChange();
    }
    _renderMaterialWrapper() {
      const t = PE(this._wrapperId, this._config, this._label, this._classes, this._config.customArrow);
      this._element.parentNode.insertBefore(t, this._element), g.addClass(this._element, this._classes.initialized), t.appendChild(this._element);
    }
    _initOutlineInput() {
      const t = m.findOne(ap, this._wrapper);
      new Z(t, { inputFormWhite: this._config.selectFormWhite }, this._classes).init(), (this._notch = m.findOne(Bl, this._wrapper));
    }
    ...
    _handleOpenKeydown(t) {
      ...
      if ((e === Ci && this._config.selectAutoSelect && !this.multiple && this._handleAutoSelection(this._activeOption), i)) {
    ...
    _handleClosedKeydown(t) {
      const e = t.keyCode;
      if ((e === Et && t.preventDefault(), (e === Et || (e === ht && t.altKey) || (e === ht && this.multiple)) && this.open(), this.multiple))
        switch (e) {
          case ht:
            this.open();
            break;
    ...
    _listenToClearBtnKeydown() {
      _.on(this.clearButton, 'keydown', (t) => {
        t.keyCode === Et && (this._handleClear(), t.preventDefault(), t.stopPropagation());
      });
    }
    _handleClear() {
    ...
    _listenToOptionsClick() {
      _.on(this.optionsWrapper, 'click', (t) => {
        ...
        const i = t.target.nodeName === 'DIV' ? t.target : m.closest(t.target, ix);
    ...
    _singleOptionSelect(t) {
      ...
      e && e !== t && (this._selectionModel.deselect(e), e.deselect(), e.node.setAttribute(nn, !1), _.trigger(this._element, ep, { value: e.value })),
        (!e || (e && t !== e)) && (this._selectionModel.select(t), t.select(), t.node.setAttribute(nn, !0), _.trigger(this._element, tp, { value: t.value }), this._emitValueChangeEvent(this.value), this._emitNativeChangeEvent());
    }
    _handleMultiSelection(t) {
      t.selected
        ? (this._selectionModel.deselect(t), t.deselect(), t.node.setAttribute(nn, !1), _.trigger(this._element, ep, { value: t.value }))
        : (this._selectionModel.select(t), t.select(), t.node.setAttribute(nn, !0), _.trigger(this._element, tp, { value: t.value })),
        this._emitValueChangeEvent(this.value),
        this._emitNativeChangeEvent();
    }
    ...
    _updateInputValue() {
      ...
      let e;
      this.multiple && this._config.selectDisplayedLabels !== -1 && this._selectionModel.selections.length > this._config.selectDisplayedLabels
    ...
    _appendFakeValue() {
      ...
      (this._fakeValue = YE(t, this._classes)), m.findOne(ap, this._wrapper).appendChild(this._fakeValue);
    }
    _updateLabelPosition() {
      const t = this._element.hasAttribute(ip),
        e = this._input.value !== '';
      this._label && (t && (e || this._isOpen || this._isFakeValueActive) ? (this._label.setAttribute(wt, ''), this._notch.setAttribute(wt, '')) : (this._label.removeAttribute(wt), this._notch.removeAttribute(wt, '')));
    }
    _updateLabelPositionWhileClosing() {
      this._label && (this._input.value !== '' || this._isFakeValueActive ? (this._label.setAttribute(wt, ''), this._notch.setAttribute(wt, '')) : (this._label.removeAttribute(wt), this._notch.removeAttribute(wt)));
    }
    _updateFakeLabelPosition() {
      this._fakeValue &&
        (this._input.value === '' && this._fakeValue.innerHTML !== '' && !this._config.selectPlaceholder
          ? ((this._isFakeValueActive = !0), this._fakeValue.setAttribute(wt, ''))
          : ((this._isFakeValueActive = !1), this._fakeValue.removeAttribute(wt)));
    }
    _updateClearButtonVisibility() {
      if (!this.clearButton) return;
      this._selectionModel.selection || this._selectionModel.selections.length > 0 ? g.addStyle(this.clearButton, { display: 'block' }) : g.addStyle(this.clearButton, { display: 'none' });
    }
    ...
    _openDropdown() {
      (this._popper = Fe(this._input, this._dropdownContainer, { placement: 'bottom-start', modifiers: [{ name: 'offset', options: { offset: [0, 1] } }] })),
    ...
    _setInputActiveStyles() {
      this._input.setAttribute(qe, ''), m.findOne(Bl, this._wrapper).setAttribute(qe, '');
    }
    ...
    _updateOptionsListTemplate(t) {
      const e = m.findOne(rp, this._dropdownContainer) || m.findOne(ox, this._dropdownContainer),
    ...
    _listenToOutsideClick() {
      (this._outsideClick = this._handleOutSideClick.bind(this)), _.on(document, 'click', this._outsideClick);
    }
    _listenToFocusChange(t = !0) {
      if (t === !1) {
        _.off(this._input, 'focus', () => this._notch.setAttribute(qe, '')), _.off(this._input, 'blur', () => this._notch.removeAttribute(qe));
        return;
      }
      _.on(this._input, 'focus', () => this._notch.setAttribute(qe, '')), _.on(this._input, 'blur', () => this._notch.removeAttribute(qe));
    }
    ...
    close() {
      ...
      !this._isOpen ||
        t.defaultPrevented ||
        (this._config.selectFilter && this.hasSelectAll && (this._resetFilterState(), this._updateOptionsListTemplate(this._optionsToRender), this._config.multiple && this._updateSelectAllState()),
        ...
        setTimeout(() => {
          this._input.removeAttribute(qe),
            ...
            this._label && !this.hasSelection && (this._label.removeAttribute(wt), this._notch.setAttribute(wt, ''), this._input.removeAttribute(wt), this._notch.removeAttribute(wt)),
            this._updateLabelPositionWhileClosing();
        }, 0),
        setTimeout(() => {
          this._container && this._dropdownContainer.parentNode === this._container && this._container.removeChild(this._dropdownContainer), this._popper.destroy(), (this._isOpen = !1), _.off(this.dropdown, 'transitionend');
        }, e));
    }
    _resetFilterState() {
    ...
    _removeDropdownEvents() {
      _.off(document, 'click', this._outsideClick), this._config.selectFilter && _.off(this.dropdown, 'keydown'), _.off(this.optionsWrapper, 'click');
    }
    ...
    _updateDisabledState() {
      ...
      this._element.hasAttribute('disabled') ? ((this._config.disabled = !0), t.setAttribute('disabled', ''), t.setAttribute(Nl, '')) : ((this._config.disabled = !1), t.removeAttribute('disabled'), t.removeAttribute(Nl));
    }
    ...
    dispose() {
      this._removeComponentEvents(), this._destroyMaterialSelect(), this._listenToFocusChange(!1), O.removeData(this._element, en);
    }
    _removeComponentEvents() {
      _.off(this.input, 'click'), _.off(this.wrapper, this._handleKeydown.bind(this)), _.off(this.clearButton, 'click'), _.off(this.clearButton, 'keydown'), _.off(window, 'resize', this._handleWindowResize.bind(this));
    }
    ...
    static jQueryInterface(t, e) {
      return this.each(function () {
        ...
        const n = typeof t == 'object' && t;
        if (!(!i && /dispose/.test(t)) && (i || (i = new on(this, n)), typeof t == 'string')) {
          if (typeof i[t] > 'u') throw new TypeError(`No method named "${t}"`);
          i[t](e);
        }
      });
  ...
  const dx = ({ inputID: s, labelText: t }, e) => `<div data-te-chips-input-wrapper data-te-input-wrapper-init class="${e.chipsInputWrapper}">
      <input
          type="text"
          class="${e.chipsInput}"
          id="${s}"
    ...
    ux = ({ text: s, iconSVG: t }, e) => `<div data-te-chip-init data-te-ripple-init class="${e.chipElement}">
    ...
    fx = 'delete.te.chips',
    _x = 'select.te.chip',
    gx = '<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-3 h-3"> <path stroke-linecap="round" stroke-linejoin="round" d="M6 18L18 6M6 6l12 12" /></svg>',
    mx = { text: 'string', closeIcon: 'boolean', img: 'object', iconSVG: 'string' },
  ...
  class ki {
    ...
    dispose() {
      (this._element = null), (this._options = null), _.off(this._element, 'click');
    }
    appendChip() {
    ...
    _appendCloseIcon(t = this._element) {
      if (!(m.find(Hl, this._element).length > 0) && this._options.closeIcon) {
        const e = $('span');
        (e.classList = this._classes.icon), e.setAttribute(lp), (e.innerHTML = this._options.iconSVG), t.insertAdjacentElement('beforeend', e);
      }
    }
    _handleClickOnChip() {
  ...
  const rn = 'chips',
    ...
    fp = 'delete.te.chips',
    _p = 'select.te.chips',
    Nx = { inputID: 'string', parentSelector: 'string', initialValues: 'array', editable: 'boolean', labelText: 'string', inputClasses: 'object', inputOptions: 'object' },
    Bx = { inputID: bt('chips-input-'), parentSelector: '', initialValues: [{ tag: 'init1' }, { tag: 'init2' }], editable: !1, labelText: 'Example label', inputClasses: {}, inputOptions: {} },
    Hx = {
      opacity: 'opacity-0',
    ...
    Vx = { opacity: 'string', inputWrapperPadding: 'string', transition: 'string', contentEditable: 'string', chipsInputWrapper: 'string', chipsInput: 'string', chipsLabel: 'string' };
  class gp extends ki {
    constructor(e, i = {}, n) {
      super(e, i);
      ke(this, '_handleBlurInput', ({ target: e }) => {
        e.value.length > 0 && this._handleCreateChip(e, e.value),
          this.allChips.length > 0
            ? (e.setAttribute(Wt, ''), this.input.setAttribute(us, ''), m.findOne(zl, this.input.parentNode).setAttribute(us, ''), this.chipsInputWrapper.classList.add(...this._classes.inputWrapperPadding.split(' ')))
            : (e.removeAttribute(Wt), this.input.removeAttribute(us), m.findOne(zl, this.input.parentNode).removeAttribute(us), this.chipsInputWrapper.classList.remove(...this._classes.inputWrapperPadding.split(' '))),
          this.allChips.forEach((i) => i.removeAttribute(Wt));
      });
      (this._element = e), (this._inputInstance = null), this._element && O.setData(e, cp, this), (this._options = this._getConfig(i)), (this._classes = this._getClasses(n)), (this.numberClicks = 0), this.init();
    }
    static get NAME() {
      return rn;
    }
    ...
    _getNotchData() {
      (this._notchMiddle = m.findOne(Dx, this._element)), (this._notchLeading = m.findOne(Ix, this._element));
    }
    _setChipsClass() {
      ...
      if (this.activeChip === null) i.remove(), this._handleEvents(e, fp);
        ...
        this.activeChip.remove(),
          ...
          this.allChips.forEach((a) => {
            a.hasAttribute(Wt) && (r.push(a), r.length > 1 && this.allChips.forEach((l) => l.remove()));
          });
      }
    }
    _handleUpEvents(e) {
      (this.numberClicks += 1), this.numberClicks === this.allChips.length + 1 && (this.numberClicks = 0), this._handleRightKeyboardArrow(this.numberClicks), this._handleEvents(e, Rx), this._handleEvents(e, Px);
    }
    _handleDownEvents(e) {
      (this.numberClicks -= 1), this.numberClicks <= 0 && (this.numberClicks = this.allChips.length), this._handleLeftKeyboardArrow(this.numberClicks), this._handleEvents(e, $x), this._handleEvents(e, Lx);
    }
    _keyboardEvents(e) {
      const { target: i, keyCode: n, ctrlKey: o } = e;
      i.value.length > 0 ||
        this.allChips.length === 0 ||
        (n === zy || n === jy ? this._handleDeleteEvents(e) : n === hs || n === ut ? this._handleUpEvents(e) : n === cs || n === ht ? this._handleDownEvents(e) : n === 65 && o && this._handleAddActiveClass());
    }
    _handleKeyboard() {
          ...
          _.on(i, 'dblclick', (n) => {
            ...
            _.on(document, 'click', ({ target: n }) => {
              ...
              !a &&
                ...
                r.textContent !== '' &&
                  setTimeout(() => {
                    g.addStyle(o, { display: 'block' }), o.classList.remove(...this._classes.opacity.split(' '));
                  }, 160)),
                r.textContent === '' &&
                  (setTimeout(() => {
    ...
    _handleClicksOnChips() {
      _.on(this._element, 'click', () => {
        this.allChips.length === 0 && (this.chipsInputWrapper.classList.remove(...this._classes.inputWrapperPadding.split(' ')), this.input.removeAttribute(Wt));
      });
    }
    _handleTextContent() {
      const e = [];
    ...
    _handleEvents(e, i) {
      ...
      _.trigger(this._element, i, { event: e, allChips: this.allChips, arrOfObjects: n, active: o, activeObj: { tag: o.length <= 0 ? '' : o[0].textContent.trim() } });
    }
    _handleChipsFocus() {
    ...
    _handleInitialValue() {
      if ((this._appendInputToElement(hp), this._element.hasAttribute(hp))) {
        ...
        e.forEach(({ tag: i }) => this._handleCreateChip(this.input, i)), m.findOne(zl, this.input.parentNode).setAttribute(us, ''), this.input.setAttribute(Wt, ''), this.input.setAttribute(us, '');
      }
    ...
    _handleKeysInputToElement(e) {
      ...
      if (i === Et) {
        if (n.value === '') return;
        this._handleCreateChip(n, n.value), this._handleRemoveActiveClass(), (this.numberClicks = this.allChips.length + 1), this._handleEvents(e, Mx);
      }
      this.allChips.length > 0
        ? (this.chipsInputWrapper.classList.add(...this._classes.inputWrapperPadding.split(' ')), this.chipsInputWrapper.classList.add(...this._classes.transition.split(' ')))
        : this.chipsInputWrapper.classList.remove(...this._classes.inputWrapperPadding.split(' '));
    }
    _handleInputText() {
      const e = m.findOne(kx, this._element);
      _.on(this._element, 'keyup', e, (i) => this._handleKeysInputToElement(i)), _.on(this.input, 'blur', (i) => this._handleBlurInput(i));
    }
    ...
    _handleCreateChip(e, i) {
      ...
      this._options.parentSelector !== '' ? document.querySelector(this._options.parentSelector).insertAdjacentHTML('beforeend', r.appendChip()) : e.insertAdjacentHTML('beforebegin', r.appendChip()),
        (e.value = ''),
        m.find(Fl).forEach((a) => {
    ...
    _handleAddActiveClassWithKebyboard(e) {
      let i;
      this.allChips[e - 1] === void 0 ? (i = this.allChips[e - 2]) : (i = this.allChips[e - 1]), i.setAttribute(Wt);
    }
    _getConfig(e) {
  ...
  const Ze = { plugins: { legend: { labels: { color: 'rgb(102,102,102)' } } } },
    ln = {
      line: {
        options: {
          ...Ze,
          elements: { line: { backgroundColor: 'rgba(59, 112, 202, 0.0)', borderColor: 'rgb(59, 112, 202)', borderWidth: 2, tension: 0 }, point: { borderColor: 'rgb(59, 112, 202)', backgroundColor: 'rgb(59, 112, 202)' } },
          responsive: !0,
          legend: { display: !0 },
          ...
          scales: {
            ...
            y: { stacked: !1, grid: { borderDash: [2], drawBorder: !1, zeroLineColor: 'rgba(0,0,0,0)', zeroLineBorderDash: [2], zeroLineBorderDashOffset: [2] }, ticks: { fontColor: 'rgba(0,0,0, 0.5)' } },
          },
        },
      },
      bar: {
        options: {
          ...
          scales: {
            x: { stacked: !0, grid: { display: !1 }, ticks: { fontColor: 'rgba(0,0,0, 0.5)' } },
            y: { stacked: !0, grid: { borderDash: [2], drawBorder: !1, zeroLineColor: 'rgba(0,0,0,0)', zeroLineBorderDash: [2], zeroLineBorderDashOffset: [2] }, ticks: { fontColor: 'rgba(0,0,0, 0.5)' } },
          },
        },
      },
      pie: { options: { ...Ze, elements: { arc: { backgroundColor: 'rgb(59, 112, 202)' } }, responsive: !0, legend: { display: !0 } } },
      doughnut: { options: { ...Ze, elements: { arc: { backgroundColor: 'rgb(59, 112, 202)' } }, responsive: !0, legend: { display: !0 } } },
      polarArea: { options: { ...Ze, elements: { arc: { backgroundColor: 'rgba(59, 112, 202, 0.5)' } }, responsive: !0, legend: { display: !0 } } },
      radar: {
        options: {
          ...Ze,
          elements: { line: { backgroundColor: 'rgba(59, 112, 202, 0.5)', borderColor: 'rgb(59, 112, 202)', borderWidth: 2 }, point: { borderColor: 'rgb(59, 112, 202)', backgroundColor: 'rgb(59, 112, 202)' } },
          responsive: !0,
          legend: { display: !0 },
        },
      },
      scatter: {
        options: {
          ...Ze,
          elements: { line: { backgroundColor: 'rgba(59, 112, 202, 0.5)', borderColor: 'rgb(59, 112, 202)', borderWidth: 2, tension: 0 }, point: { borderColor: 'rgb(59, 112, 202)', backgroundColor: 'rgba(59, 112, 202, 0.5)' } },
          responsive: !0,
          legend: { display: !0 },
          tooltips: { intersect: !1, mode: 'index' },
          datasets: { borderColor: 'red' },
      ...
      bubble: {
        options: {
          ...
          scales: {
            ...
            y: { grid: { borderDash: [2], drawBorder: !1, zeroLineColor: 'rgba(0,0,0,0)', zeroLineBorderDash: [2], zeroLineBorderDashOffset: [2] }, ticks: { fontColor: 'rgba(0,0,0, 0.5)' } },
          },
        },
      },
    };
  ...
  function Zx(s, t) {
    return bp(s, t) && !(Object.hasOwnProperty.call(s, t) && Object.propertyIsEnumerable.call(s, t));
  }
  function Qx(s, t, e) {
    var i = {};
    return (
      ...
      mp(t).forEach(function (n) {
        Zx(s, n) || (bp(s, n) && e.isMergeableObject(t[n]) ? (i[n] = Gx(n, e)(s[n], t[n], e)) : (i[n] = cn(t[n], e)));
      }),
      i
    );
  }
  function ps(s, t, e) {
    (e = e || {}), (e.arrayMerge = e.arrayMerge || Xx), (e.isMergeableObject = e.isMergeableObject || Fx), (e.cloneUnlessOtherwiseSpecified = cn);
  ...
  const vp = 'chart',
    ...
    Yl = (s, t, e) => {
      const i = (n, o, r) => {
        ...
        return (
          o.forEach((l, c) => {
            typeof a[c] > 'u' ? (a[c] = r.cloneUnlessOtherwiseSpecified(l, r)) : r.isMergeableObject(l) ? (a[c] = jl(n[c], l, r)) : n.indexOf(l) === -1 && a.push(l);
          }),
          a
        );
      };
    ...
    eC = { darkTicksColor: '#fff', darkLabelColor: '#fff', darkGridLinesColor: '#555', darkmodeOff: 'undefined', darkMode: null, darkBgColor: '#262626', darkBgColorLight: '#fff', options: null },
    iC = { darkTicksColor: 'string', darkLabelColor: 'string', darkGridLinesColor: 'string', darkmodeOff: '(string|null)', darkMode: '(string|null)', darkBgColor: 'string', darkBgColorLight: 'string', options: '(object|null)' };
  let yp = class am {
    constructor(t, e, i = {}, n = {}) {
    ...
    async _getChartjs() {
      ...
      return t.register(e, i, n, o, r, a, l, c, h, d, u, p, f, b, v, y, T, x, E, C, A, w, S, k), t;
    }
    ...
    async _waitForCharts(t, e, i = {}, n = {}) {
      if (
        ...
        (this._observer = null),
        this._element && (O.setData(t, ar, this), g.addClass(this._element, tC), this._chartConstructor()),
        ...
        this._handleMode(o), (this._observer = new MutationObserver(this._observerCallback.bind(this))), this._observer.observe(this._darkModeClassContainer, { attributes: !0 });
      }
    }
    static get NAME() {
      return vp;
    ...
    dispose() {
      this._observer.disconnect(), O.removeData(this._element, ar), (this._element = null);
    }
    update(t, e) {
      t && ((this._data = { ...this._data, ...t }), (this._chart.data = this._data));
      const i = Object.prototype.hasOwnProperty.call(e, 'options') ? e : { options: { ...e } };
      (this._options = jl(this._options, i)), (this._chart.options = Yl(this._options, this._type, ln).options), this._chart.update();
    }
    setTheme(t) {
    ...
    _getDarkConfig(t) {
      ...
      Object.keys(i).forEach((c) => c.startsWith('dark') && (e[c] = i[c])), (e = { ...eC, ...e });
      const n = { y: { ticks: { color: e.darkTicksColor }, grid: { color: e.darkGridLinesColor } }, x: { ticks: { color: e.darkTicksColor }, grid: { color: e.darkGridLinesColor } } },
        o = { r: { ticks: { color: e.darkTicksColor, backdropColor: e.darkBgColor }, grid: { color: e.darkGridLinesColor }, pointLabels: { color: e.darkTicksColor } } },
        l = { scales: ['pie', 'doughnut', 'polarArea', 'radar'].includes(this._type) ? (['polarArea', 'radar'].includes(this._type) ? o : {}) : n, plugins: { legend: { labels: { color: e.darkLabelColor } } } };
    ...
    _chartConstructor() {
      if (this._data) {
        ...
        const t = Yl(this._options, this._type, ln),
          e = [];
        t.dataLabelsPlugin && e.push(this._ChartDataLabels.default), (this._prevConfig = t), (this._chart = new this._Chartjs(this._canvas, { ...this._data, ...t, plugins: e }));
      }
    }
    _createCanvas() {
  ...
  var Tp = typeof Element < 'u' && (Element.prototype.matches || Element.prototype.webkitMatchesSelector || Element.prototype.mozMatchesSelector || Element.prototype.msMatchesSelector);
  function Qe(s, t) {
  ...
  function nC(s, t, e, i, n) {
    ...
    (s.reach[l] = null),
      ...
      t && (d.dispatchEvent(cr('ps-scroll-' + l)), t < 0 ? d.dispatchEvent(cr('ps-scroll-' + c)) : t > 0 && d.dispatchEvent(cr('ps-scroll-' + h)), i && sC(s, l)),
      s.reach[l] && (t || n) && d.dispatchEvent(cr('ps-' + l + '-reach-' + s.reach[l]));
  }
  function st(s) {
    return parseInt(s, 10) || 0;
  }
  function oC(s) {
    return Qe(s, 'input,[contenteditable]') || Qe(s, 'select,[contenteditable]') || Qe(s, 'textarea,[contenteditable]') || Qe(s, 'button,[contenteditable]');
  }
  function rC(s) {
    var t = me(s);
    return st(t.width) + st(t.paddingLeft) + st(t.paddingRight) + st(t.borderLeftWidth) + st(t.borderRightWidth);
  }
  var gs = {
  ...
  function Se(s) {
    ...
    (s.containerWidth = Math.round(i.width)),
      ...
      !s.settings.suppressScrollX && s.containerWidth + s.settings.scrollXMarginOffset < s.contentWidth
        ? ((s.scrollbarXActive = !0),
          (s.railXWidth = s.containerWidth - s.railXMarginWidth),
          (s.railXRatio = s.containerWidth / s.railXWidth),
          (s.scrollbarXWidth = kp(s, st((s.railXWidth * s.containerWidth) / s.contentWidth))),
          (s.scrollbarXLeft = st(((s.negativeScrollAdjustment + t.scrollLeft) * (s.railXWidth - s.scrollbarXWidth)) / (s.contentWidth - s.containerWidth))))
        : (s.scrollbarXActive = !1),
      !s.settings.suppressScrollY && s.containerHeight + s.settings.scrollYMarginOffset < s.contentHeight
        ? ((s.scrollbarYActive = !0),
          (s.railYHeight = s.containerHeight - s.railYMarginHeight),
          (s.railYRatio = s.containerHeight / s.railYHeight),
          (s.scrollbarYHeight = kp(s, st((s.railYHeight * s.containerHeight) / s.contentHeight))),
          (s.scrollbarYTop = st((e * (s.railYHeight - s.scrollbarYHeight)) / (s.contentHeight - s.containerHeight))))
        : (s.scrollbarYActive = !1),
      s.scrollbarXLeft >= s.railXWidth - s.scrollbarXWidth && (s.scrollbarXLeft = s.railXWidth - s.scrollbarXWidth),
      s.scrollbarYTop >= s.railYHeight - s.scrollbarYHeight && (s.scrollbarYTop = s.railYHeight - s.scrollbarYHeight),
      aC(t, s),
      s.scrollbarXActive ? t.classList.add(at.state.active('x')) : (t.classList.remove(at.state.active('x')), (s.scrollbarXWidth = 0), (s.scrollbarXLeft = 0), (t.scrollLeft = s.isRtl === !0 ? s.contentWidth : 0)),
      s.scrollbarYActive ? t.classList.add(at.state.active('y')) : (t.classList.remove(at.state.active('y')), (s.scrollbarYHeight = 0), (s.scrollbarYTop = 0), (t.scrollTop = 0));
  }
  function kp(s, t) {
  ...
  function aC(s, t) {
    ...
    t.isRtl ? (e.left = t.negativeScrollAdjustment + s.scrollLeft + t.containerWidth - t.contentWidth) : (e.left = s.scrollLeft),
    ...
    t.isScrollbarYUsingRight
      ? t.isRtl
        ? (n.right = t.contentWidth - (t.negativeScrollAdjustment + s.scrollLeft) - t.scrollbarYRight - t.scrollbarYOuterWidth - 9)
        : (n.right = t.scrollbarYRight - s.scrollLeft)
      : t.isRtl
        ? (n.left = t.negativeScrollAdjustment + s.scrollLeft + t.containerWidth * 2 - t.contentWidth - t.scrollbarYLeft - t.scrollbarYOuterWidth)
        : (n.left = t.scrollbarYLeft + s.scrollLeft),
      Ot(t.scrollbarYRail, n),
      Ot(t.scrollbarX, { left: t.scrollbarXLeft, width: t.scrollbarXWidth - t.railBorderXWidth }),
      Ot(t.scrollbarY, { top: t.scrollbarYTop, height: t.scrollbarYHeight - t.railBorderYWidth });
  }
  function lC(s) {
    s.element,
      ...
      s.event.bind(s.scrollbarYRail, 'mousedown', function (t) {
        ...
        (s.element.scrollTop += i * s.containerHeight), Se(s), t.stopPropagation();
      }),
      ...
      s.event.bind(s.scrollbarXRail, 'mousedown', function (t) {
        ...
        (s.element.scrollLeft += i * s.containerWidth), Se(s), t.stopPropagation();
      });
  }
  function cC(s) {
    Sp(s, ['containerWidth', 'contentWidth', 'pageX', 'railXWidth', 'scrollbarX', 'scrollbarXWidth', 'scrollLeft', 'x', 'scrollbarXRail']),
      Sp(s, ['containerHeight', 'contentHeight', 'pageY', 'railYHeight', 'scrollbarY', 'scrollbarYHeight', 'scrollTop', 'y', 'scrollbarYRail']);
  }
  function Sp(s, t) {
    var e = t[0],
      i = t[1],
      ...
      f = null;
    function b(T) {
      T.touches && T.touches[0] && (T[n] = T.touches[0].pageY), (d[l] = u + f * (T[n] - p)), Cp(s, c), Se(s), T.stopPropagation(), T.type.startsWith('touch') && T.changedTouches.length > 1 && T.preventDefault();
    }
    function v() {
      Ap(s, c), s[h].classList.remove(at.state.clicking), s.event.unbind(s.ownerDocument, 'mousemove', b);
    }
    function y(T, x) {
      (u = d[l]),
        ...
        (p = T[n]),
        (f = (s[i] - s[e]) / (s[o] - s[a])),
        x ? s.event.bind(s.ownerDocument, 'touchmove', b) : (s.event.bind(s.ownerDocument, 'mousemove', b), s.event.once(s.ownerDocument, 'mouseup', v), T.preventDefault()),
  ...
  function hC(s) {
    ...
    s.event.bind(s.ownerDocument, 'keydown', function (o) {
      if (!((o.isDefaultPrevented && o.isDefaultPrevented()) || o.defaultPrevented) && !(!e() && !i())) {
        ...
        (s.settings.suppressScrollX && a !== 0) || (s.settings.suppressScrollY && l !== 0) || ((t.scrollTop -= l), (t.scrollLeft += a), Se(s), n(a, l) && o.preventDefault());
      }
    });
  }
  function dC(s) {
    ...
    function e(r, a) {
      var l = Math.floor(t.scrollTop),
        ...
        p;
      return Math.abs(a) > Math.abs(r) ? (p = c || h) : (p = d || u), p ? !s.settings.wheelPropagation : !0;
    }
    function i(r) {
      var a = r.deltaX,
        l = -1 * r.deltaY;
      ...
      if (!n(r.target, l, c)) {
        ...
        s.settings.useBothWheelAxes
          ? s.scrollbarYActive && !s.scrollbarXActive
            ? (c ? (t.scrollTop -= c * s.settings.wheelSpeed) : (t.scrollTop += l * s.settings.wheelSpeed), (h = !0))
            : s.scrollbarXActive && !s.scrollbarYActive && (l ? (t.scrollLeft += l * s.settings.wheelSpeed) : (t.scrollLeft -= c * s.settings.wheelSpeed), (h = !0))
          : ((t.scrollTop -= c * s.settings.wheelSpeed), (t.scrollLeft += l * s.settings.wheelSpeed)),
          Se(s),
          (h = h || e(l, c)),
  ...
  function uC(s) {
    ...
    function e(f, b) {
      var v = Math.floor(t.scrollTop),
        ...
        x = Math.abs(b);
      if (x > T) {
        if ((b < 0 && v === s.contentHeight - s.containerHeight) || (b > 0 && v === 0)) return window.scrollY === 0 && b > 0 && gs.isChrome;
    ...
    function d(f, b, v) {
      ...
      for (var y = f; y && y !== t; ) {
        ...
        if (v && T.overflowY.match(/(scroll|auto)/)) {
          ...
          if (x > 0 && ((y.scrollTop > 0 && v < 0) || (y.scrollTop < x && v > 0))) return !0;
        }
        if (b && T.overflowX.match(/(scroll|auto)/)) {
          var E = y.scrollWidth - y.clientWidth;
          if (E > 0 && ((y.scrollLeft > 0 && b < 0) || (y.scrollLeft < E && b > 0))) return !0;
        }
        y = y.parentNode;
      }
      return !1;
    ...
    function u(f) {
      if (c(f)) {
        ...
        var x = new Date().getTime(),
          E = x - o;
        E > 0 && ((r.x = y / E), (r.y = T / E), (o = x)), e(y, T) && f.preventDefault();
      }
    }
    function p() {
    ...
    gs.supportsTouch
      ? (s.event.bind(t, 'touchstart', h), s.event.bind(t, 'touchmove', u), s.event.bind(t, 'touchend', p))
      : gs.supportsIePointer &&
        (window.PointerEvent
          ? (s.event.bind(t, 'pointerdown', h), s.event.bind(t, 'pointermove', u), s.event.bind(t, 'pointerup', p))
          : window.MSPointerEvent && (s.event.bind(t, 'MSPointerDown', h), s.event.bind(t, 'MSPointerMove', u), s.event.bind(t, 'MSPointerUp', p)));
  }
  var pC = function () {
      return {
    ...
    fC = { 'click-rail': lC, 'drag-thumb': cC, keyboard: hC, wheel: dC, touch: uC },
    dn = function (t, e) {
      var i = this;
      ...
      (this.scrollbarXBottom = parseInt(a.bottom, 10)),
        isNaN(this.scrollbarXBottom) ? ((this.isScrollbarXUsingBottom = !1), (this.scrollbarXTop = st(a.top))) : (this.isScrollbarXUsingBottom = !0),
        (this.railBorderXWidth = st(a.borderLeftWidth) + st(a.borderRightWidth)),
      ...
      (this.scrollbarYRight = parseInt(l.right, 10)),
        isNaN(this.scrollbarYRight) ? ((this.isScrollbarYUsingRight = !1), (this.scrollbarYLeft = st(l.left))) : (this.isScrollbarYUsingRight = !0),
        (this.scrollbarYOuterWidth = this.isRtl ? rC(this.scrollbarY) : null),
        (this.railBorderYWidth = st(l.borderTopWidth) + st(l.borderBottomWidth)),
  ...
  (dn.prototype.update = function () {
    this.isAlive &&
      ...
      Ot(this.scrollbarXRail, { display: 'block' }),
      Ot(this.scrollbarYRail, { display: 'block' }),
      (this.railXMarginWidth = st(me(this.scrollbarXRail).marginLeft) + st(me(this.scrollbarXRail).marginRight)),
      (this.railYMarginHeight = st(me(this.scrollbarYRail).marginTop) + st(me(this.scrollbarYRail).marginBottom)),
  ...
  const Kl = 'perfectScrollbar',
    ...
    vC = { ps: 'string', railX: 'string', railXColors: 'string', railXThumb: 'string', railXThumbColors: 'string', railY: 'string', railYColors: 'string', railYThumb: 'string', railYThumbColors: 'string' };
  class ms {
    constructor(t, e = {}, i = {}) {
      (this._element = t),
        (this._options = this._getConfig(e)),
        ...
        this._element && (O.setData(t, dr, this), g.addClass(this._element, _C)),
        this.init();
    }
    static get NAME() {
      return Kl;
    ...
    _getConfig(t) {
      const e = g.getDataAttributes(this._element);
      return e.handlers !== void 0 && (e.handlers = e.handlers.split(' ')), (t = { ...gC, ...e, ...t }), L(Kl, t, mC), t;
    }
    _getClasses(t) {
      const e = g.getDataClassAttributes(this._element);
    ...
    init() {
      if (((this.perfectScrollbar = new dn(this._element, this._options)), this._addPerfectScrollbarStyles(), this._updateScrollPosition(), this.perfectScrollbar.update(), this._initEvents(Ul), this._options.positionRight)) {
    ...
    _initEvents(t = []) {
      t.forEach(({ ps: e, te: i }) => _.on(this._element, e, (n) => _.trigger(this._element, i, { e: n })));
    }
    ...
    static jQueryInterface(t) {
      return this.each(function () {
        ...
        if (!(!e && /dispose|hide/.test(t)) && (e || (e = new ms(this, i)), typeof t == 'string')) {
          if (typeof e[t] > 'u') throw new TypeError(`No method named "${t}"`);
          e[t]();
        }
      });
  ...
  const yC = 'data-te-datatable-select-ref',
    ...
    wC = (
      { text: s, entries: t, entriesOptions: e, fullPagination: i, rowsText: n, allText: o, paginationStartIconTemplate: r, paginationLeftIconTemplate: a, paginationRightIconTemplate: l, paginationEndIconTemplate: c, classes: h },
      d,
      u
    ) => {
...
`;
  ...
  `
          : '<th scope="col"></th>',
        c = s.map((h, d) => {
          const u = h.fixed ? s.filter((p, f) => p.fixed === h.fixed && f < d).reduce((p, f) => p + f.width, 0) : null;
          return `<th class="${a.column} ${i ? `${a.tableBordered}` : ''} ${a.borderColor} ${n ? `${a.sm}` : ''} ${h.fixed ? `${a.fixedHeader} ${a.color}` : ''} ${o ? `${a.loadingColumn}` : ''}" style="${
            h.fixed ? `${h.fixed === 'right' ? 'right' : 'left'}: ${u}px;` : ''
          }" scope="col">${h.sort ? `<div class="${a.sortIconWrapper}"><span class="${a.sortIcon} ${o ? 'invisible' : ''}" data-te-sort="${h.field}" ${kC}>${r}</span>` : ''} <span class="${h.sort ? '' : 'pl-[18px]'}">${
            h.label
          }</span></div></th>`;
        });
      return [t ? l : '', ...c].join(`
`);
    ...
    LC = ({ rows: s, columns: t, noFoundMessage: e, edit: i, selectable: n, loading: o, bordered: r, borderless: a, striped: l, hover: c, sm: h, classes: d }) => {
      const u = s.map((p) => {
        const f = `
      <td data-te-field="checkbox" class="${r ? `${d.tableBordered} ${d.borderColor}` : ''}">
        <div class="${d.checkboxRowWrapper}">
          ...
          b = t
            .map((v, y) => {
              const T = {};
              if ((v.width && ((T['min-width'] = `${v.width - 1}px`), (T['max-width'] = `${v.width}px`), (T.width = `${v.width}px`)), v.fixed)) {
                const E = t.filter((C, A) => C.fixed === v.fixed && A < y).reduce((C, A) => C + A.width, 0);
                T[v.fixed === 'right' ? 'right' : 'left'] = `${E}px`;
              }
              return `<td style="${Object.keys(T)
                .map((E) => `${E}: ${T[E]}`)
                .join('; ')}" class="${d.rowItem} ${d.borderColor} ${i ? `${d.edit}` : ''} ${r ? `${d.tableBordered}` : ''} ${h ? `${d.sm}` : ''} ${v.fixed ? `${d.fixedHeader} ${d.color}` : ''}" ${MC} data-te-field="${v.field}" ${
                i && 'contenteditable="true"'
              }>${p[v.field]}</td>`;
            })
            .join('');
        return `<tr scope="row" class="${d.row} ${d.borderColor} ${d.rowAnimation} ${l ? `${d.striped}` : ''} ${a ? `${d.borderless}` : ''} ${c ? `${d.hoverRow}` : ''}" data-te-index="${p.rowIndex}" ${IC}>${n ? f : ''}${b}</tr>`;
      });
      return s.length > 0 || o
        ? u.join(`
`)
    ...
    Op = ({
      ...
      const y = LC({ rows: t, columns: s, noFoundMessage: e, edit: i, loading: r, selectable: o, bordered: c, borderless: h, striped: d, hover: u, sm: f, classes: v }),
...
${l.enable ? wC(l, r, c) : ''}
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M11.25 4.5l7.5 7.5-7.5 7.5m-6-15l7.5 7.5-7.5 7.5"/>
    ...
    pA = 'pointer-events-none cursor-none text-neutral-400 dark:text-neutral-300',
    fA = 'h-[2px] relative w-full overflow-hidden',
    _A = 'text-center text-neutral-500 font-ligh text-sm my-4 dark:text-neutral-400',
    ...
    EA = 'border-b',
    xA = 'flex md:flex-row justify-end items-center py-2 space-x-4 text-sm flex-col leading-[1.6]',
    ...
    RA = 'relative',
    PA = '!bg-neutral-100 dark:!bg-neutral-600',
    NA = 'flex items-center space-x-4 order-3 md:order-none',
    BA = 'w-[70px]',
    HA = '!py-2',
    VA = 'w-[15px] h-[10px] origin-bottom font-black mr-1 opacity-0 text-neutral-500 group-hover:opacity-100 transition hover:ease-in-out transform ease-linear duration-300 motion-reduce:transition-none dark:text-neutral-400',
    FA = 'flex flex-row group',
    WA = '[&:nth-child(odd)]:bg-neutral-50 [&:nth-child(odd)]:dark:bg-neutral-700',
    zA = 'border',
    ...
    XA = { label: 'string', field: 'string', fixed: '(boolean|string)', format: '(function|null)', width: '(number|null)', sort: 'boolean', columnIndex: 'number' },
    GA = { label: '', field: '', fixed: !1, format: null, width: null, sort: !0, columnIndex: 0 },
    qA = {
      table: YA,
      tableHeader: jA,
      column: lA,
  ...
  class pr {
    constructor(t, e = {}, i = {}, n = {}) {
      (this._element = t),
        ...
        this._element && (O.setData(t, pn, this), (this._perfectScrollbar = null), this._setup());
    }
    static get NAME() {
      return un;
    }
    get columns() {
      return this._columns.map((t, e) => {
        ...
        return typeof t == 'string' ? (i.label = t) : typeof t == 'object' && (i = { ...i, ...t }), L('column', i, XA), i;
      });
    }
    get rows() {
    ...
    get computedRows() {
      ...
      return (
        this._options.sortOrder && (t = PC({ rows: t, field: this._options.sortField, order: this._options.sortOrder })),
        this._options.pagination && (this._options.entries === 'All' ? (t = Ip({ rows: t, entries: t.length, activePage: this._activePage })) : (t = Ip({ rows: t, entries: this._options.entries, activePage: this._activePage }))),
        t
      );
    }
    get pages() {
    ...
    dispose() {
      this._selectInstance && this._selectInstance.dispose(), O.removeData(this._element, pn), this._removeEventListeners(), this._perfectScrollbar.destroy(), (this._element = null);
    }
    search(t, e) {
      (this._search = t),
    ...
    sort(t, e = 'asc') {
      ...
      const i = m.findOne(`[data-te-sort="${this._options.sortField}"]`, this._element);
    ...
    _emitSelectEvent() {
      _.trigger(this._element, UC, { selectedRows: this.rows.filter((t) => this._selected.indexOf(t.rowIndex) !== -1), selectedIndexes: this._selected, allSelected: this._selected.length === this.rows.length });
    }
    _getRows(t = []) {
    ...
    _getColumns(t = []) {
      ...
      return [...m.find('th', i).map((o) => ({ label: o.innerHTML, ...g.getDataAttributes(o) })), ...t];
    }
    _getCSSValue(t) {
    ...
    _setActiveRows() {
      m.find(fn, this._element).forEach((t) => {
        this._selected.includes(g.getDataAttribute(t, 'index')) ? g.addClass(t, `active ${this._classes.selectableRow}`) : g.removeClass(t, `active ${this._classes.selectableRow}`);
      });
    }
    _setEntries(t) {
    ...
    _setActiveSortIcon(t) {
      m.find(Gl, this._element).forEach((e) => {
        ...
        g.style(e, { transform: `rotate(${i}deg)` }), e === t && this._options.sortOrder ? g.addClass(e, 'opacity-100') : g.removeClass(e, 'opacity-100');
      });
    }
    _setup() {
      this._renderTable(),
    ...
    _setupClickableRows() {
      m.find(fn, this._element).forEach((t) => {
        ...
        g.addClass(t, 'cursor-pointer'),
          _.on(t, 'click', (i) => {
            m.matches(i.target, ql) || _.trigger(this._element, XC, { index: e, row: this.rows[e] });
          });
      });
    }
    _setupEditable() {
    ...
    _setupScroll() {
      ...
      if ((g.style(t, e), g.addClass(t, `${this._classes.scroll}`), this._options.fixedHeader)) {
        let i = m.find(HC, this._element);
        this._options.selectable && (i = i.filter((n, o) => (g.addClass(n, `${this._classes.fixedHeader} ${this._classes.color}`), o !== 0))),
          i.forEach((n, o) => {
            g.addClass(n, `${this._classes.fixedHeader} ${this._classes.color}`), this.columns[o].fixed && g.addClass(n, '!z-40');
          });
      }
    ...
    _setupPagination() {
      (this._paginationRight = m.findOne(FC, this._element)),
        ...
        _.on(this._paginationRight, 'click', () => this._changeActivePage(this._activePage + 1)),
        _.on(this._paginationLeft, 'click', () => this._changeActivePage(this._activePage - 1)),
        this._options.fullPagination &&
          ...
          _.on(this._paginationEnd, 'click', () => this._changeActivePage(this.pages - 1))),
        this._toggleDisableState(),
        this._setupPaginationSelect();
    }
    _setupPaginationSelect() {
      (this._select = m.findOne(KC, this._element)), (this._selectInstance = new on(this._select)), _.on(this._select, 'valueChange.te.select', (t) => this._setEntries(t));
    }
    _removeEventListeners() {
      this._options.pagination &&
        ...
        this._options.fullPagination && (_.off(this._paginationStart, 'click'), _.off(this._paginationEnd, 'click'))),
        this._options.edit &&
    ...
    _renderTable() {
      (this._element.innerHTML = Op(this.tableOptions).table), this._formatCells(), _.trigger(this._element, Dp);
    }
    _renderRows() {
    ...
    _toggleDisableState() {
      this._options.pagination !== !1 &&
        (this._activePage === 0 || this._options.loading
          ? (this._paginationLeft.setAttribute('disabled', ''), this._options.fullPagination && this._paginationStart.setAttribute('disabled', ''))
        ...
        this._activePage === this.pages - 1 || this._options.loading || this.pages === 0
          ? (this._paginationRight.setAttribute('disabled', ''), this._options.fullPagination && this._paginationEnd.setAttribute('disabled', ''))
    ...
    static jQueryInterface(t, e, i) {
      return this.each(function () {
        ...
        if (!(!n && /dispose/.test(t)) && (n || (n = new pr(this, o, e)), typeof t == 'string')) {
          if (typeof n[t] > 'u') throw new TypeError(`No method named "${t}"`);
          n[t](e, i);
        }
      });
  ...
  const Mp = 'rating',
    ...
    tw = 'ArrowLeft',
    ew = 'ArrowRight',
    iw = { tooltip: 'string', value: '(string|number)', readonly: 'boolean', after: 'string', before: 'string', dynamic: 'boolean', active: 'string' },
    sw = { tooltip: 'top', value: '', readonly: !1, after: '', before: '', dynamic: !1, active: 'fill-current' },
    Lp = `onSelect${bs}`,
    nw = `onHover${bs}`,
    $p = `keyup${bs}`,
    Rp = `focusout${bs}`,
  ...
  class Bp {
      ...
      O.removeData(this._element, fr),
        this._options.readonly ||
          ...
          this._icons.forEach((t, e) => {
            _.off(t, Np), t.removeEventListener('mouseenter', this._fn.mouseenter[e]), g.removeClass(t, 'cursor-pointer');
          }),
        ...
        this._icons.forEach((t, e) => {
          t.addEventListener(
            ...
            (this._fn.mouseenter[e] = (i) => {
              (this._index = this._icons.indexOf(i.target)), this._updateRating(this._index), this._triggerEvents(t, nw);
            })
          );
        });
    }
    ...
    _bindMouseDown() {
      this._icons.forEach((t) => {
        _.on(t, Np, () => {
          this._setElementOutline('none'), (this._savedIndex = this._index), this._triggerEvents(t, Lp);
        });
      });
    }
    _bindKeyDown() {
      (this._element.tabIndex = 0), _.on(this._element, Pp, (t) => this._updateAfterKeyDown(t));
    }
    _bindKeyUp() {
    ...
    _updateAfterKeyDown(t) {
      ...
      t.key === ew && this._index < e && (this._index += 1),
        ...
        i !== this._index && ((this._savedIndex = this._index), this._updateRating(this._savedIndex), this._triggerEvents(this._icons[this._savedIndex], Lp));
    }
    _updateRating(t) {
      this._clearRating(),
    ...
    _clearRating() {
      this._icons.forEach((t, e) => {
        ...
        this._options.dynamic && ((t.classList = this._originalClassList[e]), (i.innerHTML = this._originalIcons[e])), g.removeClass(i, this._options.active);
      });
    }
    _setToolTips() {
      this._icons.forEach((t, e) => {
        const i = g.getDataAttribute(t, 'toggle');
        t.title && !i && (g.setDataAttribute(t, 'toggle', 'tooltip'), (this._tooltips[e] = new is(t, { placement: this._options.tooltip })));
      });
    }
    _setCustomText() {
      this._icons.forEach((t) => {
  ...
  const Zl = 'popconfirm',
    ...
    cw = { popconfirmMode: 'string', message: 'string', cancelText: '(null|string)', okText: '(null|string)', popconfirmIconTemplate: 'string', cancelLabel: '(null|string)', confirmLabel: '(null|string)', position: '(null|string)' },
    hw = { popconfirmMode: 'inline', message: 'Are you sure?', cancelText: 'Cancel', okText: 'OK', popconfirmIconTemplate: '', cancelLabel: 'Cancel', confirmLabel: 'Confirm', position: 'bottom' },
    dw = { backdrop: 'string', body: 'string', btnCancel: 'string', btnConfirm: 'string', btnsContainer: 'string', fade: 'string', icon: 'string', message: 'string', messageText: 'string', modal: 'string', popover: 'string' },
    uw = {
  ...
  class _r {
    constructor(t, e, i) {
      (this._element = t),
        ...
        (this._confirmButton = ''),
        (this._isOpen = !1),
        (this._uid = this._element.id ? `popconfirm-${this._element.id}` : bt('popconfirm-')),
    ...
    dispose() {
      (this._isOpen || this.container !== null) && this.close(), O.removeData(this._element, _n), _.off(this._element, 'click', this._clickHandler), (this._element = null);
    }
    open() {
      this._isOpen ||
        (this._options.popconfirmMode === 'inline' ? this._openPopover(this._getPopoverTemplate()) : this._openModal(this._getModalTemplate()),
    ...
    close() {
      if (this._isOpen) {
        if (this._popper !== null || m.findOne(`[${Ql}]`) !== null) _.on(this.popconfirmBody, 'transitionend', this._handlePopconfirmTransitionEnd.bind(this)), g.removeClass(this.popconfirmBody, 'opacity-100');
        else {
          const t = m.findOne(`[${Vp}]`);
          g.removeClass(this.popconfirmBody, 'opacity-100'), document.body.removeChild(t), (this._isOpen = !1);
        }
        _.off(document, 'click', this._handleOutsideClick.bind(this)), _.off(document, 'keydown', this._handleEscapeKey.bind(this));
      }
    }
    _handlePopconfirmTransitionEnd(t) {
      if (t.target !== this.popconfirmBody) return;
      const e = m.findOne(`[${Ql}]`);
      _.off(this.popconfirmBody, 'transitionend'), this._isOpen && t && t.propertyName === 'opacity' && (this._popper.destroy(), e && document.body.removeChild(e), (this._isOpen = !1));
    }
    _getPopoverTemplate() {
      const t = $('div'),
        e = this._getPopconfirmTemplate();
      return t.setAttribute(Ql, ''), g.addClass(t, this._classes.popover), (t.id = this._uid), (t.innerHTML = e), t;
    }
    _getModalTemplate() {
      const t = $('div'),
        e = this._getPopconfirmTemplate();
      return t.setAttribute(lw, ''), g.addClass(t, `${this._classes.modal}`), (t.id = this._uid), (t.innerHTML = e), t;
    }
    ...
    _getConfig(t) {
      return (t = { ...hw, ...g.getDataAttributes(this._element), ...t }), L(Zl, t, cw), t;
    }
    _getClasses(t) {
      const e = g.getDataClassAttributes(this._element);
    ...
    _openPopover(t) {
      (this._popper = Fe(this._element, t, { placement: this._translatePositionValue(), modifiers: [{ name: 'offset', options: { offset: [0, 5] } }] })),
        document.body.appendChild(t),
        setTimeout(() => {
          g.addClass(this.popconfirmBody, `${this._classes.fade} opacity-100`), (this._isOpen = !0);
        }, 0);
    }
    _openModal(t) {
      const e = $('div');
      e.setAttribute(Vp, ''), g.addClass(e, this._classes.backdrop), document.body.appendChild(e), e.appendChild(t), g.addClass(this.popconfirmBody, 'opacity-100'), (this._isOpen = !0);
    }
...
`,
  ...
  class ys {
    ...
    get options() {
      const t = { ...xw, ...g.getDataAttributes(this._element), ...this._options };
      return L(Jl, t, Ew), t;
    }
    init() {
    ...
    zoomIn() {
      this._zoom >= 3 || (this._triggerEvents('zoomIn', 'zoomedIn'), (this._zoom += parseFloat(this.options.zoomLevel)), g.style(this.currentImg.parentNode, { transform: `scale(${this._zoom})` }), this._updateZoomBtn());
    }
    zoomOut() {
      this._zoom <= 1 ||
        (this._triggerEvents('zoomOut', 'zoomedOut'), (this._zoom -= parseFloat(this.options.zoomLevel)), g.style(this.currentImg.parentNode, { transform: `scale(${this._zoom})` }), this._updateZoomBtn(), this._updateImgPosition());
    }
    toggleFullscreen() {
      this._fullscreen === !1
        ? (this._fullscreenBtn.setAttribute(ye, ''), (this._fullscreenBtn.innerHTML = this.options.hideFullscreenIconTemplate), this._gallery.requestFullscreen && this._gallery.requestFullscreen(), (this._fullscreen = !0))
        : (this._fullscreenBtn.removeAttribute(ye), document.exitFullscreen && document.exitFullscreen(), (this._fullscreen = !1));
    }
    reset() {
    ...
    dispose() {
      _.off(document, vs, pw, this.toggle), this._galleryContent && this._removeEvents(), this._gallery && this._gallery.remove(), O.removeData(this._element, gn), (this._element = null);
    }
    _getClasses(t) {
      const e = g.getDataClassAttributes(this._element);
    ...
    _appendContent() {
      (this._galleryContent = $('div')), g.addClass(this._galleryContent, `${this._classes.galleryContent}`), this._gallery.append(this._galleryContent);
    }
    _appendLoader() {
      this._loader = $('div');
      const t = $('div'),
    ...
    _appendArrows() {
      (this._leftArrowWrapper = $('div')), g.addClass(this._leftArrowWrapper, `${this._classes.prevBtnWrapper}`);
      const t = $('button');
      t.setAttribute('aria-label', 'Previous'),
        ...
        this._getImages(),
        !(this._images.length <= 1) && (this._gallery.append(this._leftArrowWrapper), this._gallery.append(this._rightArrowWrapper));
    }
    _appendCaption() {
      const t = $('div'),
        e = $('p');
      e.setAttribute(Wp, ''), g.addClass(t, `${this._classes.captionWrapper}`), g.addClass(e, `${this._classes.caption}`), t.append(e), this._gallery.append(t);
    }
    _sortImages() {
    ...
    _addImgStyles(t, e, i, n, o) {
      (t.alt = o.alt),
        ...
        i === 0 ? (o.width < o.height && g.addClass(t, `${this._classes.vertical}`), g.style(e, { opacity: 1 }), t.setAttribute(ye, '')) : t.removeAttribute(ye),
        n === this._images.length - 1 && this._images.length > 1 && g.style(e, { left: '-100%' });
    }
    _resizeImages(t) {
      t.forEach((e) => {
    ...
    _calculateImgSize(t) {
      t.width >= t.height
        ? ((t.style.width = '100%'), (t.style.maxWidth = '100%'), (t.style.height = 'auto'), (t.style.top = `${(t.parentNode.offsetHeight - t.height) / 2}px`), (t.style.left = 0))
        : ((t.style.height = '100%'), (t.style.maxHeight = '100%'), (t.style.width = 'auto'), (t.style.left = `${(t.parentNode.offsetWidth - t.width) / 2}px`), (t.style.top = 0)),
        t.width >= t.parentNode.offsetWidth && ((t.style.width = `${t.parentNode.offsetWidth}px`), (t.style.height = 'auto'), (t.style.left = 0), (t.style.top = `${(t.parentNode.offsetHeight - t.height) / 2}px`)),
        t.height >= t.parentNode.offsetHeight && ((t.style.height = `${t.parentNode.offsetHeight}px`), (t.style.width = 'auto'), (t.style.top = 0), (t.style.left = `${(t.parentNode.offsetWidth - t.width) / 2}px`)),
    ...
    _onFullscreenChange() {
      (document.webkitIsFullScreen || document.mozFullScreen || document.msFullscreenElement) === void 0 &&
        ((this._fullscreen = !1), (this._fullscreenBtn.innerHTML = this.options.showFullscreenIconTemplate), this._fullscreenBtn.removeAttribute(ye));
    }
    _beforeSlideEvents() {
    ...
    _slideHorizontally(t) {
      (this._images = m.find('img', this._galleryContent)),
        this._images.forEach((e) => {
          let i;
          t === 'right' ? ((i = parseInt(e.parentNode.style.left, 10) - 100), i < -100 && (i = (this._images.length - 2) * 100)) : ((i = parseInt(e.parentNode.style.left, 10) + 100), i === (this._images.length - 1) * 100 && (i = -100)),
            this._slideImg(e, i);
        }),
        this._updateActiveImg(t);
    }
    _slideImg(t, e) {
      e === 0 ? (t.setAttribute(ye, ''), g.style(t.parentNode, { opacity: 1, transform: 'scale(1)' })) : (t.removeAttribute(ye), g.style(t.parentNode, { opacity: 0, transform: 'scale(0.25)' })), (t.parentNode.style.left = `${e}%`);
    }
    _slideToTarget(t) {
      (t === 'first' && this._activeImg === 0) ||
        ...
        this._sortImages(),
        g.style(this.currentImg.parentNode, { transform: 'scale(0.25)', opacity: 0 }),
        setTimeout(() => {
          this._loadImages().then((e) => {
            this._resizeImages(e),
              ...
              this._hideLoader(),
              setTimeout(() => {
                g.style(this.currentImg.parentNode, { transform: 'scale(1)', opacity: 1 });
              }, 10);
          });
        }, 400));
    }
    ...
    _updateCaption() {
      setTimeout(() => {
        ...
        (this.currentImg.dataset.caption || this.currentImg.dataset.caption === '') && (t = this.currentImg.dataset.caption), (m.findOne(`[${Wp}]`, this._gallery).innerHTML = t);
      }, 200);
    }
    _toggleTemplate() {
      this._gallery.style.visibility === 'visible'
        ...
        : (this._showGallery(), this._disableScroll(), this._updateCounter(), this._updateCaption(), this._setToolsToggleTimout(), this._hideLoader());
    }
    _showLoader() {
    ...
    _hideGallery() {
      g.style(this._gallery, { opacity: 0, pointerEvents: 'none', visibility: 'hidden' });
    }
    _showGallery() {
      g.style(this._gallery, { opacity: 1, pointerEvents: 'initial', visibility: 'visible' }),
        setTimeout(() => {
    ...
    _updateZoomBtn() {
      this._zoom > 1
        ? (this._zoomBtn.setAttribute(ye, ''), this._zoomBtn.setAttribute('aria-label', 'Zoom out'), (this._zoomBtn.innerHTML = this.options.zoomOutIconTemplate))
        : (this._zoomBtn.removeAttribute(ye), this._zoomBtn.setAttribute('aria-label', 'Zoom in'), (this._zoomBtn.innerHTML = this.options.zoomInIconTemplate));
    }
    _updateImgPosition() {
    ...
    _onMousedown(t) {
      ...
      (this._originalPositionX = parseFloat(this.currentImg.style.left) || 0),
        ...
        (this._mousedown = !0),
        t.type === 'touchstart' && t.touches.length > 1 && ((this._multitouch = !0), (this._touchZoomPosition = t.touches));
    }
    _onMousemove(t) {
      ...
      if ((e && this._resetToolsToggler(), !this._multitouch))
        if (this._zoom !== 1)
          (this._positionX = i * (1 / this._zoom) - this._mousedownPositionX), (this._positionY = n * (1 / this._zoom) - this._mousedownPositionY), g.style(this.currentImg, { left: `${this._positionX}px`, top: `${this._positionY}px` });
        else {
          if (this._images.length <= 1) return;
          (this._positionX = i * (1 / this._zoom) - this._mousedownPositionX), g.style(this.currentImg, { left: `${this._positionX}px` });
        }
    }
    _onMouseup(t) {
    ...
    _hideTools() {
      g.style(this._galleryToolbar, { opacity: 0 }), g.style(this._leftArrowWrapper, { opacity: 0 }), g.style(this._rightArrowWrapper, { opacity: 0 });
    }
    _showTools() {
      g.style(this._galleryToolbar, { opacity: 1 }), g.style(this._leftArrowWrapper, { opacity: 1 }), g.style(this._rightArrowWrapper, { opacity: 1 });
    }
    _disableScroll() {
      g.addClass(document.body, 'overflow-y-hidden relative'), document.documentElement.scrollHeight > document.documentElement.clientHeight && g.addClass(document.body, 'md:pr-[17px]');
    }
    _enableScroll() {
      setTimeout(() => {
        g.removeClass(document.body, 'overflow-y-hidden relative'), g.removeClass(document.body, 'md:pr-[17px]');
      }, 300);
    }
    _animationStart() {
      (this._animating = !0),
    ...
    _restoreDefaultZoom() {
      this._zoom !== 1 && ((this._zoom = 1), g.style(this.currentImg.parentNode, { transform: `scale(${this._zoom})` }), this._updateZoomBtn(), this._updateImgPosition());
    }
    ...
    _restoreDefaultPosition() {
      ...
      g.style(this.currentImg.parentNode, { left: 0, top: 0 }),
        g.style(this.currentImg, { transition: 'all 0.5s ease-out', left: 0, top: 0 }),
        this._calculateImgSize(t),
        setTimeout(() => {
    ...
    static jQueryInterface(t, e) {
      return this.each(function () {
        ...
        const n = typeof t == 'object' && t;
        if (!(!i && /dispose/.test(t)) && (i || (i = new ys(this, n)), typeof t == 'string')) {
          if (typeof i[t] > 'u') throw new TypeError(`No method named "${t}"`);
          i[t](e);
        }
      });
  ...
  const ww = {
    ...
    $w = `invalid${gr}`,
    Rw = `changed${gr}`,
    Pw = { validFeedback: 'string', invalidFeedback: 'string', disableFeedback: 'boolean', customRules: 'object', customErrorMessages: 'object', activeValidation: 'boolean', submitCallback: '(function|null)' },
    Yp = { validFeedback: 'Looks good!', invalidFeedback: 'Something is wrong!', disableFeedback: !1, customRules: {}, customErrorMessages: {}, activeValidation: !1, submitCallback: null },
    Nw = {
  ...
  class Tr extends Mt {
    ...
    _removeValidationTraces() {
      this._removeFeedbackWrapper(),
        this._validationElements.forEach(({ element: t, classes: e, initialHTML: i }) => {
          (t.className = e), (t.innerHTML = i), t.removeAttribute(br), t.removeAttribute(yr), t.removeAttribute(ic);
        }),
    ...
    _getValidationElements() {
      return m.find(Ow, this._element).map((e) => {
        ...
        return {
          id: i.name || i.id || (n == null ? void 0 : n.name) || bt('validation-'),
          element: e,
    ...
    _watchForValidationChanges() {
      return new MutationObserver((e) => {
        e.forEach((i) => {
          ...
          n === mr && (this._handleValidation(), this._config.activeValidation && this._shouldApplyInputEvents && this._applyInputEvents());
        });
      });
    }
    _handleValidation() {
      this._element.getAttribute(mr) &&
        ((this._validationResult = []), (this._isValid = !0), this._validationElements.forEach((t) => this._validateSingleElement(t)), this._emitEvents(this._isValid), this._submitCallback && this._submitCallback(this._isValid));
    }
    _validateSingleElement(t) {
      ...
      i === 'input' && this._restyleNotches(e, l),
        ...
        _.trigger(this._element, Rw, { value: { name: r, result: a, validation: (c = this._validationResult[r]) == null ? void 0 : c.validation } });
    }
    _validateByRuleset({ element: t, type: e, invalidFeedback: i, input: n, id: o }) {
      ...
      let l = '',
        c = [];
      for (const h of r) {
        const d = h.callback(a, this._errorMessages[h.name] || this._config.invalidFeedback, h.parameter);
        c.push({ result: d === !0, name: h.name, fullName: h.fullName }), typeof d == 'string' && !l && (l = d);
      }
    ...
    _getRuleData(t, e) {
      const i = t.split('(');
      return { callback: e[i[0]], parameter: i[1] ? i[1].split(')')[0] : null, name: i[0], fullName: t };
    }
    _applyFeedback(t, e) {
      const i = m.findOne(`[${vr}]`, t),
        n = t.getAttribute(ic) || this._config.validFeedback,
        o = t.getAttribute(yr) || this._config.invalidFeedback;
      g.addClass(t, this._classes.elementValidated), (i.textContent = e === 'valid' ? n : o), (i.className = this._classes[e === 'valid' ? 'validFeedback' : 'invalidFeedback']);
    }
    _restyleCheckboxes(t, e, i) {
      g.removeClass(t, this._classes.checkboxValid), g.removeClass(t, this._classes.checkboxInvalid), g.addClass(t, this._classes[`${i}${e}`]);
    }
    _restyleBasicInputs(t, e) {
      g.removeClass(t, this._classes.basicInputValid), g.removeClass(t, this._classes.basicInputInvalid), g.addClass(t, this._classes[`basicInput${e}`]);
    }
    _restyleNotches(t, e) {
      m.find(Iw, t).forEach((n, o) => {
        let r = o === 0 ? 'notchLeading' : o === 1 ? 'notchMiddle' : 'notchTrailing';
        (n.className = ''), g.addClass(n, nu[r]), (r += e), g.addClass(n, this._classes[r]);
      });
    }
    _restyleLabels(t, e) {
      ...
      i.length &&
        i.forEach((n) => {
          g.removeClass(n, this._classes.labelValid), g.removeClass(n, this._classes.labelInvalid), g.addClass(n, this._classes[`label${e}`]);
        });
    }
    _emitEvents(t) {
    ...
    _applyInputEvents() {
      this._validationElements.forEach((t) => {
        ...
        _.on(e, 'input', () => this._handleInputChange(t)), _.on(i, 'valueChange.te.select', () => this._delayedInputChange(t)), _.on(i, 'itemSelect.te.autocomplete', () => this._delayedInputChange(t));
      }),
    ...
    _removeInputEvents() {
      this._validationElements.forEach((t) => {
        const { input: e, element: i } = t;
        _.off(e, 'input', () => this._handleInputChange(t)), _.off(i, 'valueChange.te.select', () => this._delayedInputChange(t)), _.off(i, 'itemSelect.te.autocomplete', () => this._delayedInputChange(t));
      });
    }
    ...
    _handleSubmitButton() {
      (this._submitButton = m.findOne(Dw, this._element)), this._submitButton && _.on(this._submitButton, 'click', (t) => this._handleSubmitButtonClick(t));
    }
    ...
    _getConfig(t) {
      return (t = { ...Yp, ...g.getDataAttributes(this._element), ...(typeof t == 'object' && t ? t : {}) }), L(tc, t, this.constructor.DefaultType), t;
    }
    _getClasses(t) {
      const e = g.getDataClassAttributes(this._element);
  ...
  class mn {
    ...
    _getDirection({ x: t, y: e }) {
      return { x: { direction: t < 0 ? 'left' : 'right', value: Math.abs(t) }, y: { direction: e < 0 ? 'up' : 'down', value: Math.abs(e) } };
    }
    ...
    handleTouchStart(t) {
      ...
      t.touches.length === i &&
        (this._timer = setTimeout(() => {
          _.trigger(this._element, sc, { touch: t, time: e }), _.trigger(this._element, Hw, { touch: t });
        }, e));
    }
    handleTouchEnd() {
  ...
  class Kw {
    ...
    handleTouchMove(t) {
      ...
      if (this._options.direction === 'all') {
        if (n.y.value < this._options.threshold && n.x.value < this._options.threshold) return;
        const r = n.y.value > n.x.value ? n.y.direction : n.x.direction;
        _.trigger(this._element, `swipe${r}`, { touch: t }), _.trigger(this._element, 'swipe', { touch: t, direction: r }), (this._startPosition = null);
        return;
      }
      const o = this._options.direction === 'left' || this._options === 'right' ? 'x' : 'y';
      n[o].direction === this._options.direction && n[o].value > this._options.threshold && (_.trigger(this._element, `swipe${n[o].direction}`, { touch: t }), (this._startPosition = null));
    }
    handleTouchEnd() {
      this._startPosition = null;
    }
  ...
  class tk extends mn {
    ...
    handleTouchStart(t) {
      (this._startTouch = this._getCoordinates(t)), (this._movedTouch = t), _.trigger(this._element, Uw, { touch: t });
    }
    handleTouchMove(t) {
      ...
      if (i === 'all' && (d.value > e || h.value > e)) {
        ...
        _.trigger(this._element, `${Je}${p}`, { touch: t }), _.trigger(this._element, Je, { ...a, touch: t });
      }
      const u = i === qw || i === Zw ? 'x' : 'y';
      c[u].direction === i && l[u].value > e && _.trigger(this._element, `${Je}${i}`, { touch: t, [u]: n[u] - o[u] }), (this._movedTouch = t), _.trigger(this._element, Gw, { touch: t });
    }
    handleTouchEnd(t) {
      t.type === 'touchend' && t.preventDefault(), (this._movedTouch = null), (this._startTouch = null), _.trigger(this._element, Xw, { touch: t });
    }
    _getConfig(t) {
  ...
  class rk extends mn {
    ...
    handleTouchStart(t) {
      ...
      (this._touch = e), (this._origin = i), (this._startTouch = this._touch), _.trigger(this._element, ik, { touch: t, ratio: this._ratio, origin: this._origin });
    }
    handleTouchMove(t) {
      ...
      t.touches.length === i &&
        ...
        this.isNumber &&
          ...
          ((this._startTouch = this._touch), _.trigger(this._element, Ts, { touch: t, ratio: this._ratio, origin: this._origin }), _.trigger(this._element, sk, { touch: t, ratio: this._ratio, origin: this._origin })));
    }
    handleTouchEnd(t) {
      this.isNumber && ((this._startTouch = null), _.trigger(this._element, ek, { touch: t, ratio: this._ratio, origin: this._origin }));
    }
    _getConfig(t) {
  ...
  const nc = 'tap',
    ak = { interval: 'number', time: 'number', taps: 'number', pointers: 'number' },
    ...
    handleTouchStart(t) {
      ...
      return (
        t.touches.length === r &&
          ...
          this._tapCount === o && (clearTimeout(this._timer), (this._tapCount = 0), _.trigger(this._element, nc, { touch: t, origin: { x: e, y: i } }))),
        t
      );
    }
    handleTouchEnd() {}
  ...
  class fk extends mn {
    ...
    handleTouchStart(t) {
      t.type === 'touchstart' && t.preventDefault(), !(t.touches.length < 2) && ((this._startTouch = t), (this._origin = {}), _.trigger(this._element, dk, { touch: t }));
    }
    handleTouchMove(t) {
      t.type === 'touchmove' && t.preventDefault();
      let e, i;
    ...
    handleTouchEnd(t) {
      t.type === 'touchend' && t.preventDefault(), (this._origin = {}), _.trigger(this._element, hk, { touch: t });
    }
    _getConfig(t) {
  ...
  class Er {
    ...
    static jQueryInterface(t) {
      return this.each(function () {
        ...
        const i = typeof t == 'object' && t;
        if (!(!e && /dispose/.test(t)) && (e || (e = new Er(this, i)), typeof t == 'string')) {
          if (typeof e[t] > 'u') throw new TypeError(`No method named "${t}"`);
          return e[t];
        }
      });
  ...
  const ac = 'smoothScroll',
    vn = `te.${ac}`,
    lc = `.${vn}`,
    mk = { container: 'string', offset: 'number', easing: 'string', duration: 'number' },
  ...
  class xr {
    constructor(t, e = {}) {
      (this._element = t), (this._options = this._getConfig(e)), (this._href = this._element.getAttribute('href')), (this.isCancel = !1), this._element && (O.setData(t, vn, this), this._setup());
    }
    static get NAME() {
      return ac;
    }
    ...
    get containerToScroll() {
      return this.isWindow ? document.documentElement : m.findOne(this._options.container, document.documentElement);
    }
    get elFromHrefExist() {
    ...
    dispose() {
      _.off(this._element, 'click', this._handleClick), O.removeData(this._element, vn), (this._element = null);
    }
    cancelScroll() {
      this.isCancel = !0;
    }
    ...
    _handleClick(t) {
      ...
      this._inViewport()
        ...
        : (this._scrollOnNextTick(document.documentElement, document.documentElement.scrollTop, this.containerToScroll.offsetTop, o, r, a, l),
          setTimeout(() => {
    ...
    _scrollOnNextTick(t, e, i, n, o, r, a) {
      ...
      if (l || c || h || this.isCancel) {
        if (this.isCancel) {
          this.isInViewport && (this.isCancel = !1), _.trigger(this._element, Tk);
          return;
        }
    ...
    _preventNativeScroll() {
      let t = !1;
      try {
        window.addEventListener('test', null, Object.defineProperty({}, 'passive', { get: () => (t = !0) }));
      } catch (n) {
        this._scrollError = n;
      }
  ...
  const Kp = 'lazyLoad',
    ...
    Ck = 'onError.te.lazy',
    Xp = ['img', 'video'],
    Ak = { lazySrc: '(string|null)', lazyDelay: 'number', lazyAnimation: 'string', lazyOffset: 'number', lazyPlaceholder: '(string|undefined)', lazyError: '(string|undefined)' },
    wk = { lazySrc: null, lazyDelay: 500, lazyAnimation: '[fade-in_1s_ease-in-out]', lazyOffset: 0 };
  class yn {
    constructor(t, e) {
      (this._element = t),
    ...
    dispose() {
      O.removeData(this._element, Cr), this._animation && (this._animation.dispose(), (this._animation = null)), (this._element = null), this._childrenInstances && this._childrenInstances.forEach((t) => t.dispose());
    }
    _init() {
    ...
    _setupElement() {
      _.one(this._element, 'error', this.errorHandler),
        ...
        (this._animation = new Gs(this._element, { animation: `${this._options.lazyAnimation}`, animationStart: 'onLoad' })),
    ...
    _scrollHandler() {
      this.inViewport &&
        ((this._timeout = setTimeout(() => {
          this._setSrc(), this._element.removeAttribute(Up), this._removeAttrs(), this._animation.init();
        }, this._options.lazyDelay)),
        this.parent && _.off(this.parent, 'scroll', this.scrollHandler),
        _.off(window, 'scroll', this.scrollHandler));
    }
    _setElementError() {
      !this._options.lazyError || this._element.src === this._options.lazyError ? (this._element.alt = '404 not found') : this._element.setAttribute('src', this._options.lazyError), _.trigger(this._element, Ck);
    }
    _setSrc() {
      this._element.setAttribute('src', this._options.lazySrc), _.trigger(this._element, xk);
    }
    _setPlaceholder() {
    ...
    _setupContainer() {
      this._childrenInstances = m.children(this._element, Xp).map((t) => new yn(t, this._options));
    }
    _getConfig(t) {
  ...
  class Ar {
    constructor(t, e = {}) {
      (this._element = t), (this._options = e), this._element && (O.setData(t, Tn, this), (this._initCopy = this._initCopy.bind(this)), this._setup());
    }
    static get NAME() {
      return Gp;
    }
    get options() {
      const t = { ...Sk, ...g.getDataAttributes(this._element), ...this._options };
      return L(Gp, t, Ok), t;
    }
    get clipboardTarget() {
    ...
    dispose() {
      _.off(this._element, 'click', this._initCopy), O.removeData(this._element, Tn), (this._element = null);
    }
    _setup() {
    ...
    _initCopy() {
      ...
      document.body.appendChild(t), this._selectInput(t), _.trigger(this._element, Ik, { copyText: this.copyText }), t.remove();
    }
    _createNewInput() {
      const t = this.clipboardTarget.tagName === 'TEXTAREA' ? 'textarea' : 'input',
        e = $(t);
      return (e.value = this.copyText), g.addClass(e, '-left-[9999px] absolute'), e;
    }
    _selectInput(t) {
  ...
  class kr {
    constructor(t, e) {
      (this._element = t), this._element && O.setData(t, wr, this), (this._options = this._getConfig(e)), (this.scrollHandler = this._scrollHandler.bind(this)), this._init();
    }
    static get NAME() {
      return cc;
    }
    ...
    get condition() {
      return this._element === window
        ...
        : this._options.infiniteDirection === 'x'
          ? this.rect.width + this._element.scrollLeft + 10 >= this._element.scrollWidth
          : Math.ceil(this.rect.height + this._element.scrollTop) >= this._element.scrollHeight;
    }
    dispose() {
      _.off(this._element, 'scroll', this.scrollHandler), O.removeData(this._element, wr), (this._element = null);
    }
    _init() {
      _.on(this._element, 'scroll', () => this._scrollHandler());
    }
    _scrollHandler() {
      this.condition && _.trigger(this._element, 'complete.te.infiniteScroll'), _.off(this._element, 'scroll', this.scrollHandler);
    }
    _getConfig(t) {
      const e = { ...Dk, ...(this._element !== window ? g.getDataAttributes(this._element) : {}), ...t };
      return L(cc, e, Mk), e;
    }
    static getInstance(t) {
  ...
  const En = 'loadingManagement',
    ...
    Pk = `show.te.${En}`,
    Nk = { backdrop: '(null|boolean)', backdropID: '(null|string|number)', delay: '(null|number)', loader: '(null|string|number)', parentSelector: '(null|string)', loadingIcon: 'boolean', loadingText: 'boolean', scroll: 'boolean' },
    Bk = { backdrop: !0, backdropID: null, delay: 0, loader: '', parentSelector: null, scroll: !0, loadingText: !0, loadingIcon: !0 },
    Hk = {
    ...
    Vk = { loadingSpinner: 'string', spinnerColor: 'string', backdrop: 'string', backdropColor: 'string' };
  class Or {
    constructor(t, e = {}, i) {
      (this._element = t),
        (this._options = this._getConfig(e)),
    ...
    init() {
      ...
      this._removeElementsOnStart(),
        setTimeout(() => {
          g.addClass(this._element, `${this._classes.loadingSpinner} ${this._classes.spinnerColor}`), this._setBackdrop(), this._setLoadingIcon(t), this._setLoadingText(e), this._setScrollOption(), _.trigger(this._element, Pk);
        }, this._options.delay);
    }
    dispose() {
      O.removeData(this._element, Sr), g.removeClass(this._element, `${this._classes.loadingSpinner} ${this._classes.spinnerColor}`);
    ...
    _setBackdrop() {
      ...
      t &&
        ...
        this._parentElement !== null
          ? (g.addClass(this._element, 'absolute'), g.addClass(this._parentElement, 'relative'), g.addClass(this._backdropElement, 'absolute'), this._parentElement.appendChild(this._backdropElement))
          : (g.addClass(this._element, '!fixed'), document.body.appendChild(this._backdropElement), document.body.appendChild(this._element)));
    }
    _removeBackdrop() {
      const { backdrop: t } = this._options;
      t && (this._parentElement !== null ? (g.removeClass(this._element, 'absolute'), g.removeClass(this._parentElement, 'relative'), this._backdropElement.remove()) : (this._backdropElement.remove(), this._element.remove()));
    }
    _setLoadingIcon(t) {
  ...
  const Fk = (s) => {
    ...
    Wk = (s) => s && Object.prototype.toString.call(s) === '[object Date]' && !isNaN(s),
    zk = (s) => s.getMonth(),
    jk = (s) => s.getFullYear(),
...
`,
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 11-18 0 9 9 0 0118 0z" />
    ...
    mS = { toggleButton: 'string', pickerIcon: 'string', buttonsContainer: 'string', timepicker: 'object', datepicker: 'object' };
  class Dr {
    constructor(t, e, i) {
      (this._element = t),
        (this._input = m.findOne('input', this._element)),
    ...
    _addDatepicker() {
      const t = $('div');
      t.id = this._element.id ? `datepicker-${this._element.id}` : bt('datepicker-');
      const e = '<input type="text">';
      (t.innerHTML = e), t.setAttribute(qp, ''), this._element.appendChild(t), g.addClass(t, 'hidden');
      let i = { ...this._options.datepicker, container: this._options.container, disablePast: this._options.disablePast, disableFuture: this._options.disableFuture };
      (this._options.inline || this._options.datepicker.inline) && (i = { ...i, inline: !0 }), (this._datepicker = new xl(t, i, { ...this._classes.datepicker })), (this._datepicker._input.value = this._dateValue);
    }
    _removeTimePicker() {
    ...
    _addTimePicker() {
      const t = $('div');
      t.id = this._element.id ? `timepicker-${this._element.id}` : bt('timepicker-');
      const e = '<input type="text">';
      (t.innerHTML = e), t.setAttribute(Zp, ''), this._element.appendChild(t), g.addClass(t, 'hidden');
      let i = { ...this._options.timepicker, container: this._options.container };
      (this._options.inline || this._options.timepicker.inline) && (i = { ...i, inline: !0 }), (this._timepicker = new Ll(t, i, { ...this._classes.timepicker })), (this._timepicker.input.value = this._timeValue);
    }
    _addIconButtons() {
      if (
        (g.addClass(Es, this._classes.buttonsContainer),
        (Es.innerHTML = Xk(this._options.datepickerToggleIconTemplate, this._options.timepickerToggleIconTemplate, this._classes)),
        Es.removeAttribute(Jp),
        !(this._options.inline || this._options.datepicker.inline))
      ) {
        if ((this._scrollBar.hide(), this._datepicker._isOpen)) m.findOne(`[${qk}]`, document.body).appendChild(Es);
    ...
    _enableOrDisableToggleButton() {
      this._options.disabled ? ((this.toggleButton.disabled = !0), g.addClass(this.toggleButton, 'pointer-events-none')) : ((this.toggleButton.disabled = !1), g.removeClass(this.toggleButton, 'pointer-events-none'));
    }
    _appendToggleButton() {
      this._options.toggleButton && (this._element.insertAdjacentHTML('beforeend', Gk(this._options.dateTimepickerToggleIconTemplate, this._classes)), this._enableOrDisableToggleButton());
    }
    ...
    _openDatePicker() {
      ...
      this._datepicker.open(),
        ...
        this._options.inline && this._datepicker._isOpen && g.addClass(this.toggleButton, 'pointer-events-none'),
        _.one(this._datepicker._element, tf, () => {
          ...
          _.on(this._datepicker.container, 'click', (n) => {
            ...
            this._options.inline && g.removeClass(this.toggleButton, 'pointer-events-none');
        });
      const e = m.findOne(aS, document.body);
      _.on(e, 'click', () => {
        this._datepicker.close(), this._scrollBar.hide(), _.trigger(this._datepicker._element, tf);
      });
    }
    ...
    _openTimePicker() {
      _.trigger(this._timepicker.elementToggle, 'click'),
            ...
            this._handleEscapeKey(),
              ...
              _.on(this._timepicker._modal, 'click', (e) => {
                (e.target.hasAttribute(dc) || e.target.hasAttribute(Jk)) &&
                  ...
                  e.target.hasAttribute(tS) && _.trigger(this._timepicker._element, ef),
        ...
        _.one(this._timepicker._element, ef, () => {
          (this._timeValue = this._timepicker.input.value), this._updateInputValue(), _.trigger(this._element, pS);
        });
    }
    _openDropdownTime() {
    ...
    _updateInputValue() {
      (this._timeValue && this._dateValue && ((this._input.value = `${this._dateValue}, ${this._timeValue}`), _.trigger(this._element, fS, { value: this._input.value }).defaultPrevented)) ||
        (_.trigger(this._input, 'focus'), this.notch && this.notch.removeAttribute('data-te-input-focused'));
    }
    static jQueryInterface(t, e) {
      return this.each(function () {
  ...
  const Mr = 'sticky',
    ...
    bS = `active${nf}`,
    vS = `inactive${nf}`,
    yS = { stickyAnimationSticky: '', stickyAnimationUnsticky: '', stickyBoundary: !1, stickyDelay: 0, stickyDirection: 'down', stickyMedia: 0, stickyOffset: 0, stickyPosition: 'top', stickyZIndex: 100 },
    TS = {
  ...
  class Lr {
    constructor(t, e, i) {
      (this._element = t),
        ...
        this._element && ((this._options = this._getConfig(e)), (this._classes = this._getClasses(i)), O.setData(t, Cn, this), this._init());
    }
    static get NAME() {
      return Mr;
    }
    ...
    _userActivityListener() {
      _.on(window, 'resize', () => {
        ...
        _.on(window, 'scroll', () => {
          ...
          r && (this._createHiddenElement(), this._enableSticky(), this._changeBoundaryPosition(), (this._isSticked = !0)),
            a && (this._disableSticky(), (this._isSticked = !1)),
            this._isSticked && (this._updatePosition({ styles: this._elementPositionStyles }), this._changeBoundaryPosition()),
    ...
    _enableSticky() {
      const { stickyAnimationSticky: t, stickyAnimationUnsticky: e, stickyOffset: i, stickyPosition: n, stickyZIndex: o } = this._options,
      ...
      t !== '' && this._toggleClass(t, e, this._element),
        ...
        this._setStyle(this._element, { top: n === 'top' && `${0 + i}px`, bottom: n === 'bottom' && `${0 + i}px`, height: `${r}px`, width: `${l}px`, left: `${a}px`, zIndex: `${o}`, position: 'fixed' }),
    ...
    _changeBoundaryPosition() {
      const { stickyPosition: t, stickyBoundary: e, stickyOffset: i } = this._options,
        ...
        o = { height: this._element.parentElement.getBoundingClientRect().height, ...this._getOffset(this._element.parentElement) };
      let r;
      const a = m.findOne(e);
      ...
      l && (d && h ? (p = { top: `${i + r}px` }) : (p = { top: `${i + 0}px` })),
        c && (d && h ? (p = { bottom: `${i + r}px` }) : u && h ? (p = { bottom: `${i + o.bottom}px` }) : (p = { bottom: `${i + 0}px` })),
    ...
    _disableSticky() {
      ...
      (i = t !== '' ? parseFloat(i) * 1e3 : 0),
        this._options.stickyAnimationUnsticky !== '' && this._toggleClass(t, e, this._element),
        setTimeout(() => {
          this._element.classList.contains(e) || (this._removeUnstickyAnimation(), this._resetStyles(), this._removeHiddenElement(), this._toggleClass('', this._classes.stickyActive, this._element), _.trigger(this._element, vS));
        }, i);
    }
    ...
    _resetStyles() {
      this._setStyle(this._element, { top: null, bottom: null, position: null, left: null, zIndex: null, width: null, height: null });
    }
    ...
    _copyElement(t) {
      const { height: e, width: i } = t.getBoundingClientRect(),
        n = t.cloneNode(!1);
      return (n.hidden = !0), this._setStyle(n, { height: `${e}px`, width: `${i}px`, opacity: '0' }), t.parentElement.insertBefore(n, t), n;
    }
    _getConfig(t = {}) {
      const e = g.getDataAttributes(this._element);
    ...
    static jQueryInterface(t, e) {
      return this.each(function () {
        ...
        const n = typeof t == 'object' && t;
        if (!(!i && /dispose|hide/.test(t)) && (i || (i = new Lr(this, n)), typeof t == 'string')) {
          if (typeof i[t] > 'u') throw new TypeError(`No method named "${t}"`);
          i[t](e);
        }
      });
  ...
  function SS(s, t) {
    const { id: e, items: i, width: n, options: o } = s,
      r = $('div');
    g.addClass(r, t.dropdownContainer), g.addStyle(r, { width: `${n}px` }), r.setAttribute('id', e);
    const a = $('div');
    a.setAttribute(CS, ''), g.addClass(a, t.dropdown);
    const l = $('ul'),
      c = o.listHeight;
    l.setAttribute(AS, ''), g.addClass(l, t.autocompleteList), g.addClass(l, t.scrollbar), g.addStyle(l, { maxHeight: `${c}px` }), l.setAttribute('role', 'listbox');
    const h = of(i, o);
  ...
  function OS(s) {
    const t = $('div');
    t.setAttribute(kS, ''), g.addClass(t, s.autocompleteLoader), g.addClass(t, s.spinnerIcon), t.setAttribute('role', 'status');
  ...
  const uc = 'autocomplete',
    ...
    cf = `itemSelect${Rr}`,
    BS = `update${Rr}`,
    HS = { autoSelect: !1, container: 'body', customContent: '', debounce: 300, displayValue: (s) => s, filter: null, itemContent: null, listHeight: 190, loaderCloseDelay: 300, noResults: 'No results found', threshold: 0 },
    VS = {
      autoSelect: 'boolean',
      container: 'string',
    ...
    WS = { autocompleteItem: 'string', autocompleteList: 'string', autocompleteLoader: 'string', dropdown: 'string', dropdownContainer: 'string', scrollbar: 'string', spinnerIcon: 'string' };
  class Pr {
    constructor(t, e, i) {
      (this._element = t),
        (this._options = this._getConfig(e)),
    ...
    _initDropdown() {
      this._dropdownContainerId = this._element.id ? `autocomplete-dropdown-${this._element.id}` : bt('autocomplete-dropdown-');
      const t = { id: this._dropdownContainerId, items: [], width: this._input.offsetWidth, options: this._options };
      if (((this._dropdownContainer = SS(t, this._classes)), this._options.customContent !== '')) {
    ...
    _updateInputState() {
      var t, e;
      this._input.value !== '' || this._isOpen ? (this._input.setAttribute(xs, ''), (t = this._notch) == null || t.setAttribute(xs, '')) : (this._input.removeAttribute(xs), (e = this._notch) == null || e.removeAttribute(xs));
    }
    _listenToInputFocus() {
    ...
    _resetActiveItem() {
      ...
      t && (t.removeAttribute(pc), (this._activeItem = null), (this._activeItemIndex = -1));
    }
    _showLoader() {
    ...
    _updateResults(t) {
      this._resetActiveItem(), (this._filteredResults = t), _.trigger(this._element, BS, { results: t });
    ...
    _handleOpenKeydown(t) {
      const e = t.keyCode;
      if ((e === Ci && this._options.autoSelect && this._selectActiveItem(), e === xi || (e === ut && t.altKey))) {
        this.close(), this._input.focus();
        return;
      }
    ...
    _updateActiveItem(t, e) {
      ...
      i && i.removeAttribute(pc), t.setAttribute(pc, ''), (this._activeItemIndex = e), (this._activeItem = t);
    }
    _scrollToItem(t) {
      if (!t) return;
    ...
    open() {
      ...
      this._isOpen ||
        ...
        (this._updateDropdownWidth(),
        this._listenToWindowResize(),
        (this._popper = Fe(this._element, this._dropdownContainer, { modifiers: [{ name: 'offset', options: { offset: [0, 1] } }] })),
        this._container.appendChild(this._dropdownContainer),
        this._listenToOutsideClick(),
        this._listenToItemsClick(),
        setTimeout(() => {
          this.dropdown.setAttribute(af, ''), (this._isOpen = !0), this._setInputActiveStyles(), this._updateInputState();
        }, 0));
    }
    _listenToOutsideClick() {
    ...
    close() {
      ...
      !this._isOpen ||
        ...
        _.on(this.dropdown, 'transitionend', this._handleDropdownTransitionEnd.bind(this)),
        this._input.removeAttribute(rf),
        this._input.value || (this._input.removeAttribute(xs), (e = this._notch) == null || e.removeAttribute(xs)));
    }
    _removeDropdownEvents() {
      const t = m.findOne($r, this._dropdownContainer);
      _.off(t, 'click'), _.off(document, 'click', this._outsideClickHandler), _.off(window, 'resize', this._handleWindowResize.bind(this));
    }
    _handleDropdownTransitionEnd(t) {
      this._isOpen &&
        t &&
        t.propertyName === 'opacity' &&
        (this._popper.destroy(), this._dropdownContainer && this._container.removeChild(this._dropdownContainer), (this._isOpen = !1), _.off(this.dropdown, 'transitionend'), (this._canOpenOnFocus = !0));
    }
    dispose() {
      this._isOpen && this.close(), this._removeInputAndElementEvents(), this._dropdownContainer.remove(), O.removeData(this._element, An);
    }
    _removeInputAndElementEvents() {
      _.off(this._input, 'focus', this._inputFocusHandler), _.off(this._input, 'input', this._userInputHandler), _.off(this._element, 'keydown', this._keydownHandler);
    }
    static jQueryInterface(t, e) {
      return this.each(function () {
        let i = O.getData(this, An);
        const n = typeof t == 'object' && t;
        if (!(!i && /dispose/.test(t)) && (i || (i = new Pr(this, n)), typeof t == 'string')) {
          if (typeof i[t] > 'u') throw new TypeError(`No method named "${t}"`);
          i[t](e);
        }
      });
  ...
  <div class="${s.connect}"></div>
    ...
    KS = { max: 'number', min: 'number', numberOfRanges: 'number', startValues: '(array|string)', step: '(string|null|number)', tooltip: 'boolean' },
    US = { max: 100, min: 0, numberOfRanges: 2, startValues: [0, 100], step: null, tooltip: !1 },
    XS = {
    ...
    GS = { container: 'string', connectContainer: 'string', connect: 'string', hand: 'string', tooltip: 'string', tooltipValue: 'string' };
  class Hr extends Mt {
    constructor(t, e, i) {
      super(t),
        (this._options = this._getConfig(e)),
      ...
      typeof i == 'string' && (i = JSON.parse(i.replace(/'/g, '"'))),
        i.length === 0
          ? this.hands.forEach((n) => {
              g.setDataAttribute(n, 'translation', Math.round(this._minTranslation)), g.addStyle(n, { transform: `translate(${this._minTranslation}px,-25%)` });
            })
          : this.hands.forEach((n, o) => {
              if (i[o] > t || i[o] < e) return;
              if (i[o] === void 0) {
                g.setDataAttribute(n, 'translation', Math.round(this._maxTranslation)), g.addStyle(n, { transform: `translate(${this._maxTranslation}px,-25%)`, zIndex: this.hands.length - o });
                return;
              }
              const a = ((i[o] - e) / (t - e)) * this.connect.offsetWidth - n.offsetWidth / 2;
              g.setDataAttribute(n, 'translation', Math.round(a)), g.addStyle(n, { transform: `translate(${a}px,-25%)`, zIndex: this.hands.length - o });
            });
    }
    ...
    _handleClickEventOnHand() {
      ...
      this.hands.forEach((n) => {
        ct.on(n, 'mousedown touchstart', (o) => {
          if (((this._mousemove = !0), n.setAttribute(Oi, ''), this._options.tooltip && n.children[1].setAttribute(Oi, ''), this._handleMoveEvent(n), this._handleEndMoveEvent(n, o), !this._canChangeStep && i !== null)) return;
          const r = Si(o) - this.leftConnectRect - n.offsetWidth / 2,
            a = ((Si(o) - this.leftConnectRect) / (this.connect.offsetWidth / (t - e))) % (t - e);
    ...
    _setRangeConnectsElement() {
      this._element.insertAdjacentHTML('afterbegin', zS({ connectContainer: this._classes.connectContainer, connect: this._classes.connect }, uf));
    }
    _setRangeHandleElements() {
      for (let t = 0; t < this._options.numberOfRanges; t++) this._element.insertAdjacentHTML('beforeend', jS({ hand: this._classes.hand }, df));
      this.hands.forEach((t, e) => {
        t.setAttribute('aria-orientation', 'horizontal'), t.setAttribute('role', 'slider'), g.setDataAttribute(t, 'handle', e);
      });
    }
    _setTooltipToHand() {
      this._options.tooltip && this.hands.forEach((t) => t.insertAdjacentHTML('beforeend', YS({ tooltip: this._classes.tooltip, tooltipValue: this._classes.tooltipValue }, pf)));
    }
    _handleMoveEvent(t) {
      ...
      ct.on(document, 'mousemove touchmove', (n) => {
        ...
        if (t.hasAttribute(Oi)) {
          const l = ((Si(n) - this.leftConnectRect) / this.connect.offsetWidth) * o;
          let c = (((Si(n) - this.leftConnectRect) / (this.connect.offsetWidth / (o - r))) % (o - r)) + r;
          if ((this._currentStepValue === Math.round(c) || Math.round(c) % i !== 0) && i !== null) {
            this._canChangeStep = !1;
            return;
          }
          ...
          if (a < 2)
            Math.round(c) % i === 0 && i !== null
              ? ((this._currentStepValue = Math.round(c)), g.addStyle(t, { transform: `translate(${h}px,-25%)` }), e && (this.activeTooltipValue.innerText = Math.round(c)))
              : i === null && (g.addStyle(t, { transform: `translate(${h}px,-25%)` }), e && (this.activeTooltipValue.innerText = Math.round(c))),
            ...
            const y = p[d + 1],
              T = p[d - 1];
            d === 0 && u >= y ? ((b = y), (v = h <= b)) : d === a - 1 && u <= T ? ((b = T), (v = h >= b)) : f && (u >= y || u <= T) && ((b = u >= y ? y : T), (v = b === y ? h <= b : h >= b)),
              Math.round(c) % i === 0 && i !== null
                ? ((this._currentStepValue = Math.round(c)), g.addStyle(t, { transform: `translate(${b}px,-25%)` }), e && b === h && this.activeTooltipValue !== null && (this.activeTooltipValue.innerText = Math.round(c)))
                : i === null && (g.addStyle(t, { transform: `translate(${b}px,-25%)` }), e && b === h && this.activeTooltipValue !== null && (this.activeTooltipValue.innerText = Math.round(c))),
    ...
    _handleEventChangeValuesOnRange() {
      const { max: t, min: e, numberOfRanges: i } = this._options,
        n = (r) => {
          ...
          return a === this.connect.offsetWidth ? (l = t) : (l += e), g.setDataAttribute(r, 'value', Math.round(l * 10) / 10), { value: l };
        };
      if (i < 2) {
        const { value: r } = n(this.hands[0]);
        _.trigger(this._element, hf, { values: { value: r + e, rounded: Math.round(r + e) } });
        return;
      }
      const o = this.hands.map((r) => n(r));
      _.trigger(this._element, hf, { values: { value: o.map(({ value: r }) => r + e), rounded: o.map(({ value: r }) => Math.round(r + e)) } });
    }
    _resetHandState(t, e) {
      _.off(t, e), t.removeAttribute(Oi), this._options.tooltip && t.children[1].removeAttribute(Oi);
    }
    ...
    _handleEndMoveEvent(t) {
      ct.on(t, 'mouseup touchend', () => {
        this._resetHandState(t, 'mousemove'), ct.off(document, 'mousemove touchmove'), (this._mousemove = !1);
      });
    }
    _handleClickOnRange() {
      this._options.step === null &&
        ct.on(this.connect, 'mousedown touchstart', (t) => {
          ...
          if (
            ...
            const n = Si(t) - this.leftConnectRect - this.hands[i].offsetWidth / 2;
    ...
    _updateHand(t, e) {
      g.addStyle(t, { transform: `translate(${e}px,-25%)` }), g.setDataAttribute(t, 'translation', e);
    }
    ...
    static jQueryInterface(t, e) {
      return this.each(function () {
        ...
        const n = typeof t == 'object' && t;
        if (!(!i && /dispose|hide/.test(t)) && (i || (i = new Hr(this, n)), typeof t == 'string')) {
          if (typeof i[t] > 'u') throw new TypeError(`No method named "${t}"`);
          i[t](e);
        }
      });
  ...
  const qS = (s) => {
    ...
    QS = (s, t) => {
      _.on(document, `click.te.${s.NAME}.data-api`, t, function (e) {
        if ((['A', 'AREA'].includes(this.tagName) && e.preventDefault(), ci(this))) return;
    ...
    rO = (s, t) => {
      m.find(t).forEach((e) => {
        ...
        _.on(document, `click.te.${s.NAME}.data-api`, `${t} img:not([data-te-lightbox-disabled])`, s.toggle());
    },
    aO = (s, t) => {
      ...
      m.find(t).forEach((o) => {
        if (g.getDataAttribute(o, 'chart') !== 'bubble' && g.getDataAttribute(o, 'chart') !== 'scatter') {
          const r = g.getDataAttributes(o),
            a = { data: { datasets: [n(r)] } };
          return r.chart && (a.type = r.chart), r.labels && (a.data.labels = JSON.parse(r.labels.replace(/'/g, '"'))), new s(o, { ...a, ...ln[a.type] });
        }
        return null;
      });
    };
  ...
  const fc = new lO(),
    wn = {
      ...
      datetimepicker: { name: 'Datetimepicker', selector: '[data-te-date-timepicker-init]', isToggler: !1 },
      ...
      smoothScroll: { name: 'SmoothScroll', selector: 'a[data-te-smooth-scroll-init]' },
      lazyLoad: { name: 'LazyLoad', selector: '[data-te-lazy-load-init]' },
      clipboard: { name: 'Clipboard', selector: '[data-te-clipboard-init]' },
      infiniteScroll: { name: 'InfiniteScroll', selector: '[data-te-infinite-scroll-init]' },
      loadingManagement: { name: 'LoadingManagement', selector: '[data-te-loading-management-init]' },
      sticky: { name: 'Sticky', selector: '[data-te-sticky-init]' },
      multiRangeSlider: { name: 'MultiRangeSlider', selector: '[data-te-multi-range-slider-init]' },
      chart: { name: 'Chart', selector: '[data-te-chart]', isToggler: !1, advanced: aO },
      button: { name: 'Button', selector: "[data-te-toggle='button']", isToggler: !0, callback: tO },
      collapse: { name: 'Collapse', selector: '[data-te-collapse-init]', isToggler: !0, callback: sO },
      dropdown: { name: 'Dropdown', selector: '[data-te-dropdown-toggle-ref]', isToggler: !0, callback: ZS },
      modal: { name: 'Modal', selector: "[data-te-toggle='modal']", isToggler: !0, callback: eO },
      ripple: { name: 'Ripple', selector: '[data-te-ripple-init]', isToggler: !0, callback: iO },
      offcanvas: { name: 'Offcanvas', selector: '[data-te-offcanvas-toggle]', isToggler: !0, callback: JS },
      tab: { name: 'Tab', selector: "[data-te-toggle='tab'], [data-te-toggle='pill'], [data-te-toggle='list']", isToggler: !0, callback: QS },
      tooltip: { name: 'Tooltip', selector: "[data-te-toggle='tooltip']", isToggler: !1, callback: nO },
      popover: { name: 'Popover', selector: "[data-te-toggle='popover']", isToggler: !0, callback: oO },
      lightbox: { name: 'Lightbox', selector: '[data-te-lightbox-init]', isToggler: !0, callback: rO },
    ...
    ff = (s, t = {}) => {
      ...
      const e = Object.keys(wn).map((i) => {
        if (!!document.querySelector(wn[i].selector)) {
          const o = s[wn[i].name];
          return !o && !fc.isInited(i) && t.checkOtherImports && console.warn(`Please import ${wn[i].name} from "tw-elements" package and add it to a object parameter inside "initTE" function`), o;
        }
      });
      dO(e, t);
    },
  ...
  class Ii {
    constructor(t, e = {}) {
      ke(this, '_addBackdropOnInit', () => {
        this._options.sidenavHidden || (this._backdrop.show(), _.off(this._element, 'transitionend', this._addBackdropOnInit));
      });
      (this._element = t),
        (this._options = e),
        (this._ID = bt('')),
        ...
        (this.escHandler = (i) => {
          i.keyCode === xi && this.toggler && ae(this.toggler) && (this._update(!1), _.off(window, 'keydown', this.escHandler));
        }),
        (this.hashHandler = () => {
          this._setActiveElements();
        }),
        t && (O.setData(t, Vr, this), this._setup()),
        this.options.sidenavBackdrop && !this.options.sidenavHidden && this.options.sidenavMode === 'over' && _.on(this._element, 'transitionend', this._addBackdropOnInit),
        (this._didInit = !1),
        this._init();
    }
    static get NAME() {
    ...
    get isVisible() {
      ...
      if ((this.options.sidenavRight && !et()) || (!this.options.sidenavRight && et())) {
        let n = 0;
    ...
    get options() {
      const t = { ...TO, ...g.getDataAttributes(this._element), ...this._options };
      return L(_f, t, yO), t;
    }
    get sidenavStyle() {
      return { width: `${this.width}px`, height: this.options.sidenavPosition === 'fixed' ? '100vh' : '100%', position: this.options.sidenavPosition, transition: `all ${this.transitionDuration} linear` };
    }
    get toggler() {
    ...
    dispose() {
      _.off(window, 'keydown', this.escHandler), this.options.sidenavBackdrop && this._backdrop.dispose(), _.off(window, 'hashchange', this.hashHandler), this._touch.dispose(), O.removeData(this._element, Vr), (this._element = null);
    }
    hide() {
    ...
    _init() {
      this._didInit || (_.on(document, 'click', _c, Ii.toggleSidenav()), (this._didInit = !0));
    }
    ...
    _handleSwipe(t, e) {
      e && this._slimCollapsed && this.options.sidenavSlim && this.options.sidenavExpandable
        ? this.toggleSlim()
        : e || (this._slimCollapsed || !this.options.sidenavSlim || !this.options.sidenavExpandable ? this.toggler && ae(this.toggler) && this.toggle() : this.toggleSlim());
    }
    _isActive(t, e) {
      return e ? e === t : t.attributes.href ? new URL(t, window.location.href).href === window.location.href : !1;
    }
    _isAllToBeCollapsed() {
      return m.find(fO, this._element).filter((i) => i.getAttribute('aria-expanded') === 'true').length === 0;
    }
    _isAllCollapsed() {
    ...
    _initializeBackDrop() {
      ...
      const t = this.options.sidenavBackdropClass
        ...
        : this.options.sidenavPosition
          ? ['opacity-50', 'transition-all', 'duration-300', 'ease-in-out', this.options.sidenavPosition, 'top-0', 'left-0', 'z-50', 'bg-black/10', 'dark:bg-black-60', 'w-full', 'h-full', this._element.id]
          : null;
      return new Qa({ isVisible: this.options.sidenavBackdrop, isAnimated: !0, rootElement: this._element.parentNode, backdropClasses: t, clickCallback: () => this.hide() });
    }
    _updateBackdrop(t) {
    ...
    _setupCollapse() {
      this.navigation.forEach((t, e) => {
        m.find(Cs, t).forEach((n, o) => this._setupCollapseList({ list: n, index: o, menu: t, menuIndex: e }));
      });
    }
    ...
    _setupCollapseList({ list: t, index: e, menu: i, menuIndex: n }) {
      ...
      const [r] = m.prev(t, kn);
      g.setDataAttribute(r, 'collapse-init', ''), r.setAttribute('href', `#${o}`), r.setAttribute('role', 'button');
      const a = ce.getInstance(t) || new ce(t, { toggle: !1, parent: this.options.sidenavAccordion ? i : t });
    ...
    _setupFocusTrap() {
      this._focusTrap = new Vs(this._element, { event: 'keydown', condition: (t) => t.keyCode === Ci, onlyVisible: !0 }, this.toggler);
    }
    ...
    _setupScrolling() {
      ...
      this._perfectScrollbar = new ms(t, { suppressScrollX: !0, handlers: ['click-rail', 'drag-thumb', 'wheel', 'touch'] });
    }
    _setupSlim() {
    ...
    _setupRippleEffect() {
      this.links.forEach((t) => {
        ...
        (localStorage.theme === 'dark' || (!('theme' in localStorage) && window.matchMedia('(prefers-color-scheme: dark)').matches)) && (i = 'white'), (e = new Ye(t, { rippleColor: i }));
      });
    }
    _setupTouch() {
      (this._touch = new pE(this._element, 'swipe', { threshold: 20 })),
        this._touch.init(),
        _.on(this._element, 'swipeleft', (t) => this._handleSwipe(t, this.options.sidenavRight)),
        _.on(this._element, 'swiperight', (t) => this._handleSwipe(t, !this.options.sidenavRight));
    }
    _setActive(t, e) {
      ...
      const [n] = m.prev(i, kn);
      this._setActiveCategory(n), !e && !this._slimCollapsed && ce.getInstance(i).show();
    }
    ...
    _setContentOffsets(t, e, i) {
      this._content.forEach((n, o) => {
        const r = this._getOffsetValue(t, { index: o, property: 'padding', offsets: e }),
          ...
          l = {};
        if ((i || (l.transition = `all ${this.transitionDuration} linear`), (l[e.padding.property] = `${r}px`), (l[e.margin.property] = `${a}px`), g.style(n, l), !!t)) {
          if (i) {
    ...
    _setSlim(t) {
      ...
      this._triggerEvents(...e), t && this._collapseItems(), (this._slimCollapsed = t), this._toggleSlimDisplay(t), g.style(this._element, { width: `${this.width}px` }), this._updateOffsets(this.isVisible);
    }
    _setTabindex(t) {
    ...
    _update(t) {
      t && this._isiPhone() && g.addClass(this._element, 'ps--scrolling-y'),
        ...
        t && this.options.sidenavCloseOnEsc && this.options.sidenavMode !== 'side' && _.on(window, 'keydown', this.escHandler),
    ...
    _updateOffsets(t, e = !1) {
      const [i, n] = this.options.sidenavRight ? ['right', 'left'] : ['left', 'right'],
        o = { property: this._getProperty('padding', i), value: this.options.sidenavMode === 'over' ? 0 : this.width },
        r = { property: this._getProperty('margin', n), value: this.options.sidenavMode === 'push' ? -1 * this.width : 0 };
      _.trigger(this._element, 'update.te.sidenav', { margin: r, padding: o }), this._content && ((this._content.className = ''), this._setContentOffsets(t, { padding: o, margin: r }, e));
    }
    ...
    static jQueryInterface(t, e) {
      return this.each(function () {
        ...
        const n = typeof t == 'object' && t;
        if (!(!i && /dispose/.test(t)) && (i || (i = new Ii(this, n)), typeof t == 'string')) {
          if (typeof i[t] > 'u') throw new TypeError(`No method named "${t}"`);
          i[t](e);
        }
      });
  ...
  const xO = (s, t) => (typeof s == 'string' && s.endsWith('%') ? parseFloat(s) / 100 : s / t),
    gf = (s, t) => (typeof s == 'string' && s.endsWith('%') ? (parseFloat(s) / 100) * t : +s);
  function G(s, t, e) {
  ...
  function U(s, t, e, i) {
    ...
    else if (V(s)) for (r = Object.keys(s), o = r.length, n = 0; n < o; n++) t.call(e, s[r[n]], r[n]);
  }
  function Fr(s, t) {
    let e, i, n, o;
  ...
  function AO(s, t, e) {
    ...
    const i = t[s],
      n = e[s];
    V(i) && V(n) ? Sn(i, n) : Object.prototype.hasOwnProperty.call(t, s) || (t[s] = Wr(n));
  }
  ...
  const yc = (s) => (s === 'start' ? 'left' : s === 'end' ? 'right' : 'center'),
    ...
    HO = (s, t, e, i) => (s === (i ? 'left' : 'right') ? e : s === 'center' ? (t + e) / 2 : t);
  function If(s, t, e) {
    const i = t.length;
    let n = 0,
      o = i;
    if (s._sorted) {
      ...
      d && (n = dt(Math.min(De(a, r.axis, c).lo, e ? i : De(t, l, r.getPixelForValue(c)).lo), 0, i - 1)), u ? (o = dt(Math.max(De(a, r.axis, h, !0).hi + 1, e ? 0 : De(t, l, r.getPixelForValue(h), !0).hi + 1), n, i) - n) : (o = i - n);
    }
  ...
  const jr = (s) => s === 0 || s === 1,
    Mf = (s, t, e) => -(Math.pow(2, 10 * (s -= 1)) * Math.sin(((s - t) * q) / e)),
    ...
    Mn = {
      ...
      easeInOutExpo: (s) => (jr(s) ? s : s < 0.5 ? 0.5 * Math.pow(2, 10 * (s * 2 - 1)) : 0.5 * (-Math.pow(2, -10 * (s * 2 - 1)) + 2)),
      ...
      easeInOutElastic(s) {
        return jr(s) ? s : s < 0.5 ? 0.5 * Mf(s * 2, 0.1125, 0.45) : 0.5 + 0.5 * Lf(s * 2 - 1, 0.1125, 0.45);
      },
      easeInBack(s) {
      ...
      easeInOutBounce: (s) => (s < 0.5 ? Mn.easeInBounce(s * 2) * 0.5 : Mn.easeOutBounce(s * 2 - 1) * 0.5 + 0.5),
    };
  /*!
   * @kurkle/color v0.2.1
  ...
  function zO(s) {
    ...
    return (
      s[0] === '#' &&
        (t === 4 || t === 5
          ? (e = { r: 255 & (Kt[s[1]] * 17), g: 255 & (Kt[s[2]] * 17), b: 255 & (Kt[s[3]] * 17), a: t === 5 ? Kt[s[4]] * 17 : 255 })
          : (t === 7 || t === 9) && (e = { r: (Kt[s[1]] << 4) | Kt[s[2]], g: (Kt[s[3]] << 4) | Kt[s[4]], b: (Kt[s[5]] << 4) | Kt[s[6]], a: t === 9 ? (Kt[s[7]] << 4) | Kt[s[8]] : 255 })),
      e
    );
  }
  ...
  function Ec(s) {
    const e = s.r / 255,
      ...
      a = (o + r) / 2;
    let l, c, h;
    return o !== r && ((h = o - r), (c = a > 0.5 ? h / (2 - o - r) : h / (o + r)), (l = GO(e, i, n, h, o)), (l = l * 60 + 0.5)), [l | 0, c || 0, a];
  }
  function xc(s, t, e, i) {
  ...
  function QO(s) {
    ...
    const n = Pf(+t[2]),
      o = +t[3] / 100,
      r = +t[4] / 100;
    return t[1] === 'hwb' ? (i = qO(n, o, r)) : t[1] === 'hsv' ? (i = ZO(n, o, r)) : (i = Cc(n, o, r)), { r: i[0], g: i[1], b: i[2], a: e };
  }
  function JO(s, t) {
    var e = Ec(s);
    (e[0] = Pf(e[0] + t)), (e = Cc(e)), (s.r = e[0]), (s.g = e[1]), (s.b = e[2]);
  }
  function tI(s) {
    if (!s) return;
    const t = Ec(s),
      ...
      i = $f(t[1]),
      n = $f(t[2]);
    return s.a < 255 ? `hsla(${e}, ${i}%, ${n}%, ${Me(s.a)})` : `hsl(${e}, ${i}%, ${n}%)`;
  }
  const Nf = {
      x: 'dark',
      Z: 'light',
  ...
  function eI() {
    ...
    for (i = 0; i < t.length; i++) {
      for (r = a = t[i], n = 0; n < e.length; n++) (o = e[n]), (a = a.replace(o, Nf[o]));
      (o = parseInt(Bf[r], 16)), (s[a] = [(o >> 16) & 255, (o >> 8) & 255, o & 255]);
    }
    return s;
  }
  let Kr;
  ...
  function nI(s) {
    ...
    if (t) {
      ...
      return (i = +t[1]), (n = +t[3]), (o = +t[5]), (i = 255 & (t[2] ? $n(i) : ii(i, 0, 255))), (n = 255 & (t[4] ? $n(n) : ii(n, 0, 255))), (o = 255 & (t[6] ? $n(o) : ii(o, 0, 255))), { r: i, g: n, b: o, a: e };
    }
  }
  function oI(s) {
    return s && (s.a < 255 ? `rgba(${s.r}, ${s.g}, ${s.b}, ${Me(s.a)})` : `rgb(${s.r}, ${s.g}, ${s.b})`);
  }
  const Ac = (s) => (s <= 0.0031308 ? s * 12.92 : Math.pow(s, 1 / 2.4) * 1.055 - 0.055),
    ws = (s) => (s <= 0.04045 ? s / 12.92 : Math.pow((s + 0.055) / 1.055, 2.4));
  function rI(s, t, e) {
    const i = ws(Me(s.r)),
      n = ws(Me(s.g)),
      o = ws(Me(s.b));
    return { r: si(Ac(i + e * (ws(Me(t.r)) - i))), g: si(Ac(n + e * (ws(Me(t.g)) - n))), b: si(Ac(o + e * (ws(Me(t.b)) - o))), a: s.a + e * (t.a - s.a) };
  }
  function Ur(s, t, e) {
    if (s) {
      let i = Ec(s);
      (i[t] = Math.max(0, Math.min(i[t] + i[t] * e, t === 0 ? 360 : 1))), (i = Cc(i)), (s.r = i[0]), (s.g = i[1]), (s.b = i[2]);
    }
  }
  function Hf(s, t) {
  ...
  function Vf(s) {
    ...
    return Array.isArray(s) ? s.length >= 3 && ((t = { r: s[0], g: s[1], b: s[2], a: 255 }), s.length > 3 && (t.a = si(s[3]))) : ((t = Hf(s, { r: 0, g: 0, b: 0, a: 1 })), (t.a = si(t.a))), t;
  }
  function aI(s) {
  ...
  class Xr {
    constructor(t) {
      ...
      const e = typeof t;
      let i;
      e === 'object' ? (i = Vf(t)) : e === 'string' && (i = zO(t) || iI(t) || aI(t)), (this._rgb = i), (this._valid = !!i);
    }
    get valid() {
      return this._valid;
    }
  ...
  var F = new lI({ _scriptable: (s) => !s.startsWith('on'), _indexable: (s) => s !== 'events', hover: { _fallback: 'interaction' }, interaction: { _scriptable: !1, _indexable: !1 } });
  function cI(s) {
    return !s || H(s.size) || H(s.family) ? null : (s.style ? s.style + ' ' : '') + (s.weight ? s.weight + ' ' : '') + s.size + 'px ' + s.family;
  }
  ...
  function hI(s, t, e, i) {
    ...
    for (l = 0; l < a; l++)
      ...
      else if (Q(d)) for (c = 0, h = d.length; c < h; c++) (u = d[c]), u != null && !Q(u) && (r = Gr(s, n, o, r, u));
    s.restore();
    const p = o.length / 2;
    if (p > e.length) {
  ...
  function Yf(s, t, e, i, n) {
    ...
    if (d && typeof d == 'object' && ((o = d.toString()), o === '[object HTMLImageElement]' || o === '[object HTMLCanvasElement]')) {
      s.save(), s.translate(e, i), s.rotate(f), s.drawImage(d, -d.width / 2, -d.height / 2, d.width, d.height), s.restore();
      return;
    }
    if (!(isNaN(p) || p <= 0)) {
      switch ((s.beginPath(), d)) {
        default:
          n ? s.ellipse(e, i, n / 2, p, 0, 0, q) : s.arc(e, i, p, 0, q), s.closePath();
          break;
        case 'triangle':
          s.moveTo(e + Math.sin(f) * p, i - Math.cos(f) * p), (f += yf), s.lineTo(e + Math.sin(f) * p, i - Math.cos(f) * p), (f += yf), s.lineTo(e + Math.sin(f) * p, i - Math.cos(f) * p), s.closePath();
          break;
        case 'rectRounded':
          (c = p * 0.516),
            (l = p - c),
        ...
        case 'rect':
          ...
          f += On;
        case 'rectRot':
          (r = Math.cos(f) * p), (a = Math.sin(f) * p), s.moveTo(e - r, i - a), s.lineTo(e + a, i - r), s.lineTo(e + r, i + a), s.lineTo(e - a, i + r), s.closePath();
          break;
        case 'crossRot':
          f += On;
        case 'cross':
          (r = Math.cos(f) * p), (a = Math.sin(f) * p), s.moveTo(e - r, i - a), s.lineTo(e + r, i + a), s.moveTo(e + a, i - r), s.lineTo(e - a, i + r);
          break;
        case 'star':
          (r = Math.cos(f) * p),
            (a = Math.sin(f) * p),
          ...
          break;
        case 'line':
          (r = n ? n / 2 : Math.cos(f) * p), (a = Math.sin(f) * p), s.moveTo(e - r, i - a), s.lineTo(e + r, i + a);
          break;
        case 'dash':
  ...
  function Li(s, t, e, i, n, o = {}) {
    ...
    for (s.save(), s.font = n.string, pI(s, o), l = 0; l < r.length; ++l)
      (c = r[l]), a && (o.strokeColor && (s.strokeStyle = o.strokeColor), H(o.strokeWidth) || (s.lineWidth = o.strokeWidth), s.strokeText(c, e, i, o.maxWidth)), s.fillText(c, e, i, o.maxWidth), fI(s, e, i, c, o), (i += n.lineHeight);
    s.restore();
  }
  function pI(s, t) {
  ...
  function Nn(s, t) {
    ...
    s.arc(e + r.topLeft, i + r.topLeft, r.topLeft, -nt, it, !0),
      ...
      s.arc(e + n - r.bottomRight, i + o - r.bottomRight, r.bottomRight, nt, 0, !0),
  ...
  const _I = new RegExp(/^(normal|(\d+(?:\.\d+)?)(px|em|%)?)$/),
    gI = new RegExp(/^(normal|italic|initial|inherit|unset|(oblique( -?[0-9]?[0-9]deg)?))$/);
  function mI(s, t) {
    const e = ('' + s).match(_I);
  ...
  function lt(s, t) {
    ...
    i && !('' + i).match(gI) && (console.warn('Invalid font style specified: "' + i + '"'), (i = ''));
    const n = { family: B(s.family, t.family), lineHeight: mI(B(s.lineHeight, t.lineHeight), e), size: e, style: i, weight: B(s.weight, t.weight), string: '' };
  ...
  function tt(s, t, e, i) {
    ...
    for (o = 0, r = s.length; o < r; ++o)
      if (((a = s[o]), a !== void 0 && (t !== void 0 && typeof a == 'function' && ((a = a(t)), (n = !1)), e !== void 0 && Q(a) && ((a = a[e % a.length]), (n = !1)), a !== void 0))) return i && !n && (i.cacheable = !1), a;
  }
  function vI(s, t, e) {
    const { min: i, max: n } = s,
      o = gf(t, (n - i) / 2),
  ...
  function Dc(s, t = [''], e = s, i, n = () => s[0]) {
    ...
    const o = { [Symbol.toStringTag]: 'Object', _cacheable: !0, _scopes: s, _rootScopes: e, _fallback: i, _getTarget: n, override: (r) => Dc([r, ...s], t, e, i) };
    return new Proxy(o, {
      deleteProperty(r, a) {
  ...
  function ks(s, t, e, i) {
    const n = { _cacheable: !1, _proxy: s, _context: t, _subProxy: e, _stack: new Set(), _descriptors: Uf(s, i), setContext: (o) => ks(s, o, e, i), override: (o) => ks(s.override(o), t, e, i) };
    return new Proxy(n, {
      deleteProperty(o, r) {
      ...
      getOwnPropertyDescriptor(o, r) {
        return o._descriptors.allKeys ? (Reflect.has(s, r) ? { enumerable: !0, configurable: !0 } : void 0) : Reflect.getOwnPropertyDescriptor(s, r);
      },
      getPrototypeOf() {
  ...
  function Uf(s, t = { scriptable: !0, indexable: !0 }) {
    ...
    return { allKeys: n, scriptable: e, indexable: i, isScriptable: ei(e) ? e : () => e, isIndexable: ei(i) ? i : () => i };
  }
  const yI = (s, t) => (s ? s + gc(t) : t),
    Mc = (s, t) => V(t) && s !== 'adapters' && (Object.getPrototypeOf(t) === null || t.constructor === Object);
  function Xf(s, t, e) {
  ...
  function TI(s, t, e) {
    ...
    let a = i[t];
    return ei(a) && r.isScriptable(t) && (a = EI(t, a, s, e)), Q(a) && a.length && (a = xI(t, a, s, r.isIndexable)), Mc(t, a) && (a = ks(a, n, o && o[t], r)), a;
  }
  function EI(s, t, e, i) {
    const { _proxy: n, _context: o, _subProxy: r, _stack: a } = e;
    if (a.has(s)) throw new Error('Recursion detected: ' + Array.from(a).join('->') + '->' + s);
    return a.add(s), (t = t(o, r || i)), a.delete(s), Mc(s, t) && (t = Lc(n._scopes, n, s, t)), t;
  }
  function xI(s, t, e, i) {
  ...
  function Lc(s, t, e, i) {
    ...
    return l === null || (jt(o) && o !== e && ((l = qf(a, r, o, l, i)), l === null)) ? !1 : Dc(Array.from(a), [''], n, o, () => wI(t, e, i));
  }
  ...
  function kI(s, t, e, i) {
    let n;
    for (const o of t) if (((n = Zf(yI(o, s), e)), jt(n))) return Mc(s, n) ? Lc(e, i, s, n) : n;
  }
  function Zf(s, t) {
    for (const e of t) {
      if (!e) continue;
  ...
  function SI(s) {
    const t = new Set();
    for (const e of s) for (const i of Object.keys(e).filter((n) => !n.startsWith('_'))) t.add(i);
    return Array.from(t);
  }
  function Jf(s, t, e, i) {
    const { iScale: n } = s,
      ...
      r = new Array(i);
    let a, l, c, h;
    for (a = 0, l = i; a < l; ++a) (c = a + e), (h = t[c]), (r[a] = { r: n.parse(ti(h, o), c) });
    return r;
  }
  ...
  function LI(s, t = 'x') {
    ...
    for (r = 0; r < i; ++r)
      if (((a = l), (l = c), (c = Ss(s, r + 1)), !!l)) {
        ...
        o[r] = a ? (c ? (Ee(n[r - 1]) !== Ee(n[r]) ? 0 : (n[r - 1] + n[r]) / 2) : n[r - 1]) : n[r];
      }
    DI(s, n, o), MI(s, o, t);
  }
  function Qr(s, t, e) {
  ...
  function $I(s, t) {
    ...
    for (e = 0, i = s.length; e < i; ++e)
      (r = o),
        (o = a),
        (a = e < i - 1 && Pn(s[e + 1], t)),
        o && ((n = s[e]), r && ((n.cp1x = Qr(n.cp1x, t.left, t.right)), (n.cp1y = Qr(n.cp1y, t.top, t.bottom))), a && ((n.cp2x = Qr(n.cp2x, t.left, t.right)), (n.cp2y = Qr(n.cp2y, t.top, t.bottom))));
  }
  function RI(s, t, e, i, n) {
    let o, r, a, l;
    if ((t.spanGaps && (s = s.filter((c) => !c.skip)), t.cubicInterpolationMode === 'monotone')) LI(s, n);
    else {
      let c = i ? s[s.length - 1] : s[0];
      for (o = 0, r = s.length; o < r; ++o) (a = s[o]), (l = II(c, a, s[Math.min(o + 1, r - (i ? 0 : 1)) % r], t.tension)), (a.cp1x = l.previous.x), (a.cp1y = l.previous.y), (a.cp2x = l.next.x), (a.cp2y = l.next.y), (c = a);
    }
  ...
  function Pi(s, t) {
    ...
    return o && ((p -= r.width + a.width), (f -= r.height + a.height)), { x: Math.round((((l - d) / p) * e.width) / i), y: Math.round((((c - u) / f) * e.height) / i) };
  }
  function VI(s, t, e) {
    let i, n;
    if (t === void 0 || e === void 0) {
      ...
      if (!o) (t = s.clientWidth), (e = s.clientHeight);
        ...
        const r = o.getBoundingClientRect(),
          ...
          l = Ri(a, 'border', 'width'),
          c = Ri(a, 'padding');
        (t = r.width - c.width - l.width), (e = r.height - c.height - l.height), (i = Jr(a.maxWidth, o, 'clientWidth')), (n = Jr(a.maxHeight, o, 'clientHeight'));
      }
    }
  ...
  function FI(s, t, e, i) {
    ...
    return (c = Math.max(0, c - o.width)), (h = Math.max(0, i ? Math.floor(c / i) : h - o.height)), (c = Rc(Math.min(c, r, l.maxWidth))), (h = Rc(Math.min(h, a, l.maxHeight))), c && !h && (h = Rc(c / 2)), { width: c, height: h };
  }
  function i_(s, t, e) {
    const i = t || 1,
    ...
    return (
      ...
      s.currentDevicePixelRatio !== i || r.height !== n || r.width !== o ? ((s.currentDevicePixelRatio = i), (r.height = n), (r.width = o), s.ctx.setTransform(i, 0, 0, i, 0, 0), !0) : !1
    );
  }
  const WI = (function () {
    let s = !1;
  ...
  function o_(s, t) {
    let e, i;
    (t === 'ltr' || t === 'rtl') && ((e = s.canvas.style), (i = [e.getPropertyValue('direction'), e.getPropertyPriority('direction')]), e.setProperty('direction', t, 'important'), (s.prevTextDirection = i));
  }
  function r_(s, t) {
    t !== void 0 && (delete s.prevTextDirection, s.canvas.style.setProperty('direction', t[0], t[1]));
  }
  function a_(s) {
    return s === 'angle' ? { between: Dn, compare: LO, normalize: Vt } : { between: Ie, compare: (t, e) => t - e, normalize: (t) => t };
  }
  ...
  function XI(s, t, e) {
    ...
    let { start: c, end: h, loop: d } = s,
      ...
      p;
    if (d) {
      for (c += l, h += l, u = 0, p = l; u < p && r(a(t[c % l][i]), n, o); ++u) c--, h--;
      (c %= l), (h %= l);
    }
  ...
  function c_(s, t, e) {
    ...
    for (let S = h, k = h; S <= d; ++S)
      (T = t[S % r]),
        !T.skip && ((y = c(T[i])), y !== x && ((b = l(y, n, o)), v === null && A() && (v = a(y, n) === 0 ? S : k), v !== null && w() && (f.push(l_({ start: v, end: S, loop: u, count: r, style: p })), (v = null)), (k = S), (x = y)));
    return v !== null && f.push(l_({ start: v, end: d, loop: u, count: r, style: p })), f;
  }
  function h_(s, t) {
    const e = [],
      i = s.segments;
  ...
  function qI(s, t, e, i) {
    ...
    for (l = t + 1; l <= e; ++l) {
      const c = s[l % n];
      c.skip || c.stop ? a.skip || ((i = !1), o.push({ start: t % n, end: (l - 1) % n, loop: i }), (t = r = c.stop ? l : null)) : ((r = l), a.skip && (t = l)), (a = c);
    }
  ...
  function QI(s, t, e, i) {
    ...
    for (const f of t) {
      ...
      for (u = d + 1; u <= f.end; u++) {
        const y = e[u % l];
        (v = u_(i.setContext(ni(n, { type: 'segment', p0: b, p1: y, p0DataIndex: (u - 1) % l, p1DataIndex: u % l, datasetIndex: r })))), JI(v, h) && p(d, u - 1, f.loop, h), (b = y), (h = v);
      }
  ...
  function u_(s) {
    return { backgroundColor: s.backgroundColor, borderCapStyle: s.borderCapStyle, borderDash: s.borderDash, borderDashOffset: s.borderDashOffset, borderJoinStyle: s.borderJoinStyle, borderWidth: s.borderWidth, borderColor: s.borderColor };
  }
  function JI(s, t) {
    ...
    _update(t = Date.now()) {
      ...
      this._charts.forEach((i, n) => {
        ...
        let r = o.length - 1,
          a = !1,
          l;
        for (; r >= 0; --r) (l = o[r]), l._active ? (l._total > i.duration && (i.duration = l._total), l.tick(t), (a = !0)) : ((o[r] = o[o.length - 1]), o.pop());
    ...
    update(t, e, i) {
      if (this._active) {
        ...
        const n = this._target[this._prop],
          o = i - this._start,
          r = this._duration - o;
        (this._start = i), (this._duration = Math.floor(Math.max(r, t.duration))), (this._total += o), (this._loop = !!t.loop), (this._to = tt([t.to, e, n, t.from])), (this._from = tt([t.from, n, e]));
      }
    }
    cancel() {
  ...
  F.set('animation', { delay: void 0, duration: 1e3, easing: 'easeOutQuart', fn: void 0, from: void 0, loop: void 0, to: void 0, type: void 0 });
  const nD = Object.keys(F.animation);
  F.describe('animation', { _fallback: !1, _indexable: !1, _scriptable: (s) => s !== 'onProgress' && s !== 'onComplete' && s !== 'fn' }),
    F.set('animations', { colors: { type: 'color', properties: sD }, numbers: { type: 'number', properties: iD } }),
    ...
    F.set('transitions', {
      ...
      hide: { animations: { colors: { to: 'transparent' }, visible: { type: 'boolean', easing: 'linear', fn: (s) => s | 0 } } },
    });
  class Pc {
    constructor(t, e) {
  ...
  function lD(s) {
    let t, e, i, n;
    return V(s) ? ((t = s.top), (e = s.right), (i = s.bottom), (n = s.left)) : (t = e = i = n = s), { top: t, right: e, bottom: i, left: n, disabled: s === !1 };
  }
  function g_(s, t) {
    const e = [],
  ...
  function m_(s, t, e, i = {}) {
    ...
    if (t !== null) {
      for (r = 0, a = n.length; r < a; ++r) {
        ...
        (c = s.values[l]), rt(c) && (o || t === 0 || Ee(t) === Ee(c)) && (t += c);
      }
      return t;
    }
  }
  ...
  function y_(s, t) {
    ...
    for (let p = 0; p < d; ++p) {
      ...
      (u = y[c] = uD(n, h, b)), (u[a] = v), (u._top = v_(u, r, !0, i.type)), (u._bottom = v_(u, r, !1, i.type));
    }
  }
  function Nc(s, t) {
    const e = s.scales;
  ...
  function pD(s, t) {
    return ni(s, { active: !1, dataset: void 0, datasetIndex: t, index: t, mode: 'default', type: 'dataset' });
  }
  function fD(s, t, e) {
    return ni(s, { active: !1, dataIndex: t, parsed: void 0, raw: void 0, element: e, index: t, mode: 'default', type: 'data' });
  }
  function Hn(s, t) {
  ...
  const Bc = (s) => s === 'reset' || s === 'none',
    ...
    _D = (s, t, e) => s && !t.hidden && t._stacked && { keys: g_(e, !0), values: null };
  class Ut {
    constructor(t, e) {
      (this.chart = t),
        (this._ctx = t.ctx),
    ...
    initialize() {
      ...
      this.configure(), this.linkScales(), (t._stacked = b_(t.vScale, t)), this.addElements();
    }
    updateIndex(t) {
    ...
    buildOrUpdateElements(t) {
      ...
      this._dataCheck();
      const o = e._stacked;
      (e._stacked = b_(e.vScale, e)), e.stack !== i.stack && ((n = !0), Hn(e), (e.stack = i.stack)), this._resyncElements(t), (n || o !== e._stacked) && y_(this, e._parsed);
    }
    configure() {
    ...
    parse(t, e) {
      ...
      if (this._parsing === !1) (i._parsed = n), (i._sorted = !0), (u = n);
        ...
        Q(n[t]) ? (u = this.parseArrayData(i, n, t, e)) : V(n[t]) ? (u = this.parseObjectData(i, n, t, e)) : (u = this.parsePrimitiveData(i, n, t, e));
        const p = () => d[a] === null || (c && d[a] < c[a]);
        for (h = 0; h < e; ++h) (i._parsed[h + t] = d = u[h]), l && (p() && (l = !1), (c = d));
        i._sorted = l;
      }
      r && y_(this, u);
    }
    parsePrimitiveData(t, e, i, n) {
      const { iScale: o, vScale: r } = t,
        ...
        d = new Array(n);
      let u, p, f;
      for (u = 0, p = n; u < p; ++u) (f = u + i), (d[u] = { [a]: h || o.parse(c[f], f), [l]: r.parse(e[f], f) });
      return d;
    }
    parseArrayData(t, e, i, n) {
      const { xScale: o, yScale: r } = t,
        a = new Array(n);
      let l, c, h, d;
      for (l = 0, c = n; l < c; ++l) (h = l + i), (d = e[h]), (a[l] = { x: o.parse(d[0], h), y: r.parse(d[1], h) });
      return a;
    }
    parseObjectData(t, e, i, n) {
      const { xScale: o, yScale: r } = t,
        ...
        c = new Array(n);
      let h, d, u, p;
      for (h = 0, d = n; h < d; ++h) (u = h + i), (p = e[u]), (c[h] = { x: o.parse(ti(p, a), u), y: r.parse(ti(p, l), u) });
      return c;
    }
    getParsed(t) {
    ...
    updateRangeFromParsed(t, e, i, n) {
      ...
      n && a && ((n.values = a), (r = m_(n, o, this._cachedMeta.index))), (t.min = Math.min(t.min, r)), (t.max = Math.max(t.max, r));
    }
    getMinMax(t, e) {
    ...
    getAllParsedValues(t) {
      const e = this._cachedMeta._parsed,
        i = [];
      let n, o, r;
      for (n = 0, o = e.length; n < o; ++n) (r = e[n][t.axis]), rt(r) && i.push(r);
      return i;
    }
    getMaxOverflow() {
      return !1;
    ...
    _update(t) {
      const e = this._cachedMeta;
      this.update(t || 'default'), (e._clip = lD(B(this.options.clip, aD(e.xScale, e.yScale, this.getMaxOverflow()))));
    }
    update(t) {}
    draw() {
      const t = this._ctx,
    ...
    getContext(t, e, i) {
      ...
      if (t >= 0 && t < this._cachedMeta.data.length) {
        ...
        (o = r.$context || (r.$context = fD(this.getContext(), t, r))), (o.parsed = this.getParsed(t)), (o.raw = n.data[t]), (o.index = o.dataIndex = t);
  ...
  (Ut.defaults = {}), (Ut.prototype.datasetElementType = null), (Ut.prototype.dataElementType = null);
  function gD(s, t) {
    if (!s._cache.$bar) {
  ...
  function mD(s) {
    ...
    let i = t._length,
      ...
      a;
    const l = () => {
      r === 32767 || r === -32768 || (jt(a) && (i = Math.min(i, Math.abs(r - a) || i)), (a = r));
    };
  ...
  function bD(s, t, e, i) {
    ...
    let o, r;
    return H(n) ? ((o = t.min * e.categoryPercentage), (r = e.barPercentage)) : ((o = n * i), (r = 1)), { chunk: o / i, ratio: r, start: t.pixels[s] - o / 2 };
  }
  function vD(s, t, e, i) {
    const n = t.pixels,
      o = n[s];
  ...
  function x_(s, t, e, i) {
    const n = s.iScale,
      ...
      l = [];
    let c, h, d, u;
    for (c = e, h = e + i; c < h; ++c) (u = t[c]), (d = {}), (d[n.axis] = a || n.parse(r[c], c)), l.push(E_(u, d, o, c));
    return l;
  }
  function Hc(s) {
  ...
  function ED(s) {
    let t, e, i, n, o;
    return (
      s.horizontal ? ((t = s.base > s.x), (e = 'left'), (i = 'right')) : ((t = s.base < s.y), (e = 'bottom'), (i = 'top')), t ? ((n = 'end'), (o = 'start')) : ((n = 'start'), (o = 'end')), { start: e, end: i, reverse: t, top: n, bottom: o }
    );
  }
  function xD(s, t, e, i) {
    ...
    n === 'middle' && e && ((s.enableBorderRadius = !0), (e._top || 0) === i ? (n = c) : (e._bottom || 0) === i ? (n = h) : ((o[C_(h, r, a, l)] = !0), (n = c))), (o[C_(n, r, a, l)] = !0), (s.borderSkipped = o);
  }
  function C_(s, t, e, i) {
  ...
  class Vn extends Ut {
    ...
    parseObjectData(t, e, i, n) {
      const { iScale: o, vScale: r } = t,
        ...
        d = [];
      let u, p, f, b;
      for (u = i, p = i + n; u < p; ++u) (b = e[u]), (f = {}), (f[o.axis] = o.parse(ti(b, c), u)), d.push(E_(ti(b, h), f, r, u));
      return d;
    }
    updateRangeFromParsed(t, e, i, n) {
    ...
    getLabelAndValue(t) {
      const e = this._cachedMeta,
        ...
        o = this.getParsed(t),
        r = o._custom,
        a = Hc(r) ? '[' + r.start + ', ' + r.end + ']' : '' + n.getLabelForValue(o[n.axis]);
      ...
      for (let p = e; p < e + i; p++) {
        const f = this.getParsed(p),
          ...
          T = {
            horizontal: c,
            base: b.base,
            enableBorderRadius: !y || Hc(f._custom) || r === y._top || r === y._bottom,
            x: c ? b.head : v.center,
            y: c ? v.center : b.head,
            height: c ? v.size : Math.abs(b.size),
            width: c ? Math.abs(b.size) : v.size,
          };
        u && (T.options = d || this.resolveDataElementOptions(p, t[p].active ? 'active' : n));
    ...
    _getRuler() {
      ...
      return { min: a || mD(e), pixels: n, start: i._startPixel, end: i._endPixel, stackCount: this._getStackCount(), scale: i, grouped: t.grouped, ratio: a ? 1 : t.categoryPercentage * t.barPercentage };
    }
    _calculateBarValuePixels(t) {
      ...
      let h = a[e.axis],
        ...
        p,
        f;
      u !== h && ((d = u - h), (u = h)), c && ((h = l.barStart), (u = l.barEnd - l.barStart), h !== 0 && Ee(h) !== Ee(l.barEnd) && (d = 0), (d += h));
      const b = !H(n) && !c ? n : d;
  ...
  (Vn.id = 'bar'),
    (Vn.defaults = { datasetElementType: !1, dataElementType: 'bar', categoryPercentage: 0.8, barPercentage: 0.9, grouped: !0, animations: { numbers: { type: 'number', properties: ['x', 'y', 'base', 'width', 'height'] } } }),
    (Vn.overrides = { scales: { _index_: { type: 'category', offset: !0, grid: { offset: !0 } }, _value_: { type: 'linear', beginAtZero: !0 } } });
  class Fn extends Ut {
    initialize() {
      (this.enableOptionSharing = !0), super.initialize();
    }
    ...
    parseObjectData(t, e, i, n) {
      ...
      for (let r = 0; r < o.length; r++) {
        const a = e[i + r];
        o[r]._custom = B(a && a.r && +a.r, this.resolveDataElementOptions(r + i).radius);
      }
      return o;
    }
    getMaxOverflow() {
    ...
    resolveDataElementOptions(t, e) {
      ...
      const o = n.radius;
      return e !== 'active' && (n.radius = 0), (n.radius += B(i && i._custom, o)), n;
    }
  }
  (Fn.id = 'bubble'),
    (Fn.defaults = { datasetElementType: !1, dataElementType: 'point', animations: { numbers: { type: 'number', properties: ['x', 'y', 'borderWidth', 'radius'] } } }),
    (Fn.overrides = {
  ...
  function wD(s, t, e) {
    ...
    if (t < q) {
      const a = s,
        ...
        y = f(it, c, d),
        T = f(it + nt, h, u);
      (i = (b - y) / 2), (n = (v - T) / 2), (o = -(b + y) / 2), (r = -(v + T) / 2);
    }
  ...
  class Bi extends Ut {
    ...
    _circumference(t, e) {
      ...
      return (e && i.animation.animateRotate) || !this.chart.getDataVisibility(t) || n._parsed[t] === null || n.data[t].hidden ? 0 : this.calculateCircumference((n._parsed[t] * o) / q);
    }
    updateElements(t, e, i, n) {
      const o = n === 'reset',
        r = this.chart,
      ...
      for (T = e; T < e + i; ++T) {
        const x = this._circumference(T, o),
          E = t[T],
          C = { x: h + this.offsetX, y: d + this.offsetY, startAngle: y, endAngle: y + x, circumference: x, outerRadius: f, innerRadius: p };
        v && (C.options = b || this.resolveDataElementOptions(T, E.active ? 'active' : n)), (y += x), this.updateElement(E, T, C, n);
      }
    }
    calculateTotal() {
      const t = this._cachedMeta,
  ...
  (Bi.id = 'doughnut'),
    ...
    (Bi.descriptors = { _scriptable: (s) => s !== 'spacing', _indexable: (s) => s !== 'spacing' }),
    (Bi.overrides = {
      aspectRatio: 1,
      plugins: {
        legend: {
            ...
            generateLabels(s) {
              ...
              if (t.labels.length && t.datasets.length) {
                ...
                return t.labels.map((i, n) => {
                  ...
                  return { text: i, fillStyle: r.backgroundColor, strokeStyle: r.borderColor, lineWidth: r.borderWidth, pointStyle: e, hidden: !s.getDataVisibility(n), index: n };
                });
              }
              return [];
            },
  ...
  class Wn extends Ut {
    ...
    update(t) {
      ...
      (this._drawStart = a), (this._drawCount = l), Df(e) && ((a = 0), (l = n.length)), (i._chart = this.chart), (i._datasetIndex = this.index), (i._decimated = !!o._decimated), (i.points = n);
      const c = this.resolveDatasetElementOptions(t);
      this.options.showLine || (c.borderWidth = 0), (c.segment = this.options.segment), this.updateElement(i, void 0, { animated: !r, options: c }, t), this.updateElements(n, a, l, t);
    }
    updateElements(t, e, i, n) {
      const o = n === 'reset',
      ...
      for (let x = e; x < e + i; ++x) {
        const E = t[x],
          ...
          k = (A[p] = o || w ? a.getBasePixel() : a.getPixelForValue(l ? this.applyStack(a, C, l) : C[p], x));
        (A.skip = isNaN(S) || isNaN(k) || w),
          (A.stop = x > 0 && Math.abs(C[u] - T[u]) > v),
          b && ((A.parsed = C), (A.raw = c.data[x])),
          d && (A.options = h || this.resolveDataElementOptions(x, E.active ? 'active' : n)),
  ...
  (Wn.id = 'line'), (Wn.defaults = { datasetElementType: 'line', dataElementType: 'point', showLine: !0, spanGaps: !1 }), (Wn.overrides = { scales: { _index_: { type: 'category' }, _value_: { type: 'linear' } } });
  class zn extends Ut {
    constructor(t, e) {
    ...
    updateElements(t, e, i, n) {
      ...
      for (f = e; f < e + i; f++) {
        ...
        let y = p,
          ...
          x = r.getDataVisibility(f) ? c.getDistanceFromCenterForValue(this.getParsed(f).r) : 0;
        (p = T), o && (l.animateScale && (x = 0), l.animateRotate && (y = T = u));
        const E = { x: h, y: d, innerRadius: 0, outerRadius: x, startAngle: y, endAngle: T, options: this.resolveDataElementOptions(f, v.active ? 'active' : n) };
    ...
    _computeAngle(t, e, i) {
      return this.chart.getDataVisibility(t) ? se(this.resolveDataElementOptions(t, e).angle || i) : 0;
    }
  }
  (zn.id = 'polarArea'),
    (zn.defaults = {
  ...
  class ea extends Bi {}
  (ea.id = 'pie'), (ea.defaults = { cutout: 0, rotation: 0, circumference: 360, radius: '100%' });
  class jn extends Ut {
    getLabelAndValue(t) {
  ...
  (jn.id = 'radar'),
    (jn.defaults = { datasetElementType: 'line', dataElementType: 'point', indexAxis: 'r', showLine: !0, elements: { line: { fill: 'start' } } }),
  ...
  F.set('scale', {
    ...
    bounds: 'ticks',
    grace: 0,
    grid: { display: !0, lineWidth: 1, drawBorder: !0, drawOnChartArea: !0, drawTicks: !0, tickLength: 8, tickWidth: (s, t) => t.lineWidth, tickColor: (s, t) => t.color, offset: !1, borderDash: [], borderDashOffset: 0, borderWidth: 1 },
    ...
    F.describe('scale', { _fallback: !1, _scriptable: (s) => !s.startsWith('before') && !s.startsWith('after') && s !== 'callback' && s !== 'parser', _indexable: (s) => s !== 'borderDash' && s !== 'tickBorderDash' }),
    F.describe('scales', { _fallback: 'scale' }),
    F.describe('scale.ticks', { _scriptable: (s) => s !== 'backdropPadding' && s !== 'callback', _indexable: (s) => s !== 'backdropPadding' });
  function SD(s, t) {
    ...
    if (o > 0) {
      ...
      for (ia(t, l, c, H(u) ? 0 : r - u, r), h = 0, d = o - 1; h < d; h++) ia(t, l, c, n[h], n[h + 1]);
  ...
  function RD(s, t, e) {
    ...
    let l = s.getPixelForTick(n),
      c;
    if (!(e && (i === 1 ? (c = Math.max(l - o, r - l)) : t === 0 ? (c = (s.getPixelForTick(1) - l) / 2) : (c = (l - s.getPixelForTick(n - 1)) / 2), (l += n < t ? c : -c), l < o - a || l > r + a))) return l;
  }
  function PD(s, t) {
    U(s, (e) => {
      const i = e.gc,
  ...
  function VD(s, t, e, i) {
    ...
    if (s.isHorizontal()) {
      ...
      } else e === 'center' ? (f = (c.bottom + c.top) / 2 + b - t) : (f = k_(s, e, t));
      u = a - o;
    } else {
      if (V(e)) {
        const y = Object.keys(e)[0],
      ...
      } else e === 'center' ? (p = (c.left + c.right) / 2 - v + t) : (p = k_(s, e, t));
  ...
  class oi extends Xt {
    ...
    getUserBounds() {
      ...
      return (t = zt(t, Number.POSITIVE_INFINITY)), (e = zt(e, Number.NEGATIVE_INFINITY)), (i = zt(i, Number.POSITIVE_INFINITY)), (n = zt(n, Number.NEGATIVE_INFINITY)), { min: zt(t, i), max: zt(e, n), minDefined: rt(t), maxDefined: rt(e) };
    }
    getMinMax(t) {
      ...
      for (let l = 0, c = a.length; l < c; ++l) (r = a[l].controller.getMinMax(this, t)), n || (e = Math.min(e, r.min)), o || (i = Math.max(i, r.max));
      return (e = o && e > i ? i : e), (i = n && e > i ? e : i), { min: zt(e, zt(i, e)), max: zt(i, zt(e, i)) };
    }
    getPadding() {
    ...
    update(t, e, i) {
      ...
      this.beforeUpdate(),
        ...
        this._dataLimitsCached || (this.beforeDataLimits(), this.determineDataLimits(), this.afterDataLimits(), (this._range = vI(this, o, n)), (this._dataLimitsCached = !0)),
      ...
      this._convertTicksToLabels(l ? S_(this.ticks, a) : this.ticks),
        ...
        r.display && (r.autoSkip || r.source === 'auto') && ((this.ticks = SD(this, this.ticks)), (this._labelSizes = null), this.afterAutoSkip()),
    ...
    generateTickLabels(t) {
      ...
      let i, n, o;
      for (i = 0, n = t.length; i < n; i++) (o = t[i]), (o.label = G(e.callback, [o.value, i, t], this));
    }
    ...
    calculateLabelRotation() {
      ...
      (a = t.offset ? this.maxWidth / i : p / (i - 1)),
        d + 6 > a &&
          ...
          (l = this.maxHeight - Kn(t.grid) - e.padding - O_(t.title, this.chart.options.font)),
          (c = Math.sqrt(d * d + u * u)),
          (r = mc(Math.min(Math.asin(dt((h.highest.height + 6) / a, -1, 1)), Math.asin(dt(l / c, -1, 1)) - Math.asin(dt(u / c, -1, 1))))),
    ...
    fit() {
      ...
      if (r) {
        ...
        if ((a ? ((t.width = this.maxWidth), (t.height = Kn(o) + l)) : ((t.height = this.maxHeight), (t.width = Kn(o) + l)), i.display && this.ticks.length)) {
    ...
    _calculatePadding(t, e, i, n) {
      ...
      if (this.isHorizontal()) {
        ...
        let u = 0,
          p = 0;
        l ? (c ? ((u = n * t.width), (p = i * e.height)) : ((u = i * t.height), (p = n * e.width))) : o === 'start' ? (p = e.width) : o === 'end' ? (u = t.width) : o !== 'inner' && ((u = t.width / 2), (p = e.width / 2)),
    ...
    _convertTicksToLabels(t) {
      ...
      let e, i;
      for (e = 0, i = t.length; e < i; e++) H(t[e].label) && (t.splice(e, 1), i--, e--);
    ...
    _getLabelSizes() {
      ...
      if (!t) {
        ...
        let i = this.ticks;
        e < i.length && (i = S_(i, e)), (this._labelSizes = t = this._computeLabelSizes(i, i.length));
      }
      return t;
    }
    _computeLabelSizes(t, e) {
      ...
      let a = 0,
        ...
        x;
      for (c = 0; c < e; ++c) {
        if (((u = t[c].label), (p = this._resolveTickFontOptions(c)), (i.font = f = p.string), (b = n[f] = n[f] || { data: {}, gc: [] }), (v = p.lineHeight), (y = T = 0), !H(u) && !Q(u))) (y = Gr(i, b.data, b.gc, y, u)), (T = v);
        else if (Q(u)) for (h = 0, d = u.length; h < d; ++h) (x = u[h]), !H(x) && !Q(x) && ((y = Gr(i, b.data, b.gc, y, x)), (T += v));
      ...
      return { first: A(0), last: A(e - 1), widest: A(E), highest: A(C), widths: o, heights: r };
    }
    getLabelForValue(t) {
      return t;
    }
    ...
    _computeGridLineItems(t) {
      ...
      else if (r === 'left') (y = v(this.right)), (C = this.right - d), (w = y - b), (k = v(t.left) + b), (I = t.right);
      else if (r === 'right') (y = v(this.left)), (k = t.left), (I = v(t.right) - b), (C = y + b), (w = this.left + d);
      else if (e === 'x') {
      ...
      for (T = 0; T < h; T += X) {
        ...
        (x = RD(this, T, a)),
          x !== void 0 &&
            ...
            u.push({ tx1: C, ty1: A, tx2: w, ty2: S, x1: k, y1: D, x2: I, y2: M, width: z, color: Y, borderDash: Gt, borderDashOffset: oe, tickWidth: re, tickColor: li, tickBorderDash: qt, tickBorderDashOffset: Ae }));
      }
    ...
    _computeLabelItems(t) {
      ...
      for (y = 0, T = a.length; y < T; ++y) {
        ...
        (S = this.getPixelForTick(y) + o.labelOffset), (k = this._resolveTickFontOptions(y)), (D = k.lineHeight), (I = Q(E) ? E.length : 1);
        const z = I / 2,
          Y = R.color,
        ...
        r
          ? ((C = S),
            w === 'inner' && (y === T - 1 ? (re = this.options.reverse ? 'left' : 'right') : y === 0 ? (re = this.options.reverse ? 'right' : 'left') : (re = 'center')),
            n === 'top'
              ? c === 'near' || b !== 0
                ? (M = -I * D + D / 2)
                : c === 'center'
        ...
        if (R.showLabelBackdrop) {
          ...
          li = { left: Pe, top: Zt, width: we + qt.width, height: Ae + qt.height, color: R.backdropColor };
        }
        v.push({ rotation: b, label: E, font: k, color: Y, strokeColor: Gt, strokeWidth: oe, textOffset: M, textAlign: re, textBaseline: P, translation: [C, A], backdrop: li });
      }
      return v;
    }
    ...
    _getYAxisLabelAlignment(t) {
      ...
      return (
        e === 'left'
          ? n
            ? ((h = this.right + o), i === 'near' ? (c = 'left') : i === 'center' ? ((c = 'center'), (h += l / 2)) : ((c = 'right'), (h += l)))
            : ((h = this.right - a), i === 'near' ? (c = 'right') : i === 'center' ? ((c = 'center'), (h -= l / 2)) : ((c = 'left'), (h = this.left)))
          : e === 'right'
            ? n
              ? ((h = this.left + o), i === 'near' ? (c = 'right') : i === 'center' ? ((c = 'center'), (h -= l / 2)) : ((c = 'left'), (h -= l)))
              : ((h = this.left + a), i === 'near' ? (c = 'left') : i === 'center' ? ((c = 'center'), (h += l / 2)) : ((c = 'right'), (h = this.right)))
            : (c = 'right'),
        { textAlign: c, x: h }
      );
    }
    ...
    drawGrid(t) {
      ...
      const a = (l, c, h) => {
        !h.width ||
          !h.color ||
          (i.save(), (i.lineWidth = h.width), (i.strokeStyle = h.color), i.setLineDash(h.borderDash || []), (i.lineDashOffset = h.borderDashOffset), i.beginPath(), i.moveTo(l.x, l.y), i.lineTo(c.x, c.y), i.stroke(), i.restore());
      };
      if (e.display)
        for (o = 0, r = n.length; o < r; ++o) {
          const l = n[o];
          e.drawOnChartArea && a({ x: l.x1, y: l.y1 }, { x: l.x2, y: l.y2 }, l),
            e.drawTicks && a({ x: l.tx1, y: l.ty1 }, { x: l.tx2, y: l.ty2 }, { color: l.tickColor, width: l.tickWidth, borderDash: l.tickBorderDash, borderDashOffset: l.tickBorderDashOffset });
        }
    }
    drawBorder() {
      const {
      ...
      const r = i.setContext(this.getContext(0)).lineWidth,
        a = this._borderValue;
      let l, c, h, d;
      this.isHorizontal() ? ((l = Mi(t, this.left, o) - o / 2), (c = Mi(t, this.right, r) + r / 2), (h = d = a)) : ((h = Mi(t, this.top, o) - o / 2), (d = Mi(t, this.bottom, r) + r / 2), (l = c = a)),
        e.save(),
    ...
    drawLabels(t) {
      ...
      for (r = 0, a = o.length; r < a; ++r) {
        const l = o[r],
          c = l.font,
          h = l.label;
        l.backdrop && ((i.fillStyle = l.backdrop.color), i.fillRect(l.backdrop.left, l.backdrop.top, l.backdrop.width, l.backdrop.height));
        let d = l.textOffset;
        Li(i, h, 0, d, c, l);
      }
      n && Zr(i);
    ...
    drawTitle() {
      ...
      e === 'bottom' || e === 'center' || V(e) ? ((l += r.bottom), Q(i.text) && (l += o.lineHeight * (i.text.length - 1))) : (l += r.top);
      const { titleX: c, titleY: h, maxWidth: d, rotation: u } = VD(this, l, e, a);
      Li(t, i.text, 0, 0, o, { color: i.color, maxWidth: d, rotation: u, textAlign: HD(a, e, n), textBaseline: 'middle', translation: [c, h] });
    }
    draw(t) {
  ...
  class sa {
    ...
    register(t) {
      ...
      return o in n || ((n[o] = t), FD(t, r, i), this.override && F.override(t.id, t.overrides)), r;
    }
    get(t) {
      return this.items[t];
    }
    unregister(t) {
      const e = this.items,
        i = t.id,
        n = this.scope;
      i in e && delete e[i], n && i in F[n] && (delete F[n][i], this.override && delete Di[i]);
    }
  }
  function FD(s, t, e) {
    const i = Te(Object.create(null), [e ? F.get(e) : {}, F.get(t), s.defaults]);
    F.set(t, i), s.defaultRoutes && WD(t, s.defaultRoutes), s.descriptors && F.describe(t, s.descriptors);
  }
  function WD(s, t) {
    Object.keys(t).forEach((e) => {
      const i = e.split('.'),
  ...
  class Un extends Ut {
    update(t) {
      ...
      if (((this._drawStart = o), (this._drawCount = r), Df(e) && ((o = 0), (r = i.length)), this.options.showLine)) {
    ...
    addElements() {
      ...
      !this.datasetElementType && t && (this.datasetElementType = ne.getElement('line')), super.addElements();
    }
    updateElements(t, e, i, n) {
      const o = n === 'reset',
        { iScale: r, vScale: a, _stacked: l, _dataset: c } = this._cachedMeta,
      ...
      for (let E = e; E < e + i; ++E) {
        const C = t[E],
          ...
          D = (w[f] = o || S ? a.getBasePixel() : a.getPixelForValue(l ? this.applyStack(a, A, l) : A[f], E));
        (w.skip = isNaN(k) || isNaN(D) || S),
          (w.stop = E > 0 && Math.abs(A[p] - x[p]) > y),
          v && ((w.parsed = A), (w.raw = c.data[E])),
          u && (w.options = d || this.resolveDataElementOptions(E, C.active ? 'active' : n)),
  ...
  (Un.id = 'scatter'),
    (Un.defaults = { datasetElementType: !1, dataElementType: 'point', showLine: !1, fill: !1 }),
    (Un.overrides = {
  ...
  var I_ = Object.freeze({ __proto__: null, BarController: Vn, BubbleController: Fn, DoughnutController: Bi, LineController: Wn, PolarAreaController: zn, PieController: ea, RadarController: jn, ScatterController: Un });
  function Hi() {
    ...
    return (
      (!n && !s.isPointInArea(t)) ||
        Xn(
          ...
          t,
          function (a, l, c) {
            (!n && !Pn(a, s.chartArea, 0)) || (a.inRange(t.x, t.y, i) && o.push({ element: a, datasetIndex: l, index: c }));
          },
          !0
        ),
      o
  ...
  function XD(s, t, e, i, n, o) {
    ...
    function c(h, d, u) {
      ...
      const v = a(t, f);
      v < l ? ((r = [{ element: h, datasetIndex: d, index: u }]), (l = v)) : v === l && r.push({ element: h, datasetIndex: d, index: u });
    }
    return Xn(s, e, t, c), r;
  }
  function Wc(s, t, e, i, n, o) {
    return !o && !s.isPointInArea(t) ? [] : e === 'r' && !i ? UD(s, t, e, n) : XD(s, t, e, i, n, o);
  }
  ...
  function QD(s) {
    const t = GD(s),
      ...
      a = R_(t, 'x'),
      l = R_(t, 'y');
    return { fullSize: e, leftAndTop: i.concat(o), rightAndBottom: n.concat(l).concat(r).concat(a), chartArea: Gn(t, 'chartArea'), vertical: i.concat(n).concat(l), horizontal: o.concat(r).concat(a) };
  }
  function P_(s, t, e, i) {
  ...
  function Zn(s, t, e, i) {
    ...
    for (o = 0, r = s.length, c = 0; o < r; ++o) {
      (a = s[o]), (l = a.box), l.update(a.width || t.w, a.height || t.h, e1(a.horizontal, t));
  ...
  function B_(s, t, e, i) {
    ...
    for (const a of s) {
      ...
      if (a.horizontal) {
        const d = t.w * h,
          u = c.size || l.height;
        jt(c.start) && (r = c.start), l.fullSize ? na(l, n.left, r, e.outerWidth - n.right - n.left, u) : na(l, t.left + c.placed, r, d, u), (c.start = r), (c.placed += d), (r = l.bottom);
      } else {
        const d = t.h * h,
          u = c.size || l.width;
        jt(c.start) && (o = c.start), l.fullSize ? na(l, o, n.top, u, e.outerHeight - n.bottom - n.top) : na(l, o, t.top + c.placed, u, d), (c.start = o), (c.placed += d), (o = l.right);
      }
    }
    (t.x = o), (t.y = r);
  }
  ...
  var ft = {
    ...
    update(s, t, e, i) {
      ...
      const h = l.reduce((b, v) => (v.box.options && v.box.options.display === !1 ? b : b + 1), 0) || 1,
        d = Object.freeze({ outerWidth: t, outerHeight: e, padding: n, availableWidth: o, availableHeight: r, vBoxMaxWidth: o / 2 / h, hBoxMaxHeight: r / 2 }),
        u = Object.assign({}, n);
      N_(u, pt(i));
      ...
      Zn(a.fullSize, p, d, f),
        ...
        (s.chartArea = { left: p.left, top: p.top, right: p.left + p.w, bottom: p.top + p.h, height: p.h, width: p.w }),
        U(a.chartArea, (b) => {
          const v = b.box;
          Object.assign(v, s.chartArea), v.update(p.w, p.h, { left: 0, top: 0, right: 0, bottom: 0 });
        });
    },
  };
  class zc {
  ...
  const oa = '$chartjs',
    i1 = { touchstart: 'mousedown', touchmove: 'mousemove', touchend: 'mouseup', pointerenter: 'mouseenter', pointerdown: 'mousedown', pointermove: 'mousemove', pointerup: 'mouseup', pointerleave: 'mouseout', pointerout: 'mouseout' },
    V_ = (s) => s === null || s === '';
  function s1(s, t) {
    const e = s.style,
      i = s.getAttribute('height'),
      n = s.getAttribute('width');
    if (((s[oa] = { initial: { height: i, width: n, style: { display: e.display, height: e.height, width: e.width } } }), (e.display = e.display || 'block'), (e.boxSizing = e.boxSizing || 'border-box'), V_(n))) {
      const o = s_(s, 'width');
      o !== void 0 && (s.width = o);
    }
    if (V_(i))
  ...
  function a1(s, t, e) {
    const i = s.canvas,
      n = new MutationObserver((o) => {
        let r = !1;
        for (const a of o) (r = r || ra(a.addedNodes, i)), (r = r && !ra(a.removedNodes, i));
        r && e();
      });
  ...
  function l1(s, t, e) {
    const i = s.canvas,
      n = new MutationObserver((o) => {
        let r = !1;
        for (const a of o) (r = r || ra(a.removedNodes, i)), (r = r && !ra(a.addedNodes, i));
        r && e();
      });
    return n.observe(document, { childList: !0, subtree: !0 }), n;
  }
  ...
  class j_ extends zc {
    ...
    removeEventListener(t, e) {
      const i = t.$proxies || (t.$proxies = {}),
        n = i[e];
      if (!n) return;
      (({ attach: jc, detach: jc, resize: jc })[e] || o1)(t, e, n), (i[e] = void 0);
    }
    getDevicePixelRatio() {
  ...
  function Y_(s) {
    return !e_() || (typeof OffscreenCanvas < 'u' && s instanceof OffscreenCanvas) ? H_ : j_;
  }
  class p1 {
    constructor() {
      this._init = [];
  ...
  function g1(s, { plugins: t, localIds: e }, i, n) {
    ...
    for (const a of t) {
      const l = a.id,
        c = _1(i[l], n);
      c !== null && o.push({ plugin: a, options: m1(s.config, { plugin: a, local: e[l] }, c, r) });
    }
    return o;
  }
  ...
  function Kc(s, t) {
    return s === 'x' || s === 'y' ? s : t.axis || y1(t.position) || s.charAt(0).toLowerCase();
  }
  function T1(s, t) {
    ...
    return (
      Object.keys(i).forEach((a) => {
        const l = i[a];
        if (!V(l)) return console.error(`Invalid scale configuration for scale: ${a}`);
        if (l._proxy) return console.warn(`Ignoring resolver passed as options for scale: ${a}`);
        const c = Kc(a, l),
          h = v1(c, n),
          d = e.scales || {};
        (o[c] = o[c] || a), (r[a] = Sn(Object.create(null), [{ axis: c }, l, d[c], d[h]]));
      }),
      s.data.datasets.forEach((a) => {
        ...
        Object.keys(d).forEach((u) => {
          const p = b1(u, c),
            f = a[p + 'AxisID'] || o[p] || p;
          (r[f] = r[f] || Object.create(null)), Sn(r[f], [{ axis: p }, i[f], d[u]]);
        });
      }),
  ...
  class x1 {
    ...
    datasetElementScopeKeys(t, e) {
      return aa(`${t}-${e}`, () => [[`datasets.${t}.elements.${e}`, `datasets.${t}`, `elements.${e}`, '']]);
    }
    pluginScopeKeys(t) {
      const e = t.id,
        i = this.type;
      return aa(`${i}-plugin-${e}`, () => [[`plugins.${e}`, ...(t.additionalOptionScopes || [])]]);
    }
    _cachedScopes(t, e) {
    ...
    getOptionScopes(t, e, i) {
      ...
      const l = new Set();
      e.forEach((h) => {
        t && (l.add(t), h.forEach((d) => Jn(l, t, d))), h.forEach((d) => Jn(l, n, d)), h.forEach((d) => Jn(l, Di[o] || {}, d)), h.forEach((d) => Jn(l, F, d)), h.forEach((d) => Jn(l, kc, d));
      });
      const c = Array.from(l);
      return c.length === 0 && c.push(Object.create(null)), G_.has(e) && r.set(e, c), c;
    }
    chartOptionScopes() {
  ...
  function q_(s, t, e) {
    ...
    const n = e.join();
    let o = i.get(n);
    return o || ((o = { resolver: Dc(t, e), subPrefixes: e.filter((a) => !a.toLowerCase().includes('hover')) }), i.set(n, o)), o;
  }
  const C1 = (s) => V(s) && Object.getOwnPropertyNames(s).reduce((t, e) => t || ei(s[e]), !1);
  function A1(s, t) {
  ...
  function tg(s) {
    return e_() && typeof s == 'string' ? (s = document.getElementById(s)) : s && s.length && (s = s[0]), s && s.canvas && (s = s.canvas), s;
  }
  const la = {},
    eg = (s) => {
      const t = tg(s);
  ...
  class Uc {
    constructor(t, e) {
      ...
      (this.platform = new (i.platform || Y_(n))()), this.platform.updateConfig(i);
      ...
      xe.listen(this, 'complete', J_), xe.listen(this, 'progress', S1), this._initialize(), this.attached && this.update();
    }
    get aspectRatio() {
      const {
    ...
    _initialize() {
      return this.notifyPlugins('beforeInit'), this.options.responsive ? this.resize() : i_(this, this.options.devicePixelRatio), this.bindEvents(), this.notifyPlugins('afterInit'), this;
    }
    clear() {
    ...
    _resize(t, e) {
      ...
      (this.width = r.width),
        ...
        (this._aspectRatio = this.aspectRatio),
        i_(this, a, !0) && (this.notifyPlugins('resize', { size: r }), G(i.onResize, [this, r], this), this.attached && this._doResize(l) && this.render());
    }
    ensureScalesHaveIDs() {
      ...
      e &&
        ...
        U(o, (r) => {
          const a = r.options,
            ...
            c = Kc(l, a),
            h = B(a.type, r.dtype);
          (a.position === void 0 || Z_(a.position, c) !== Z_(r.dposition)) && (a.position = r.dposition), (n[l] = !0);
          let d = null;
    ...
    buildOrUpdateControllers() {
      ...
      for (this._removeUnreferencedMetasets(), i = 0, n = e.length; i < n; i++) {
        ...
        if (
          ...
          Object.assign(l.prototype, { dataElementType: ne.getElement(h), datasetElementType: c && ne.getElement(c) }), (r.controller = new l(this, i)), t.push(r.controller);
        }
      }
    ...
    _checkEventBindings() {
      const t = this.options,
        ...
        i = new Set(t.events);
      (!vf(e, i) || !!this._responsiveListeners !== t.responsive) && (this.unbindEvents(), this.bindEvents());
    }
    ...
    _updateDatasets(t) {
      if (this.notifyPlugins('beforeDatasetsUpdate', { mode: t, cancelable: !0 }) !== !1) {
        ...
        for (let e = 0, i = this.data.datasets.length; e < i; ++e) this._updateDataset(e, ei(t) ? t({ datasetIndex: e }) : t);
    ...
    render() {
      this.notifyPlugins('beforeRender', { cancelable: !0 }) !== !1 && (xe.has(this) ? this.attached && !xe.running(this) && xe.start(this) : (this.draw(), J_({ chart: this })));
    }
    draw() {
      let t;
    ...
    _drawDataset(t) {
      ...
      this.notifyPlugins('beforeDatasetDraw', r) !== !1 &&
        (n && qr(e, { left: i.left === !1 ? 0 : o.left - i.left, right: i.right === !1 ? this.width : o.right + i.right, top: i.top === !1 ? 0 : o.top - i.top, bottom: i.bottom === !1 ? this.height : o.bottom + i.bottom }),
        t.controller.draw(),
        n && Zr(e),
        (r.cancelable = !1),
    ...
    _updateVisibility(t, e, i) {
      ...
      jt(e) ? ((o.data[e].hidden = !i), this.update()) : (this.setDatasetVisibility(t, i), r.update(o, { visible: i }), this.update((a) => (a.datasetIndex === t ? n : void 0)));
    }
    hide(t, e) {
    ...
    destroy() {
      ...
      this._stop(),
        ...
        t && (this.unbindEvents(), jf(t, e), this.platform.releaseContext(e), (this.canvas = null), (this.ctx = null)),
    ...
    setActiveElements(t) {
      ...
      !Fr(i, e) && ((this._active = i), (this._lastEvent = null), this._updateHoverStyles(i, e));
    }
    notifyPlugins(t, e, i) {
    ...
    _handleEvent(t, e, i) {
      ...
      i && ((this._lastEvent = null), G(o.onHover, [t, a, this], this), l && G(o.onClick, [t, a, this], this));
      const h = !Fr(a, n);
  ...
  function sg(s, t, e) {
    ...
    let c = n / a;
    s.beginPath(), s.arc(o, r, a, i - c, e + c), l > n ? ((c = n / l), s.arc(o, r, l, e + c, i - c, !0)) : s.arc(o, r, n, e + nt, i - nt), s.closePath(), s.clip();
  }
  function D1(s) {
  ...
  function M1(s, t, e, i) {
    ...
    return { outerStart: a(n.outerStart), outerEnd: a(n.outerEnd), innerStart: dt(n.innerStart, 0, r), innerEnd: dt(n.innerEnd, 0, r) };
  }
  function Is(s, t, e, i) {
  ...
  function Xc(s, t, e, i, n, o) {
    ...
    const b = Math.max(0.001, f * d - e / it) / d,
      ...
      y = l + v + p,
      T = n - v - p,
      { outerStart: x, outerEnd: E, innerStart: C, innerEnd: A } = M1(t, u, d, T - y),
      w = d - x,
      S = d - E,
      k = y + x / w,
      D = T - E / S,
  ...
  function $1(s, t, e) {
    const { x: i, y: n, startAngle: o, pixelMargin: r, fullCircles: a } = t,
      ...
      c = t.innerRadius + r;
    let h;
    for (e && sg(s, t, o + q), s.beginPath(), s.arc(i, n, c, o + q, o, !0), h = 0; h < a; ++h) s.stroke();
  ...
  function R1(s, t, e, i, n, o) {
    ...
    a && (c ? ((s.lineWidth = a * 2), (s.lineJoin = l || 'round')) : ((s.lineWidth = a), (s.lineJoin = l || 'bevel')), t.fullCircles && $1(s, t, c), c && sg(s, t, n), Xc(s, t, e, i, n, o), s.stroke());
  }
  class Ds extends Xt {
    constructor(t) {
      super(),
    ...
    inRange(t, e, i) {
      const n = this.getProps(['x', 'y'], i),
        ...
        { startAngle: a, endAngle: l, innerRadius: c, outerRadius: h, circumference: d } = this.getProps(['startAngle', 'endAngle', 'innerRadius', 'outerRadius', 'circumference'], i),
    ...
    getCenterPoint(t) {
      const { x: e, y: i, startAngle: n, endAngle: o, innerRadius: r, outerRadius: a } = this.getProps(['x', 'y', 'startAngle', 'endAngle', 'innerRadius', 'outerRadius', 'circumference'], t),
    ...
    draw(t) {
      const { options: e, circumference: i } = this,
        ...
        o = (e.spacing || 0) / 2,
        r = e.circular;
      if (((this.pixelMargin = e.borderAlign === 'inner' ? 0.33 : 0), (this.fullCircles = i > q ? Math.floor(i / q) : 0), i === 0 || this.innerRadius < 0 || this.outerRadius < 0)) return;
      t.save();
      let a = 0;
      if (n) {
        a = n / 2;
        const c = (this.startAngle + this.endAngle) / 2;
        t.translate(Math.cos(c) * a, Math.sin(c) * a), this.circumference >= it && (a = n);
      }
  ...
  (Ds.id = 'arc'),
    (Ds.defaults = { borderAlign: 'center', borderColor: '#fff', borderJoinStyle: void 0, borderRadius: 0, borderWidth: 2, offset: 0, spacing: 0, angle: void 0, circular: !0 }),
  ...
  function N1(s) {
    return s.stepped ? dI : s.tension || s.cubicInterpolationMode === 'monotone' ? uI : P1;
  }
  function og(s, t, e = {}) {
    const i = s.length,
  ...
  function B1(s, t, e, i) {
    ...
    let { move: d = !0, reverse: u } = i || {},
      ...
      f,
      b;
    for (p = 0; p <= c; ++p) (f = n[(a + (u ? c - p : p)) % r]), !f.skip && (d ? (s.moveTo(f.x, f.y), (d = !1)) : h(s, b, f, u, o.stepped), (b = f));
  ...
  function H1(s, t, e, i) {
    ...
    for (l && ((p = n[T(0)]), s.moveTo(p.x, p.y)), u = 0; u <= a; ++u) {
      ...
      const E = p.x,
        C = p.y,
        A = E | 0;
      A === f ? (C < b ? (b = C) : C > v && (v = C), (h = (d * h + E) / ++d)) : (x(), s.lineTo(E, C), (f = A), (d = 0), (b = v = C)), (y = C);
    }
    x();
  }
  function Gc(s) {
    ...
    return !s._decimated && !s._loop && !t.tension && t.cubicInterpolationMode !== 'monotone' && !t.stepped && !e ? H1 : B1;
  }
  function V1(s) {
    return s.stepped ? zI : s.tension || s.cubicInterpolationMode === 'monotone' ? jI : Ni;
  }
  function F1(s, t, e, i) {
    let n = t._path;
    n || ((n = t._path = new Path2D()), t.path(n, e, i) && n.closePath()), ng(s, t.options), s.stroke(n);
  }
  function W1(s, t, e, i) {
    const { segments: n, options: o } = t,
      r = Gc(t);
    for (const a of n) ng(s, o, a.style), s.beginPath(), r(s, t, a, { start: e, end: e + i - 1 }) && s.closePath(), s.stroke();
  }
  ...
  class Le extends Xt {
    ...
    draw(t, e, i, n) {
      ...
      (this.points || []).length && o.borderWidth && (t.save(), j1(t, this, i, n), t.restore()), this.animated && ((this._pointsUpdated = !1), (this._path = void 0));
    }
  }
  (Le.id = 'line'),
    (Le.defaults = { borderCapStyle: 'butt', borderDash: [], borderDashOffset: 0, borderJoinStyle: 'miter', borderWidth: 3, capBezierPoints: !0, cubicInterpolationMode: 'default', fill: !1, spanGaps: !1, stepped: !1, tension: 0 }),
    (Le.defaultRoutes = { backgroundColor: 'backgroundColor', borderColor: 'borderColor' }),
    (Le.descriptors = { _scriptable: !0, _indexable: (s) => s !== 'borderDash' && s !== 'fill' });
  function rg(s, t, e, i) {
    const n = s.options,
      { [e]: o } = s.getProps([e], i);
  ...
  class Ms extends Xt {
    ...
    draw(t, e) {
      const i = this.options;
      this.skip || i.radius < 0.1 || !Pn(this, e, this.size(i) / 2) || ((t.strokeStyle = i.borderColor), (t.lineWidth = i.borderWidth), (t.fillStyle = i.backgroundColor), Oc(t, i, this.x, this.y));
    }
    getRange() {
      const t = this.options || {};
  ...
  (Ms.id = 'point'),
    (Ms.defaults = { borderWidth: 1, hitRadius: 1, hoverBorderWidth: 1, hoverRadius: 4, pointStyle: 'circle', radius: 3, rotation: 0 }),
    (Ms.defaultRoutes = { backgroundColor: 'backgroundColor', borderColor: 'borderColor' });
  function ag(s, t) {
    const { x: e, y: i, base: n, width: o, height: r } = s.getProps(['x', 'y', 'base', 'width', 'height'], t);
    let a, l, c, h, d;
    return s.horizontal ? ((d = r / 2), (a = Math.min(e, n)), (l = Math.max(e, n)), (c = i - d), (h = i + d)) : ((d = o / 2), (a = e - d), (l = e + d), (c = Math.min(i, n)), (h = Math.max(i, n))), { left: a, top: c, right: l, bottom: h };
  }
  function ai(s, t, e, i) {
    return s ? 0 : dt(t, e, i);
  }
  function Y1(s, t, e) {
    const i = s.options.borderWidth,
      n = s.borderSkipped,
      o = Kf(i);
    return { t: ai(n.top, o.top, 0, e), r: ai(n.right, o.right, 0, t), b: ai(n.bottom, o.bottom, 0, e), l: ai(n.left, o.left, 0, t) };
  }
  function K1(s, t, e) {
  ...
  class Ls extends Xt {
    ...
    draw(t) {
      const {
        ...
        a = X1(r.radius) ? Nn : G1;
      t.save(), (r.w !== o.w || r.h !== o.h) && (t.beginPath(), a(t, Zc(r, e, o)), t.clip(), a(t, Zc(o, -e, r)), (t.fillStyle = i), t.fill('evenodd')), t.beginPath(), a(t, Zc(o, e)), (t.fillStyle = n), t.fill(), t.restore();
    }
    inRange(t, e, i) {
  ...
  (Ls.id = 'bar'), (Ls.defaults = { borderSkipped: 'start', borderWidth: 0, borderRadius: 0, inflateAmount: 'auto', pointStyle: void 0 }), (Ls.defaultRoutes = { backgroundColor: 'backgroundColor', borderColor: 'borderColor' });
  var lg = Object.freeze({ __proto__: null, ArcElement: Ds, LineElement: Le, PointElement: Ms, BarElement: Ls });
  function q1(s, t, e, i, n) {
    ...
    for (r[l++] = s[h], d = 0; d < o - 2; d++) {
      ...
      const A = Math.floor(d * a) + 1 + t,
        ...
        { x: S, y: k } = s[h];
      for (p = f = -1, T = A; T < w; T++) (f = 0.5 * Math.abs((S - v) * (s[T].y - k) - (S - s[T].x) * (y - k))), f > p && ((p = f), (u = s[T]), (b = T));
      (r[l++] = u), (h = b);
    }
    return (r[l++] = s[c]), r;
  }
      ...
      if (C === h) c < f ? ((f = c), (d = r)) : c > b && ((b = c), (u = r)), (n = (o * n + a.x) / ++o);
        ...
        if (!H(d) && !H(u)) {
          const w = Math.min(d, u),
            S = Math.max(d, u);
          w !== p && w !== A && v.push({ ...s[w], x: n }), S !== p && S !== A && v.push({ ...s[S], x: n });
        }
        r > 0 && A !== p && v.push(s[A]), v.push(a), (h = C), (o = 0), (f = b = c), (d = u = p = r);
      }
    }
    return v;
  }
  ...
  function Q1(s, t) {
    ...
    return l && (i = dt(De(t, o.axis, r).lo, 0, e - 1)), c ? (n = dt(De(t, o.axis, a).hi + 1, i, e) - i) : (n = e - i), { start: i, count: n };
  }
  var dg = {
    id: 'decimation',
    ...
    beforeElementsUpdate: (s, t, e) => {
      ...
      s.data.datasets.forEach((n, o) => {
        const { _data: r, indexAxis: a } = n,
          ...
          c = r || n.data;
        if (tt([a, s.options.indexAxis]) === 'y' || !l.controller.supportsDecimation) return;
    ...
    for (const a of i) {
      ...
      for (const u of d) {
        const p = Qc(e, o[u.start], o[u.end], u.loop),
          f = c_(a, n, p);
        for (const b of f) r.push({ source: b, target: u, start: { [e]: ug(h, p, 'start', Math.max) }, end: { [e]: ug(h, p, 'end', Math.min) } });
      }
    }
    return r;
  }
  function Qc(s, t, e, i) {
    ...
    let n = t[s],
      o = e[s];
    return s === 'angle' && ((n = Vt(n)), (o = Vt(o))), { property: s, start: n, end: o };
  }
  function tM(s, t) {
  ...
  function pg(s, t) {
    let e = [],
      i = !1;
    return Q(s) ? ((i = !0), (e = s)) : (e = tM(s, t)), e.length ? new Le({ points: e, options: { tension: 0 }, _loop: i, _fullLoop: i }) : null;
  }
  function fg(s) {
    return s && s.fill !== !1;
  }
  ...
  function iM(s, t, e) {
    ...
    let n = parseFloat(i);
    return rt(n) && Math.floor(n) === n ? sM(i[0], t, n, e) : ['origin', 'start', 'end', 'stack', 'shape'].indexOf(i) >= 0 && i;
  }
  function sM(s, t, e, i) {
  ...
  function nM(s, t) {
    let e = null;
    return s === 'start' ? (e = t.bottom) : s === 'end' ? (e = t.top) : V(s) ? (e = t.getPixelForValue(s.value)) : t.getBasePixel && (e = t.getBasePixel()), e;
  }
  function oM(s, t, e) {
    let i;
    return s === 'start' ? (i = e) : s === 'end' ? (i = t.options.reverse ? t.min : t.max) : V(s) ? (i = s.value) : (i = t.getBaseValue()), i;
  }
  function rM(s) {
    const t = s.options,
      e = t.fill;
  ...
  class _g {
    ...
    pathSegment(t, e, i) {
      ...
      return (e = e || { start: 0, end: q }), t.arc(n, o, r, e.end, e.start, !0), !i.bounds;
    }
    interpolate(t) {
  ...
  function _M(s) {
    ...
    if (i.grid.circular) {
      ...
      return new _g({ x: l.x, y: l.y, radius: t.getDistanceFromCenterForValue(r) });
    }
  ...
  function th(s, t, e) {
    ...
    i && n.points.length && (qr(s, e), gM(s, { line: n, target: i, above: h, below: d, area: e, scale: o, axis: r }), Zr(s));
  }
  function gM(s, t) {
    const { line: e, target: i, above: n, below: o, area: r, scale: a } = t,
      l = e._loop ? 'angle' : t.axis;
    s.save(), l === 'x' && o !== n && (gg(s, i, r.top), mg(s, { line: e, target: i, color: n, scale: a, property: l }), s.restore(), s.save(), gg(s, i, r.bottom)), mg(s, { line: e, target: i, color: o, scale: a, property: l }), s.restore();
  }
  function gg(s, t, e) {
    ...
    for (const a of i) {
      const { start: l, end: c } = a,
        h = n[l],
        d = n[Jc(l, c, n)];
      o ? (s.moveTo(h.x, h.y), (o = !1)) : (s.lineTo(h.x, e), s.lineTo(h.x, h.y)), (r = !!t.pathSegment(s, a, { move: r })), r ? s.closePath() : s.lineTo(d.x, e);
    }
    ...
    afterDatasetsUpdate(s, t, e) {
      ...
      for (r = 0; r < i; ++r)
        (o = s.getDatasetMeta(r)),
          (a = o.dataset),
          (l = null),
          a && a.options && a instanceof Le && (l = { visible: s.isDatasetVisible(r), index: r, fill: iM(a, r, i), chart: s, axis: o.controller.options.indexAxis, scale: o.vScale, line: a }),
          (o.$filler = l),
          n.push(l);
      for (r = 0; r < i; ++r) (l = n[r]), !(!l || l.fill === !1) && (l.fill = eM(n, r, e.propagate));
    },
    beforeDraw(s, t, e) {
      ...
      for (let r = n.length - 1; r >= 0; --r) {
        const a = n[r].$filler;
        a && (a.line.updateControlPoints(o, a.axis), i && a.fill && th(s.ctx, a, o));
      }
    },
  ...
  const yg = (s, t) => {
      ...
      return s.usePointStyle && ((e = Math.min(e, t)), (i = s.pointStyleWidth || Math.min(i, t))), { boxWidth: i, boxHeight: e, itemHeight: Math.max(t, e) };
    },
    bM = (s, t) => s !== null && t !== null && s.datasetIndex === t.datasetIndex && s.index === t.index;
  class Tg extends Xt {
    constructor(t) {
      super(),
        (this._added = !1),
    ...
    fit() {
      ...
      let c, h;
      (e.font = n.string),
        this.isHorizontal() ? ((c = this.maxWidth), (h = this._fitRows(r, o, a, l) + 10)) : ((h = this.maxHeight), (c = this._fitCols(r, o, a, l) + 10)),
    ...
    _fitRows(t, e, i, n) {
      ...
      return (
        this.legendItems.forEach((f, b) => {
          ...
          (b === 0 || c[c.length - 1] + v + 2 * a > r) && ((d += h), (c[c.length - (b > 0 ? 0 : 1)] = 0), (p += h), u++), (l[b] = { left: 0, top: p, row: u, width: v, height: n }), (c[c.length - 1] += v + a);
        }),
        d
      );
    }
    _fitCols(t, e, i, n) {
      ...
      return (
        this.legendItems.forEach((v, y) => {
          ...
          y > 0 && p + n + 2 * a > h && ((d += u + a), c.push({ width: u, height: p }), (f += u + a), b++, (u = p = 0)), (l[y] = { left: f, top: p, col: b, width: T, height: n }), (u = Math.max(u, T)), (p += n + a);
        }),
        (d += u),
    ...
    adjustHitBoxes() {
      ...
      if (this.isHorizontal()) {
        ...
        for (const c of e) a !== c.row && ((a = c.row), (l = gt(i, this.left + n, this.right - this.lineWidths[a]))), (c.top += this.top + t + n), (c.left = r.leftForLtr(r.x(l), c.width)), (l += c.width + n);
      } else {
        let a = 0,
          l = gt(i, this.top + t + n, this.bottom - this.columnSizes[a].height);
        for (const c of e) c.col !== a && ((a = c.col), (l = gt(i, this.top + t + n, this.bottom - this.columnSizes[a].height))), (c.top = l), (c.left += this.left + n), (c.left = r.leftForLtr(r.x(c.left), c.width)), (l += c.height + n);
      }
    }
    isHorizontal() {
    ...
    _draw() {
      ...
      const { boxWidth: b, boxHeight: v, itemHeight: y } = yg(r, u),
        T = function (w, S, k) {
          ...
          if (
            ...
            const I = { radius: (v * Math.SQRT2) / 2, pointStyle: k.pointStyle, rotation: k.rotation, borderWidth: D },
              M = l.xPlus(w, b / 2),
              P = S + p;
            ...
            const I = S + Math.max((u - v) / 2, 0),
              M = l.leftForLtr(w, b),
              P = $i(k.borderRadius);
            n.beginPath(), Object.values(P).some((X) => X !== 0) ? Nn(n, { x: M, y: I, w: b, h: v, radius: P }) : n.rect(M, I, b, v), n.fill(), D !== 0 && n.stroke();
          }
          n.restore();
        },
        x = function (w, S, k) {
          Li(n, k.text, w, S + y / 2, c, { strikethrough: k.hidden, textAlign: l.textAlign(k.textAlign) });
        },
        E = this.isHorizontal(),
        C = this._computeTitleHeight();
      E ? (f = { x: gt(o, this.left + d, this.right - i[0]), y: this.top + d + C, line: 0 }) : (f = { x: this.left + d, y: gt(o, this.top + C + d, this.bottom - e[0].height), line: 0 }), o_(this.ctx, t.textDirection);
      const A = y + d;
      this.legendItems.forEach((w, S) => {
        ...
        l.setWidth(this.width),
          E
            ? S > 0 && M + I + d > this.right && ((P = f.y += A), f.line++, (M = f.x = gt(o, this.left + d, this.right - i[f.line])))
            : S > 0 && P + A > this.bottom && ((M = f.x = M + e[f.line].width + d), f.line++, (P = f.y = gt(o, this.top + C + d, this.bottom - e[f.line].height)));
        const X = l.x(M);
        T(X, P, w), (M = HO(D, M + b + p, E ? M + I : this.right, t.rtl)), x(l.x(M), P, w), E ? (f.x += I + d) : (f.y += A);
      }),
    ...
    drawTitle() {
      ...
      if (this.isHorizontal()) (u = Math.max(...this.lineWidths)), (h = this.top + c), (d = gt(t.align, d, this.right - u));
        ...
        h = c + gt(t.align, this.top, this.bottom - f - t.labels.padding - this._computeTitleHeight());
      }
      const p = gt(a, d, d + u);
      (r.textAlign = o.textAlign(yc(a))), (r.textBaseline = 'middle'), (r.strokeStyle = e.color), (r.fillStyle = e.color), (r.font = i.string), Li(r, e.text, p, h, i);
    }
    _computeTitleHeight() {
    ...
    _getLegendItemAt(t, e) {
      ...
      if (Ie(t, this.left, this.right) && Ie(e, this.top, this.bottom)) {
        for (o = this.legendHitBoxes, i = 0; i < o.length; ++i) if (((n = o[i]), Ie(t, n.left, n.left + n.width) && Ie(e, n.top, n.top + n.height))) return this.legendItems[i];
      }
      return null;
    }
    handleEvent(t) {
      ...
      if (t.type === 'mousemove' || t.type === 'mouseout') {
        const n = this._hoveredItem,
          o = bM(n, i);
        n && !o && G(e.onLeave, [t, n, this], this), (this._hoveredItem = i), i && !o && G(e.onHover, [t, i, this], this);
  ...
  class eh extends Xt {
    ...
    _drawArgs(t) {
      ...
      let l = 0,
        ...
        d;
      return (
        this.isHorizontal() ? ((h = gt(a, i, o)), (d = e + t), (c = o - i)) : (r.position === 'left' ? ((h = i + t), (d = gt(a, n, e)), (l = it * -0.5)) : ((h = o - t), (d = gt(a, e, n)), (l = it * 0.5)), (c = n - e)),
    ...
    draw() {
      ...
      Li(t, e.text, 0, 0, i, { color: e.color, maxWidth: l, rotation: c, textAlign: yc(e.align), textBaseline: 'middle', translation: [r, a] });
    }
  }
  function yM(s, t) {
...
`)
  ...
  function TM(s, t) {
    ...
    return { chart: s, label: r, parsed: o.getParsed(n), raw: s.data.datasets[i].data[n], formattedValue: a, dataset: o.getDataset(), dataIndex: n, datasetIndex: i, element: e };
  }
  function Ag(s, t) {
    const e = s.chart.ctx,
    ...
    let b = f.height,
      v = 0,
      y = i.reduce((E, C) => E + C.before.length + C.lines.length + C.after.length, 0);
    if (((y += s.beforeBody.length + s.afterBody.length), d && (b += d * c.lineHeight + (d - 1) * t.titleSpacing + t.titleMarginBottom), y)) {
  ...
  function CM(s, t, e, i) {
    ...
    let c = 'center';
    return i === 'center' ? (c = n <= (a + l) / 2 ? 'left' : 'right') : n <= o / 2 ? (c = 'left') : n >= r - o / 2 && (c = 'right'), xM(c, s, t, e) && (c = 'center'), c;
  }
  function wg(s, t, e) {
  ...
  function kg(s, t, e, i) {
    ...
    let f = AM(t, a);
    const b = wM(t, l, c);
    return l === 'center' ? (a === 'left' ? (f += c) : a === 'right' && (f -= c)) : a === 'left' ? (f -= Math.max(h, u) + n) : a === 'right' && (f += Math.max(d, p) + n), { x: dt(f, 0, i.width - t.width), y: dt(b, 0, i.height - t.height) };
  }
  function ha(s, t, e) {
  ...
  class ih extends Xt {
    ...
    getContext() {
      return this.$context || (this.$context = kM(this.chart.getContext(), this, this._tooltipItems));
    }
    getTitle(t, e) {
      const { callbacks: i } = e,
      ...
      return (
        U(t, (o) => {
          const r = { before: [], lines: [], after: [] },
            a = Og(i, o);
          Ce(r.before, $e(a.beforeLabel.call(this, o))), Ce(r.lines, a.label.call(this, o)), Ce(r.after, $e(a.afterLabel.call(this, o))), n.push(r);
        }),
        n
      );
    }
    ...
    update(t, e) {
      ...
      if (!n.length) this.opacity !== 0 && (o = { opacity: 0 });
        ...
        (this.xAlign = h.xAlign), (this.yAlign = h.yAlign), (o = { opacity: 1, x: d.x, y: d.y, width: l.width, height: l.height, caretX: a.x, caretY: a.y });
      }
      (this._tooltipItems = r), (this.$context = void 0), o && this._resolveAnimations().update(this, o), t && i.external && i.external.call(this, { chart: this.chart, tooltip: this, replay: e });
    }
    drawCaret(t, e, i, n) {
    ...
    getCaretPosition(t, e, i) {
      ...
      return (
        o === 'center'
          ? ((E = p + b / 2), n === 'left' ? ((v = u), (y = v - r), (x = E + r), (C = E - r)) : ((v = u + f), (y = v + r), (x = E - r), (C = E + r)), (T = v))
          : (n === 'left' ? (y = u + Math.max(l, h) + r) : n === 'right' ? (y = u + f - Math.max(c, d) - r) : (y = this.caretX),
            o === 'top' ? ((x = p), (E = x - r), (v = y - r), (T = y + r)) : ((x = p + b), (E = x + r), (v = y + r), (T = y - r)),
            (C = x)),
    ...
    drawTitle(t, e, i) {
      ...
      if (o) {
        ...
        for (t.x = ha(this, i.titleAlign, i), e.textAlign = c.textAlign(i.titleAlign), e.textBaseline = 'middle', r = lt(i.titleFont), a = i.titleSpacing, e.fillStyle = i.titleColor, e.font = r.string, l = 0; l < o; ++l)
    ...
    _drawColorBox(t, e, i, n, o) {
      ...
      if (o.usePointStyle) {
        const v = { radius: Math.min(c, l) / 2, pointStyle: a.pointStyle, rotation: a.rotation, borderWidth: 1 },
          ...
          T = b + l / 2;
        (t.strokeStyle = o.multiKeyBackground), (t.fillStyle = o.multiKeyBackground), Oc(t, v, y, T), (t.strokeStyle = r.borderColor), (t.fillStyle = r.backgroundColor), Oc(t, v, y, T);
      } else {
        ...
        Object.values(T).some((x) => x !== 0)
          ? (t.beginPath(),
            ...
            t.fill())
          : ((t.fillStyle = o.multiKeyBackground), t.fillRect(v, b, c, l), t.strokeRect(v, b, c, l), (t.fillStyle = r.backgroundColor), t.fillRect(y, b + 1, c - 2, l - 2));
      }
    ...
    drawBody(t, e, i) {
      ...
      let y, T, x, E, C, A, w;
      for (
        e.textAlign = r, e.textBaseline = 'middle', e.font = d.string, t.x = ha(this, v, i), e.fillStyle = i.bodyColor, U(this.beforeBody, b), p = a && v !== 'right' ? (r === 'center' ? c / 2 + h : c + 2 + h) : 0, E = 0, A = n.length;
        E < A;
        ++E
      ) {
        for (y = n[E], T = this.labelTextColors[E], e.fillStyle = T, U(y.before, b), x = y.lines, a && x.length && (this._drawColorBox(e, t, E, f, i), (u = Math.max(d.lineHeight, l))), C = 0, w = x.length; C < w; ++C)
    ...
    drawFooter(t, e, i) {
      ...
      if (o) {
        ...
        for (t.x = ha(this, i.footerAlign, i), t.y += i.footerMarginTop, e.textAlign = l.textAlign(i.footerAlign), e.textBaseline = 'middle', r = lt(i.footerFont), e.fillStyle = i.footerColor, e.font = r.string, a = 0; a < o; ++a)
    ...
    drawBackground(t, e, i, n) {
      const { xAlign: o, yAlign: r } = this,
        { x: a, y: l } = t,
        { width: c, height: h } = i,
        { topLeft: d, topRight: u, bottomLeft: p, bottomRight: f } = $i(n.cornerRadius);
    ...
    draw(t) {
      ...
      e.enabled &&
        a &&
        (t.save(), (t.globalAlpha = i), this.drawBackground(o, t, n, e), o_(t, e.textDirection), (o.y += r.top), this.drawTitle(o, t, e), this.drawBody(o, t, e), this.drawFooter(o, t, e), r_(t, e.textDirection), t.restore());
    }
    getActiveElements() {
      return this._active || [];
    }
  ...
  var Ig = {
      ...
      descriptors: { _scriptable: (s) => s !== 'filter' && s !== 'itemSort' && s !== 'external', _indexable: !1, callbacks: { _scriptable: !1, _indexable: !1 }, animation: { _fallback: !1 }, animations: { _fallback: 'animation' } },
      additionalOptionScopes: ['interaction'],
    },
    Dg = Object.freeze({ __proto__: null, Decimation: dg, Filler: vg, Legend: Eg, SubTitle: Cg, Title: xg, Tooltip: Ig });
  const SM = (s, t, e, i) => (typeof t == 'string' ? ((e = s.push(t) - 1), i.unshift({ index: e, label: t })) : isNaN(t) && (e = null), e);
  function OM(s, t, e, i) {
    const n = s.indexOf(t);
  ...
  class eo extends oi {
    ...
    parse(t, e) {
      if (H(t)) return null;
      const i = this.getLabels();
      return (e = isFinite(e) && i[e] === t ? e : OM(i, t, B(e, t), this._addedLabels)), IM(e, i.length - 1);
    }
    determineDataLimits() {
  ...
  (eo.id = 'category'), (eo.defaults = { ticks: { callback: eo.prototype.getLabelForValue } });
  function DM(s, t) {
    const e = [],
      { bounds: n, step: o, min: r, max: a, precision: l, count: c, maxTicks: h, maxDigits: d, includeBounds: u } = s,
      p = o || 1,
      f = h - 1,
      { min: b, max: v } = t,
      y = !H(r),
    ...
    (k = Math.ceil(v / C) - Math.floor(b / C)),
      ...
      n === 'ticks' ? ((w = Math.floor(b / C) * C), (S = Math.ceil(v / C) * C)) : ((w = b), (S = v)),
      y && T && o && MO((a - r) / o, C / 1e3)
        ? ((k = Math.round(Math.min((a - r) / C, h))), (C = (a - r) / k), (w = r), (S = a))
        : x
          ? ((w = y ? r : w), (S = T ? a : S), (k = c - 1), (C = (S - w) / k))
          : ((k = (S - w) / C), In(k, Math.round(k), C / 1e3) ? (k = Math.round(k)) : (k = Math.ceil(k)));
    const D = Math.max(xf(C), xf(w));
    (A = Math.pow(10, H(l) ? D : l)), (w = Math.round(w * A) / A), (S = Math.round(S * A) / A);
    let I = 0;
    for (y && (u && w !== r ? (e.push({ value: r }), w < r && I++, In(Math.round((w + I * C) * A) / A, r, Mg(r, E, s)) && I++) : w < r && I++); I < k; ++I) e.push({ value: Math.round((w + I * C) * A) / A });
    return T && u && S !== a ? (e.length && In(e[e.length - 1].value, a, Mg(a, E, s)) ? (e[e.length - 1].value = a) : e.push({ value: a })) : (!T || S === a) && e.push({ value: S }), e;
  }
  ...
  class da extends oi {
    ...
    getTickLimit() {
      ...
      return (
        i
          ? ((n = Math.ceil(this.max / i) - Math.floor(this.min / i) + 1), n > 1e3 && (console.warn(`scales.${this.id}.ticks.stepSize: ${i} would result generating up to ${n} ticks. Limiting to 1000.`), (n = 1e3)))
    ...
    buildTicks() {
      ...
      const n = {
        ...
        o = this._range || this,
        r = DM(n, o);
      return t.bounds === 'ticks' && Ef(r, this, 'value'), t.reverse ? (r.reverse(), (this.start = this.max), (this.end = this.min)) : ((this.start = this.min), (this.end = this.max)), r;
    }
    configure() {
      const t = this.ticks;
      let e = this.min,
  ...
  (ua.id = 'linear'), (ua.defaults = { ticks: { callback: Yn.formatters.numeric } });
  function Lg(s) {
  ...
  function MM(s, t) {
    ...
    do n.push({ value: o, major: Lg(o) }), ++a, a === 10 && ((a = 1), ++r, (l = r >= 0 ? 1 : l)), (o = Math.round(a * Math.pow(10, r) * l) / l);
    while (r < e || (r === e && a < i));
    const c = zt(s.max, o);
  ...
  class pa extends oi {
    ...
    handleTickRangeOptions() {
      ...
      i === n && (i <= 0 ? (o(1), r(10)) : (o(a(i, -1)), r(a(n, 1)))), i <= 0 && o(a(n, -1)), n <= 0 && r(a(i, 1)), this._zero && this.min !== this._suggestedMin && i === a(this.min, 0) && o(a(i, -1)), (this.min = i), (this.max = n);
    }
    buildTicks() {
      const t = this.options,
        e = { min: this._userMin, max: this._userMax },
        i = MM(e, this);
      return t.bounds === 'ticks' && Ef(i, this, 'value'), t.reverse ? (i.reverse(), (this.start = this.max), (this.end = this.min)) : ((this.start = this.min), (this.end = this.max)), i;
    }
    getLabelForValue(t) {
      return t === void 0 ? '0' : Bn(t, this.chart.options.locale, this.options.ticks.format);
    }
    configure() {
      const t = this.min;
  ...
  (pa.id = 'logarithmic'), (pa.defaults = { ticks: { callback: Yn.formatters.logarithmic, major: { enabled: !0 } } });
  function sh(s) {
    const t = s.ticks;
  ...
  function LM(s, t, e) {
    return (e = Q(e) ? e : [e]), { w: hI(s, t.string, e), h: e.length * t.lineHeight };
  }
  function $g(s, t, e, i, n) {
    return s === i || s === n ? { start: t - e / 2, end: t + e / 2 } : s < i || s > n ? { start: t - e, end: t } : { start: t, end: t + e };
  }
  function $M(s) {
    const t = { l: s.left + s._padding.left, r: s.right - s._padding.right, t: s.top + s._padding.top, b: s.bottom - s._padding.bottom },
      e = Object.assign({}, t),
      i = [],
      n = [],
    ...
    s.setCenterPoint(t.l - e.l, e.r - t.r, t.t - e.t, e.b - t.b), (s._pointLabelItems = PM(s, i, n));
  }
  function RM(s, t, e, i, n) {
    ...
    let a = 0,
      l = 0;
    i.start < t.l ? ((a = (t.l - i.start) / o), (s.l = Math.min(s.l, t.l - a))) : i.end > t.r && ((a = (i.end - t.r) / o), (s.r = Math.max(s.r, t.r + a))),
      n.start < t.t ? ((l = (t.t - n.start) / r), (s.t = Math.min(s.t, t.t - l))) : n.end > t.b && ((l = (n.end - t.b) / r), (s.b = Math.max(s.b, t.b + l)));
  }
  function PM(s, t, e) {
    const i = [],
    ...
    for (let c = 0; c < n; c++) {
      const h = s.getPointPosition(c, a + r + e[c], l),
        ...
        f = NM(d),
        b = BM(h.x, u.w, f);
      i.push({ x: h.x, y: p, textAlign: f, left: b, top: p, right: b + u.w, bottom: p + u.h });
    }
    return i;
  }
  function NM(s) {
  ...
  function VM(s, t) {
    ...
    for (let n = t - 1; n >= 0; n--) {
      const o = i.setContext(s.getPointLabelContext(n)),
        r = lt(o.font),
        { x: a, y: l, textAlign: c, left: h, top: d, right: u, bottom: p } = s._pointLabelItems[n],
        { backdropColor: f } = o;
      if (!H(f)) {
        ...
        const y = h - v.left,
          ...
          x = u - h + v.width,
          E = p - d + v.height;
        Object.values(b).some((C) => C !== 0) ? (e.beginPath(), Nn(e, { x: y, y: T, w: x, h: E, radius: b }), e.fill()) : e.fillRect(y, T, x, E);
      }
      Li(e, s._pointLabels[n], a, l + r.lineHeight / 2, r, { color: o.color, textAlign: c, textBaseline: 'middle' });
    }
  }
  function Rg(s, t, e, i) {
    const { ctx: n } = s;
  ...
  function FM(s, t, e, i) {
    ...
    (!o && !i) || !r || !a || e < 0 || (n.save(), (n.strokeStyle = r), (n.lineWidth = a), n.setLineDash(t.borderDash), (n.lineDashOffset = t.borderDashOffset), n.beginPath(), Rg(s, e, o, i), n.closePath(), n.stroke(), n.restore());
  }
  function WM(s, t, e) {
  ...
  class $s extends da {
    ...
    fit() {
      const t = this.options;
      t.display && t.pointLabels.display ? $M(this) : this.setCenterPoint(0, 0, 0, 0);
    }
    ...
    drawBackground() {
      ...
      if (t) {
        const i = this.ctx;
        i.save(), i.beginPath(), Rg(this, this.getDistanceFromCenterForValue(this._endValue), e, this._pointLabels.length), i.closePath(), (i.fillStyle = t), i.fill(), i.restore();
      }
    }
    drawGrid() {
      const t = this.ctx,
  ...
  ($s.id = 'radialLinear'),
    ...
    ($s.defaultRoutes = { 'angleLines.color': 'borderColor', 'pointLabels.color': 'color', 'ticks.color': 'color' }),
  ...
  function Pg(s, t) {
    ...
    let r = t;
    return typeof i == 'function' && (r = i(r)), rt(r) || (r = typeof i == 'string' ? e.parse(r, i) : e.parse(r)), r === null ? null : (n && (r = n === 'week' && (As(o) || o === !0) ? e.startOf(r, 'isoWeek', o) : e.startOf(r, n)), +r);
  }
  function Ng(s, t, e, i) {
    const n = It.length;
  ...
  function YM(s) {
    for (let t = It.indexOf(s) + 1, e = It.length; t < e; ++t) if (fa[It[t]].common) return It[t];
  }
  function Bg(s, t, e) {
    if (!e) s[t] = !0;
    else if (e.length) {
  ...
  class Rs extends oi {
    ...
    init(t, e) {
      ...
      n.init(e), Sn(i.displayFormats, n.formats()), (this._parseOpts = { parser: i.parser, round: i.round, isoWeekday: i.isoWeekday }), super.init(t), (this._normalized = e.normalized);
    }
    parse(t, e) {
    ...
    buildTicks() {
      ...
      const o = this.min,
        ...
        a = PO(n, o, r);
      return (
        (this._unit = e.unit || (i.autoSkip ? Ng(e.minUnit, this.min, this.max, this._getLabelCapacity(o)) : jM(this, a.length, e.minUnit, this.min, this.max))),
        (this._majorUnit = !i.major.enabled || this._unit === 'year' ? void 0 : YM(this._unit)),
        this.initOffsets(n),
        t.reverse && a.reverse(),
    ...
    initOffsets(t) {
      ...
      (e = dt(e, 0, r)), (i = dt(i, 0, r)), (this._offsets = { start: e, end: i, factor: 1 / (e + 1 + i) });
    }
    _generate() {
      ...
      let d = e,
        u,
        p;
      if ((c && (d = +t.startOf(d, 'isoWeek', l)), (d = +t.startOf(d, c ? 'day' : r)), t.diff(i, e, r) > 1e5 * a)) throw new Error(e + ' and ' + i + ' are too far apart with stepSize of ' + a + ' ' + r);
  ...
  (Rs.id = 'time'), (Rs.defaults = { bounds: 'data', adapters: {}, time: { parser: !1, unit: !1, round: !1, isoWeekday: !1, minUnit: 'millisecond', displayFormats: {} }, ticks: { source: 'auto', major: { enabled: !1 } } });
  function _a(s, t, e) {
    let i = 0,
      n = s.length - 1,
      o,
      ...
      l;
    e
      ? (t >= s[i].pos && t <= s[n].pos && ({ lo: i, hi: n } = De(s, 'pos', t)), ({ pos: o, time: a } = s[i]), ({ pos: r, time: l } = s[n]))
      : (t >= s[i].time && t <= s[n].time && ({ lo: i, hi: n } = De(s, 'time', t)), ({ time: o, pos: a } = s[i]), ({ time: r, pos: l } = s[n]));
    const c = r - o;
  ...
  class ga extends Rs {
    ...
    initOffsets() {
      ...
      (this._minPos = _a(e, this.min)), (this._tableRange = _a(e, this.max) - this._minPos), super.initOffsets(t);
    }
    buildLookupTable(t) {
      ...
      for (r = 0, a = n.length; r < a; ++r) (h = n[r + 1]), (l = n[r - 1]), (c = n[r]), Math.round((h + l) / 2) !== c && o.push({ time: c, pos: r / (a - 1) });
      return o;
    }
  ...
  var Vg = Object.freeze({ __proto__: null, CategoryScale: eo, LinearScale: ua, LogarithmicScale: pa, RadialLinearScale: $s, TimeScale: Rs, TimeSeriesScale: ga });
...
`)
      ...
      textSize: function (s, t, e) {
        var i = [].concat(t),
          ...
          r = 0,
          a;
        for (s.font = e.string, a = 0; a < n; ++a) r = Math.max(s.measureText(i[a]).width, r);
      ...
      arrayDiff: function (s, t) {
        var e = s.slice(),
          ...
          r,
          a;
        for (n = 0, r = t.length; n < r; ++n) (a = t[n]), (o = e.indexOf(a)), o === -1 ? i.push([a, 1]) : e.splice(o, 1);
  ...
  function ma(s, t, e) {
    var i = GM;
    return s < e.left ? (i |= Wg) : s > e.right && (i |= zg), t < e.top ? (i |= Yg) : t > e.bottom && (i |= jg), i;
  }
  function qM(s, t) {
    for (var e = s.x0, i = s.y0, n = s.x1, o = s.y1, r = ma(e, i, t), a = ma(n, o, t), l, c, h; !(!(r | a) || r & a); )
      (l = r || a),
        l & Yg
          ...
          : l & jg
            ...
            : l & zg
              ...
              : l & Wg && ((h = i + ((o - i) * (t.left - e)) / (n - e)), (c = t.left)),
        l === r ? ((e = c), (i = h), (r = ma(e, i, t))) : ((n = c), (o = h), (a = ma(n, o, t)));
  ...
  function ba(s, t) {
    var e = t.anchor,
      ...
      n,
      o;
    return t.clamp && (i = qM(i, t.area)), e === 'start' ? ((n = i.x0), (o = i.y0)) : e === 'end' ? ((n = i.x1), (o = i.y1)) : ((n = (i.x0 + i.x1) / 2), (o = (i.y0 + i.y1) / 2)), XM(n, o, s.vx, s.vy, t.align);
  }
  var va = {
      arc: function (s, t) {
        var e = (s.startAngle + s.endAngle) / 2,
          ...
          o = s.innerRadius,
          r = s.outerRadius;
        return ba({ x0: s.x + i * o, y0: s.y + n * o, x1: s.x + i * r, y1: s.y + n * r, vx: i, vy: n }, t);
      },
      point: function (s, t) {
        var e = nh(s, t.origin),
          i = e.x * s.options.radius,
          n = e.y * s.options.radius;
        return ba({ x0: s.x - i, y0: s.y - n, x1: s.x + i, y1: s.y + n, vx: e.x, vy: e.y }, t);
      },
      bar: function (s, t) {
        var e = nh(s, t.origin),
          i = s.x,
          ...
          o = 0,
          r = 0;
        return s.horizontal ? ((i = Math.min(s.x, s.base)), (o = Math.abs(s.base - s.x))) : ((n = Math.min(s.y, s.base)), (r = Math.abs(s.base - s.y))), ba({ x0: i, y0: n + r, x1: i + o, y1: n, vx: e.x, vy: e.y }, t);
      },
      fallback: function (s, t) {
        var e = nh(s, t.origin);
        return ba({ x0: s.x, y0: s.y, x1: s.x + (s.width || 0), y1: s.y + (s.height || 0), vx: e.x, vy: e.y }, t);
      },
    },
    Re = io.rasterize;
  function ZM(s) {
    var t = s.borderWidth || 0,
      ...
      o = -n / 2,
      r = -i / 2;
    return { frame: { x: o - e.left - t, y: r - e.top - t, w: n + e.width + t * 2, h: i + e.height + t * 2 }, text: { x: o, y: r, w: n, h: i } };
  }
  function QM(s, t) {
  ...
  function JM(s) {
    return s instanceof Ds ? va.arc : s instanceof Ms ? va.point : s instanceof Ls ? va.bar : va.fallback;
  }
  function tL(s, t, e, i, n, o) {
    ...
    if (o) {
      ...
      s.moveTo(t, c),
        l < h && c < d
          ? (s.arc(l, c, a, -Math.PI, -r), s.arc(h, c, a, -r, 0), s.arc(h, d, a, 0, r), s.arc(l, d, a, r, Math.PI))
          : l < h
            ? (s.moveTo(l, e), s.arc(h, c, a, -r, r), s.arc(l, c, a, r, Math.PI + r))
            : c < d
  ...
  function eL(s, t, e) {
    ...
    (!i && (!n || !o)) ||
      (s.beginPath(),
      tL(s, Re(t.x) + o / 2, Re(t.y) + o / 2, Re(t.w) - o, Re(t.h) - o, e.borderRadius),
      s.closePath(),
      i && ((s.fillStyle = i), s.fill()),
      n && o && ((s.strokeStyle = n), (s.lineWidth = o), (s.lineJoin = 'miter'), s.stroke()));
  }
  function iL(s, t, e) {
    var i = e.lineHeight,
      n = s.w,
      o = s.x,
      r = s.y + i / 2;
    return t === 'center' ? (o += n / 2) : (t === 'end' || t === 'right') && (o += n), { h: i, w: n, x: o, y: r };
  }
  function sL(s, t, e) {
    var i = s.shadowBlur,
      n = e.stroked,
      ...
      r = Re(e.y),
      a = Re(e.w);
    n && s.strokeText(t, o, r, a), e.filled && (i && n && (s.shadowBlur = 0), s.fillText(t, o, r, a), i && n && (s.shadowBlur = i));
  }
  function nL(s, t, e, i) {
    var n = i.textAlign,
      o = i.color,
  ...
  var Kg = function (s, t, e, i) {
    var n = this;
    (n._config = s), (n._index = i), (n._model = null), (n._rects = null), (n._ctx = t), (n._el = e);
  };
  Te(Kg.prototype, {
    ...
    update: function (s) {
      ...
      c && ((r = s.dataset.data[n]), (a = B(G(o.formatter, [r, s]), r)), (l = H(a) ? [] : io.toTextLines(a)), l.length && ((e = t._modelize(c, l, o, s)), (i = ZM(e)))), (t._model = e), (t._rects = i);
    },
    geometry: function () {
    ...
    draw: function (s, t) {
      ...
      this.visible() &&
        (i.save(),
        n.clip && ((r = n.area), i.beginPath(), i.rect(r.left, r.top, r.right - r.left, r.bottom - r.top), i.clip()),
  ...
  function so(s, t, e) {
    var i = Math.cos(e),
      ...
      o = t.x,
      r = t.y;
    return { x: o + i * (s.x - o) - n * (s.y - r), y: r + n * (s.x - o) + i * (s.y - r) };
  }
  function Ug(s, t) {
    var e = rL,
      i = oL,
      ...
      l,
      c;
    for (o = 0; o < s.length; ++o) (r = s[o]), (a = r.x - n.x), (l = r.y - n.y), (c = t.vx * a + t.vy * l), (e = Math.min(e, c)), (i = Math.max(i, c));
    return { min: e, max: i };
  }
  function ya(s, t) {
    var e = t.x - s.x,
  ...
  Te(Xg.prototype, {
    ...
    update: function (s, t, e) {
      (this._rotation = e), (this._rect = { x: t.x + s.x, y: t.y + s.y, w: t.w, h: t.h });
    },
    contains: function (s) {
      var t = this,
        e = 1,
        i = t._rect;
      return (s = so(s, t.center(), -t._rotation)), !(s.x < i.x - e || s.y < i.y - e || s.x > i.x + i.w + e * 2 || s.y > i.y + i.h + e * 2);
    },
    intersects: function (s) {
      var t = this._points(),
        ...
        o,
        r;
      for (this._rotation !== s._rotation && i.push(ya(e[0], e[1]), ya(e[0], e[3])), n = 0; n < i.length; ++n) if (((o = Ug(t, i[n])), (r = Ug(e, i[n])), o.max < r.min || r.max < o.min)) return !1;
      return !0;
    },
    _points: function () {
      var s = this,
        ...
        e = s._rotation,
        i = s.center();
      return [so({ x: t.x, y: t.y }, i, e), so({ x: t.x + t.w, y: t.y }, i, e), so({ x: t.x + t.w, y: t.y + t.h }, i, e), so({ x: t.x, y: t.y + t.h }, i, e)];
    },
  });
  function Gg(s, t, e) {
    ...
    return (c *= n * d), (h *= o * d), (c += t.offset * n), (h += t.offset * o), { x: i.x + c, y: i.y + h };
  }
  function aL(s, t) {
    var e, i, n, o;
    for (e = s.length - 1; e >= 0; --e) for (n = s[e].$layout, i = e - 1; i >= 0 && n._visible; --i) (o = s[i].$layout), o._visible && n._box.intersects(o._box) && t(n, o);
    return s;
  }
  function lL(s) {
    var t, e, i, n, o, r, a;
    for (t = 0, e = s.length; t < e; ++t) (i = s[t]), (n = i.$layout), n._visible && ((a = new Proxy(i._el, { get: (l, c) => l.getProps([c], !0)[c] })), (o = i.geometry()), (r = Gg(a, i.model(), o)), n._box.update(r, o, i.rotation()));
  ...
  var no = {
      prepare: function (s) {
        var t = [],
          ...
          o,
          r;
        for (e = 0, n = s.length; e < n; ++e) for (i = 0, o = s[e].length; i < o; ++i) (r = s[e][i]), t.push(r), (r.$layout = { _box: new Xg(), _hidable: !1, _visible: !0, _set: e, _idx: r._index });
        return (
          t.sort(function (a, l) {
            var c = a.$layout,
              h = l.$layout;
      ...
      update: function (s) {
        var t = !1,
          ...
          o,
          r;
        for (e = 0, i = s.length; e < i; ++e) (n = s[e]), (o = n.model()), (r = n.$layout), (r._hidable = o && o.display === 'auto'), (r._visible = n.visible()), (t |= r._hidable);
        t && lL(s);
      },
      lookup: function (s, t) {
        var e, i;
        for (e = s.length - 1; e >= 0; --e) if (((i = s[e].$layout), i && i._visible && i._box.contains(t))) return s[e];
        return null;
      },
      draw: function (s, t) {
        var e, i, n, o, r, a;
        for (e = 0, i = t.length; e < i; ++e) (n = t[e]), (o = n.$layout), o._visible && ((r = n.geometry()), (a = Gg(n._el, n.model(), r)), o._box.update(a, r, n.rotation()), n.draw(s, a));
      },
    },
    cL = function (s) {
      if (H(s)) return null;
      ...
      if (V(s))
        ...
        else for (t = '', e = Object.keys(s), n = 0, i = e.length; n < i; ++n) t += (n !== 0 ? ', ' : '') + e[n] + ': ' + s[e[n]];
      return '' + t;
    },
    hL = {
      align: 'center',
  ...
  function oh(s, t, e, i) {
    if (t) {
      var n = e.$context,
        o = e.$groups,
        r;
      t[o._set] && ((r = t[o._set][o._key]), r && G(r, [n, i]) === !0 && ((s[Dt]._dirty = !0), e.update(n)));
    }
  }
  function uL(s, t, e, i, n) {
    var o, r;
    (!e && !i) || (e ? (i ? e !== i && (r = o = !0) : (r = !0)) : (o = !0), r && oh(s, t.leave, e, n), o && oh(s, t.enter, i, n));
  }
  function pL(s, t) {
    var e = s[Dt],
      i = e._listeners,
  ...
  var _L = {
    ...
    afterDatasetUpdate: function (s, t, e) {
      ...
      for (h.save(), d = 0, p = c.length; d < p; ++d)
        if (((y = c[d]), (y[Dt] = []), r && y && s.getDataVisibility(d) && !y.skip))
          for (u = 0, f = l.labels.length; u < f; ++u)
            (b = l.labels[u]),
              (v = b._key),
              (T = new Kg(b, h, y, d)),
              (T.$groups = { _set: i, _key: v || qg }),
              (T.$context = { active: !1, chart: s, dataIndex: d, dataset: a, datasetIndex: i }),
              T.update(T.$context),
              y[Dt].push(T),
              o.push(T);
      h.restore(),
    ...
    afterEvent: function (s) {
      var t = s[Dt],
        ...
        h,
        d;
      for (o = 0, r = n.length; o < r; ++o) if (((c = n[o]), c[1])) for (d = c[0].element[Dt] || [], a = 0, l = d.length; a < l; ++a) (h = d[a]), (h.$context.active = c[1] === 1), h.update(h.$context);
      (t._dirty || n.length) && (no.update(t._labels), s.render()), delete t._dirty;
    },
  };
  const gL = Object.freeze(Object.defineProperty({ __proto__: null, default: _L }, Symbol.toStringTag, { value: 'Module' }));
  (N.Alert = Ws),
    (N.Animate = Gs),
    (N.Autocomplete = Pr),
    (N.Button = ao),
